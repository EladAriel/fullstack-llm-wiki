...
source_branch: "main"
source_path: "doc/en/explanation/types.rst"
...
> **Note:**  This page assumes the reader is familiar with Python's typing system and its advantages.
...
The same logic applies to `@pytest.mark.parametrize <@pytest.mark.parametrize>`:
