...
source_branch: "main"
source_path: "doc/en/proposals/parametrize_with_fixtures.rst"
...
> **Warning:**  This document outlines a proposal around using fixtures as input
...
The new fixture `context` inherits the scope from the used fixtures and yield the following values.
...
A new helper function named `fixture_request` would tell pytest to yield all parameters marked as a fixture.

> **Note:**  The :pypi:`pytest-lazy-fixture` plugin implements a very
