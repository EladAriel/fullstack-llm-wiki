...
generated_at: "2026-08-29T09:40:11.225014Z"
---
.. _subtests:
...
**note:** See :ref:`parametrize` for an alternative to subtests.
...
**note:** This feature was originally implemented as a separate plugin in `pytest-subtests <https://github.com/pytest-dev/pytest-subtests>`__, but since ``9.0`` has been merged into the core.
