...
source_branch: "main"
source_path: "src/langsmith/managed-deep-agents-tutorial.mdx"
source_commit: "a174f9cf7c91ee5eb14ee2382eb48bfe6e4956e9"
source_commit_short: "a174f9c"
source_commit_date: "2026-08-28T17:04:12-07:00"
generated_at: "2026-08-29T09:39:50.601734Z"
---
---
...
This tutorial continues from the [quickstart](/langsmith/managed-deep-agents-quickstart). Use the `research-assistant` project you created there, with your model, instructions, and a working `mda dev` setup.
...
<Note>
If you followed the steps to use Tavily in the [Quickstart](/langsmith/managed-deep-agents-quickstart), skip to the next step.
</Note>
...
Confirm the agent calls `internet_search` and returns an answer with citations. For more authored tools, see [Custom tools](/langsmith/managed-deep-agents-tools).
...
For thread behavior and constraints, see [Schedules](/langsmith/managed-deep-agents-schedules).
...
For deploy flags and troubleshooting, see [Deploy an agent](/langsmith/managed-deep-agents-deploy) and the [CLI reference](/langsmith/managed-deep-agents-cli#deploy-projects).
