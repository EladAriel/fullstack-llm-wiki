...
For [Deep Agents](/oss/deepagents/event-streaming) deployments, prefer `thread.subagents` for subagent invocations—it exposes the subagent name and per-subagent message and tool-call projections.
