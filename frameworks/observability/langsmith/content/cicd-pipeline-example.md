...
- <Icon icon="chart-line" /> **Offline evaluations**: Performance assessment using [AgentEvals](/oss/langchain/test/evals), [OpenEvals](/langsmith/openevals#setup) and [LangSmith](/langsmith/observability).
