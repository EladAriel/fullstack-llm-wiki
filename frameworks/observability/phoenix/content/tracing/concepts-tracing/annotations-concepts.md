...
source_branch: "main"
source_path: "docs/phoenix/tracing/concepts-tracing/annotations-concepts.mdx"
source_commit: "69b3ab92c37ff65812feaa2dbf0b1c0ad5ae55fe"
source_commit_short: "69b3ab9"
source_commit_date: "2026-07-25T11:48:12-06:00"
generated_at: "2026-07-25T19:08:24.916708Z"
---
...
* Optimize the direction based on your goal:
   * **Maximize:** higher scores are better. (e.g. confidence, faithfulness)
   * **Minimize:** lower scores are better. (e.g. toxicity)
   * **None:** direction optimization does not apply. (e.g. refusal)

<Frame caption="Different types of annotations change the way human annotators provide feedback">
  <img src="https://storage.googleapis.com/arize-phoenix-assets/assets/images/annotation_types.png" alt="" />
</Frame>

See [Annotate Traces](/docs/phoenix/tracing/how-to-tracing/feedback-and-annotations) for more details.
...
For more information on how to wire up your application to collect feedback from your users, see [here](../how-to-tracing/feedback-and-annotations).
...
<Frame caption="A span's attributes as well as annotations are propagated to example metadata">
  <img src="https://storage.googleapis.com/arize-assets/phoenix/assets/images/span_to_dataset_example.png" alt="" />
</Frame>
...
| Annotator Kind | Source | Purpose | Strengths | Use Case |
|:--|:--|:--|:--|:--|
