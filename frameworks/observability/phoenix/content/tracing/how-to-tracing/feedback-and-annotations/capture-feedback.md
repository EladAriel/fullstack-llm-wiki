...
source_branch: "main"
source_path: "docs/phoenix/tracing/how-to-tracing/feedback-and-annotations/capture-feedback.mdx"
source_commit: "c48e50e9906fcc56c1c103ebd93ef3c95ed6b6e7"
source_commit_short: "c48e50e"
source_commit_date: "2026-08-29T01:45:20-06:00"
generated_at: "2026-08-29T09:39:58.905860Z"
---
# Capture Feedback

---
title: "Annotating via the Client"
...
<Frame caption="">
  <img src="https://storage.googleapis.com/arize-phoenix-assets/assets/images/phoenix-docs-images/3e4a596d-image.jpeg" />
</Frame>
...
Once you construct the annotation, you can send this to Phoenix via its REST API. You can POST an annotation from your application to `/v1/span_annotations` like so:

<Warning>
These examples use the **REST API** (`/v1/span_annotations`), where `span_id` is an OpenTelemetry hex ID (for example, `"67f6740bbe1ddc3f"`).

If you use the **GraphQL** `createSpanAnnotations` mutation directly, pass the span's GraphQL `id` (Global ID), not the OpenTelemetry hex `span_id`.
</Warning>
