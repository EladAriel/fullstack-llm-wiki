...
source_branch: "main"
source_path: "docs/phoenix/sdk-api-reference/typescript/packages/phoenix-otel/overview.mdx"
source_commit: "69b3ab92c37ff65812feaa2dbf0b1c0ad5ae55fe"
source_commit_short: "69b3ab9"
source_commit_date: "2026-07-25T11:48:12-06:00"
generated_at: "2026-07-25T19:08:24.951676Z"
---
# Overview
...
AI SDK v7 telemetry registration is process-global, so configure it explicitly in your application. Install `ai` and `@ai-sdk/otel`; the bundled `@arizeai/openinference-vercel` span processors then translate the emitted spans to OpenInference before export.
...
const provider = register({ projectName: "my-ai-app" });

registerTelemetry(
  new OpenTelemetry({
    tracer: provider.getTracer("@arizeai/phoenix-otel/ai-sdk"),
    // Headers can contain authorization tokens and cookies.
    headers: false,
  })
);
```

- call `registerTelemetry()` only once during application startup
- compose this integration with any logging, metrics, or custom integrations your application already registers
- AI SDK v6 and older emit a different span shape; use `@arizeai/phoenix-otel` 1.x for AI SDK v6
...
const exporter = new OTLPTraceExporter({
  url: "https://your-phoenix.example.com/v1/traces",
