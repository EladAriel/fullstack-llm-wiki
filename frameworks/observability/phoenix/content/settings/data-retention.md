...
source_branch: "main"
source_path: "docs/phoenix/settings/data-retention.mdx"
source_commit: "c48e50e9906fcc56c1c103ebd93ef3c95ed6b6e7"
source_commit_short: "c48e50e"
source_commit_date: "2026-08-29T01:45:20-06:00"
generated_at: "2026-08-29T09:39:58.806085Z"
---
# Data Retention
...
Conversations with the [PXI agent](/docs/phoenix/pxi) are a separate kind of data from your traces, and they carry their own retention — these are agent chats, not the trace sessions described above. Unlike traces, Phoenix does not keep them forever by default; it holds them on a rolling window so old chats don't accumulate:

- **Idle persisted chats** are removed after **30 days** without activity.
- **Per user**, Phoenix keeps the **30** most recently updated chats and evicts the rest.
- **Temporary chats** — chats a user marks as temporary — are never saved to history and are removed **24 hours** after their last activity.

A background sweep enforces these limits about once an hour. Both persisted-chat limits are set by an administrator under **Settings → Assistant**: raise or lower the idle window and the per-user cap, or set either to `0` to turn that limit off and keep chats indefinitely. The 24-hour window for temporary chats is fixed and not configurable.

Deleting a chat is permanent, whether it ages out under a retention limit, an administrator removes it from the assistant sessions card, or the user deletes it themselves.
