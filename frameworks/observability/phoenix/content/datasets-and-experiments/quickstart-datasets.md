...
source_branch: "main"
source_path: "docs/phoenix/datasets-and-experiments/quickstart-datasets.mdx"
source_commit: "c48e50e9906fcc56c1c103ebd93ef3c95ed6b6e7"
source_commit_short: "c48e50e"
source_commit_date: "2026-08-29T01:45:20-06:00"
generated_at: "2026-08-29T09:39:58.807138Z"
---
# Quickstart Datasets
...
import ConnectToPhoenixEnv from "../../snippets/connect-to-phoenix-env.mdx";
...
<Tabs>
  ...
  <Tab title="Python" icon="python">
    ...
    @create_evaluator(name="contains_keyword", kind="code")
    def contains_keyword(output):
        keywords = ["Y Combinator", "YC"]
        output_lower = str(output).lower()
        contains = any(kw.lower() in output_lower for kw in keywords)
        return contains
    ```
...
<Tabs>
  ...
  <Tab title="Python" icon="python">
    ...
    conciseness = ConcisenessEvaluator(llm=llm)
    ```
