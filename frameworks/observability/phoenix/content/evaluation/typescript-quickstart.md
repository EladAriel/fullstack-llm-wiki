...
generated_at: "2026-07-25T19:08:24.830306Z"
---
...
<Steps>
  <Step title={<span className="step-title">Set up and Connect to Phoenix</span>}>
    ...
    Include these in your `.env` file. `PHOENIX_HOST` is what `@arizeai/phoenix-client` reads for datasets and experiments; `PHOENIX_COLLECTOR_ENDPOINT` is what `@arizeai/phoenix-otel` reads when exporting spans — set both to the same instance.
  ...
  <Step title={<span className="step-title">Create an Evaluator</span>}>
    ...
    import { createDocumentRelevanceEvaluator } from "@arizeai/phoenix-evals/llm/createDocumentRelevanceEvaluator";
