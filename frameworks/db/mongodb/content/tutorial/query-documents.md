...
generated_at: "2026-08-29T09:39:19.568221Z"
---
...
**meta:** :description: Read documents by querying for equality matches or other query operators, and specifying compound query conditions.
...
In MongoDB, a Read operation consists of querying the database. This page
provides examples.
...
This operation uses an empty :term:`query predicate` of ``{}``, which
   ...
   tabs:
     ...
     - id: csharp
       content: |
         ...
         method returns a :doc:`cursor </tutorial/iterate-a-cursor>` to
         the matching documents. See the MongoDB .NET/C# Driver
