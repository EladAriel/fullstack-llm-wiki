...
generated_at: "2026-08-29T09:39:19.614167Z"
---
...
Both guides describe how to enforce access control.
...
The tutorial primarily refers to the :binary:`~bin.mongod` process.
Windows users should use the :binary:`mongod.exe` program instead.

### Keyfile Security

Use keyfiles only for testing and development environments because
of their limited manageability and cryptographic strength. For
production environments, use :ref:`X.509 certificates
<security-auth-x509>`, which offer stronger security features, better
key management, and individual authentication.
