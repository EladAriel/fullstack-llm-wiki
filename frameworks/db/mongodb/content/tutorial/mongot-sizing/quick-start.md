...
source_branch: "main"
source_path: "content/manual/manual/source/tutorial/mongot-sizing/quick-start.txt"
...
- `Hardware Considerations <mongot-sizing-hardware>`
These pages offer guidance on mission-critical applications, or when higher-fidelity optimization is required.

> **Note:** Sizing resources for search and vector search workloads is an
...
rates. A minimum setup of two small nodes (4 CPUs total) supports roughly 40 QPS.
