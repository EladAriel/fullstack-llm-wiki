...
generated_at: "2026-08-29T09:39:19.641641Z"
---
.. _index-build-on-sharded-clusters:

# Create Rolling Index Builds on Sharded Clusters

**meta:** :description: Learn how to perform rolling index builds on sharded clusters, including stopping the balancer and building indexes on each shard.
...
**warning:** Make sure you are not performing :ref:`DDL operations <ddl-operations>` while conducting the rolling index build.
