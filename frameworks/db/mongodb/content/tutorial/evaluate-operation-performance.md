...
generated_at: "2026-08-29T09:39:19.621125Z"
---
.. _server-diagnose-queries:

# Analyze Query Performance

**meta:** :description: Identify and analyze slow queries in MongoDB to improve performance using tools like Atlas Performance Advisor, Query Profiler, and explain results.
...
.. list-table::
   ...
   * - View collection statistics
     - |both|
     - The :pipeline:`$collStats` aggregation stage returns statistical
       information on specific collections and their usage.
       ``$collStats`` provides information such as:
