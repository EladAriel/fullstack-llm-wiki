...
generated_at: "2026-08-29T09:39:19.579633Z"
---
# Configure Encryption

**meta:** :description: Configure encryption at rest for MongoDB using KMIP or local key management, ensuring secure key handling and compliance with regulatory guidelines.
...
If you use `MongoDB Atlas <https://www.mongodb.com/atlas/database>`__,
...
To create a new key when you connect to the key manager, add an entry similar to
...
For more information on these options, see :ref:`encryption-key-management-conf-options`.
...
.. |kmip-client-cert-file| replace:: :setting:`security.kmip.clientCertificateFile`
...
the following to your configuration file before you start ``mongod``.
Replace the strings and port number with your values.
