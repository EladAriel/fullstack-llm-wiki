...
generated_at: "2026-08-29T09:39:19.621546Z"
---
.. _sharding-procedure-add-member-to-shard:

# Add a Member to a Shard

**meta:** :description: Add a member to a shard to increase data redundancy and availability. Ensure the new member reaches SECONDARY state before reconfiguring.
...
**procedure:** .. step:: Prepare the Data Directory
