...
generated_at: "2026-08-29T09:39:19.649699Z"
---
.. _remove-shards-from-cluster-tutorial:

# Remove Shards from a Sharded Cluster

**meta:** :description: Remove a shard from a sharded cluster by following the procedure to ensure data is redistributed across remaining shards and the shard is properly drained.
