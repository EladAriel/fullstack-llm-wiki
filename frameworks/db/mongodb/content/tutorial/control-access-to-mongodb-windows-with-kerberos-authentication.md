...
generated_at: "2026-08-29T09:39:19.602338Z"
---
# Configure MongoDB with Kerberos Authentication on Windows

**meta:** :keywords: on-prem
   :description: Configure MongoDB on Windows with Kerberos authentication, detailing steps for setup, connection, and additional considerations for secure access.
...
**example:** If :binary:`mongod.exe` runs as a service named
