...
generated_at: "2026-08-29T09:39:19.590782Z"
---
# Prevent a Self-Managed Secondary from Becoming Primary

**meta:** :keywords: on-prem
   :description: Configure a secondary replica set member to prevent it from becoming primary by setting its priority to 0.
...
**note:** MongoDB does not permit the current :term:`primary` to have a priority
