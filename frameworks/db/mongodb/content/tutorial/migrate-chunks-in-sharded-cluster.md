...
generated_at: "2026-08-29T09:39:19.615806Z"
---
...
**meta:** :description: Learn how to manually migrate ranges in a sharded cluster using the `moveChunk` or `moveRange` command when automatic balancing is insufficient.
