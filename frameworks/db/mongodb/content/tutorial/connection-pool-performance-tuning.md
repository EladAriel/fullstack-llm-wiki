...
generated_at: "2026-08-29T09:39:19.617338Z"
---
.. _connection-pool-performance-tuning:

# Tuning Your Connection Pool Settings

**meta:** :description: Optimize connection pool settings by adjusting parameters like `connectTimeoutMS`, `minPoolSize`, and `maxPoolSize` to improve application performance.
