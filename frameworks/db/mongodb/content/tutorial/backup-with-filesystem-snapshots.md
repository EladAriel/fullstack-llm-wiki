...
generated_at: "2026-08-29T09:39:19.592391Z"
---
...
**meta:** :keywords: on-prem
   :description: Create backups of MongoDB standalone servers and replica sets using filesystem snapshots with tools like LVM, and learn restoration strategies.
...
**note:** Running :term:`LVM` provides additional flexibility and enables the
...
If your :binary:`~bin.mongod` instance has the journal files on a separate 
...
configuration, then for your backup use a :term:`secondary` which is not 
receiving reads (i.e. :term:`hidden member`).
