...
generated_at: "2026-08-29T09:39:19.651636Z"
---
...
**meta:** :description:  Learn how to query for null or missing fields in MongoDB using various methods including the MongoDB Atlas UI and MongoDB Compass.
...
Query for ``null`` or missing fields in MongoDB using the
following methods:
