...
generated_at: "2026-08-29T09:39:19.593776Z"
---
.. _database-profiler:
.. _database-profiling:
...
**meta:** :description: Manage the database profiler to collect detailed information on database commands, affecting performance and disk use when enabled.
...
**warning:** The database profiler can degrade MongoDB performance. Before enabling 
   ...
   - :ref:`Atlas Query Profiler <profile-database>`
   - :ref:`Atlas Performance Advisor <performance-advisor>`
   - :pipeline:`$queryStats` (aggregation stage)

   To learn more about the performance impact of the database profiler, see 
   :ref:`database-profiling-overhead`.
...
Starting in MongoDB 8.3, you can set a slow in-progress operation threshold. By
default, the slow in-progress operation threshold is 5000 milliseconds. You can
set the threshold with :method:`db.setProfilingLevel()` or the :option:`mongod
...
.. _database-profiling-system-profile:
