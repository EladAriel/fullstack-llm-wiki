...
generated_at: "2026-08-29T09:39:19.645241Z"
---
...
**meta:** :keywords: on-prem
   :description: Change the oplog size for replica set members using the `replSetResizeOplog` command, starting with secondary members before the primary.
...
**note:** If the replica set enforces :ref:`authentication <authentication>`,
