...
generated_at: "2026-08-29T09:39:19.645857Z"
---
...
**meta:** :keywords: on-prem
   :description: Replace a config server in a replica set by starting a new instance, adding it to the set, updating settings, and removing the old server.
