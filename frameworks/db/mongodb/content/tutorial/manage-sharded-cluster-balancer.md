...
generated_at: "2026-08-29T09:39:19.604267Z"
---
.. _sharded-cluster-balancer:

# Manage Sharded Cluster Balancer

**meta:** :description: Manage sharded cluster balancer settings, including enabling/disabling, scheduling, and configuring migration behavior.
...
**literalinclude:** /code-examples/tested/command-line/mongosh/cluster/balancer/unset-active-window.js
   :language: shell
   :copyable: true
...
**literalinclude:** /code-examples/tested/command-line/mongosh/cluster/balancer/unset-active-window-DOW.js
   :language: shell
   :copyable: true
   :category: syntax examples

If you have both ``activeWindow`` and ``activeWindowDOW`` set, you must
individually unset both using :update:`$unset` as shown above. 
...
.. _disable-balancer-on-collection:
...
.. _enable-balancer-on-collection:
