...
generated_at: "2026-08-29T09:39:19.625423Z"
---
**meta:** :keywords: on-prem
   :description: Install MongoDB Enterprise on SUSE using a .tgz tarball, including prerequisites, extraction, and running the `mongod` process.
...
|arrow| See :ref:`Install MongoDB using the zypper Package Manager<install-mdb-enterprise-suse>`
for instructions.
