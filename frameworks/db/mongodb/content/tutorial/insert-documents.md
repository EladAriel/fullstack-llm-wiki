...
generated_at: "2026-08-29T09:39:19.576650Z"
---
...
**meta:** :description: How to create documents by inserting them into a collection, including creating a collection on first insert.
...
## Insert a Single Document
      ...
      If the document does not specify ``_id``, MongoDB adds one.
...
## Insert a Single Document
      ...
      :driver:`IMongoCollection.insertOne() </java/sync/current/crud/insert/#insert-a-single-document>`      
      inserts a *single* :ref:`document<bson-document-format>` into
      a collection.

      This example inserts one document into ``inventory``. If the document 
      does not specify ``_id``, MongoDB adds one. 
      See :ref:`write-op-insert-behavior`.
...
## Insert a Single Document
      ...
      `com.mongodb.reactivestreams.client.MongoCollection.insertOne <{+java-api-docs+}/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoCollection.html#insertOne(TDocument)>`__      
      inserts a *single* :ref:`document<bson-document-format>` into
      a collection with the `Java Reactive Streams Driver 
...
## Insert a Single Document
      ...
      This example inserts one document into ``inventory``. 
      If the document does not specify ``_id``, MongoDB adds one. 
      See :ref:`write-op-insert-behavior`.
...
## Insert a Single Document
      ...
      :driver:`IMongoCollection.InsertOne() </csharp/current/crud/insert/#insert-one-document>`
      inserts a *single* :ref:`document<bson-document-format>` into a
      collection.
...
## Insert Multiple Documents
      ...
      This example inserts multiple documents into the ``movies`` collection.
      If documents do not specify ``_id``, MongoDB adds one for each document.
      See :ref:`write-op-insert-behavior`.
...
## Insert Multiple Documents
      ...
      *multiple* :ref:`documents <bson-document-format>` into a
      ...
      This example inserts multiple documents into ``inventory``. 
      If documents do not specify ``_id``, MongoDB adds one for each document. 
      See :ref:`write-op-insert-behavior`.
...
## Insert Multiple Documents
      ...
      :driver:`IMongoCollection.insertMany() </java/sync/current/crud/insert/#insert-multiple-documents>`       
      can insert *multiple* :ref:`documents <bson-document-format>`
...
## Insert Multiple Documents
      ...
      `com.mongodb.reactivestreams.client.MongoCollection.insertMany <{+java-api-docs+}/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoCollection.html#insertMany(java.util.List)>`__      
      inserts the following documents with the `Java Reactive Streams Driver 
      <https://www.mongodb.com/docs/languages/java/reactive-streams-driver/current/>`__:
...
## Insert Multiple Documents
      ...
      :driver:`IMongoCollection.InsertMany() </csharp/current/crud/insert/#insert-multiple-documents>`
      can insert *multiple* :ref:`documents <bson-document-format>`
...
### ``_id`` Field
   ...
   .. selected-content::
      ...
      .. seealso::
         ...
         - :ref:`Collection Methods <additional-inserts>`
   ...
   .. selected-content::
      ...
      .. seealso::
         ...
         - `Java Reactive Streams Driver <https://www.mongodb.com/docs/languages/java/reactive-streams-driver/current/>`__
