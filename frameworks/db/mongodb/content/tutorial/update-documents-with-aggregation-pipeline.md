...
generated_at: "2026-08-29T09:39:19.581808Z"
---
...
**meta:** :description: Update documents using aggregation pipeline stages.
...
You can build aggregation pipelines to perform updates in the {+atlas+} UI.
Requires :authrole:`Project Data Access Read Only` role or higher.
...
The pipeline consists of a :pipeline:`$set` stage
...
The pipeline consists of an :pipeline:`$addFields`
