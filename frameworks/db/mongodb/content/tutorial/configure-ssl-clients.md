...
generated_at: "2026-08-29T09:39:19.619480Z"
---
.. _ssl-clients:

# TLS/SSL Configuration for Clients

**meta:** :description: Configure TLS/SSL for MongoDB clients to ensure secure connections, using options like `--tls`, `--tlsCAFile`, and `--tlsCertificateKeyFile`.
...
:ref:`TLS/SSL connections <configure-mongod-mongos-for-tls-ssl>`.
...
- `.NET/C# Driver <https://www.mongodb.com/docs/drivers/csharp/current/fundamentals/connection/tls/>`_
...
**seealso:** :ref:`configure-mongod-mongos-for-tls-ssl`