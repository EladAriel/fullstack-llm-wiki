...
generated_at: "2026-08-29T09:39:19.570066Z"
---
...
**meta:** :keywords: on-prem
   :description: Secure a replica set with keyfile authentication without downtime using the `--transitionToAuth` option.
