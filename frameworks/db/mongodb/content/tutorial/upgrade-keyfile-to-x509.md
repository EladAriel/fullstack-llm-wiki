...
generated_at: "2026-08-29T09:39:19.599653Z"
---
...
**meta:** :keywords: on-prem
   :description: Upgrade MongoDB clusters from keyfile to X.509 authentication using a rolling upgrade process with TLS/SSL settings.
...
To upgrade self-managed clusters that are currently using :ref:`keyfile authentication
