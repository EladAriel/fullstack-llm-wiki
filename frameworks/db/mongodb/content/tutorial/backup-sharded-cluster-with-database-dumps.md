...
generated_at: "2026-08-29T09:39:19.600961Z"
---
...
**meta:** :keywords: on-prem
   :description: Back up a self-managed sharded cluster using mongodump by stopping the balancer, locking the cluster, and performing the dump to create a restorable backup.
...
- `MongoDB Cloud Manager <https://www.mongodb.com/cloud/cloud-manager>`_

- `MongoDB Ops Manager <https://www.mongodb.com/products/ops-manager>`_
...
- To a sharded cluster, see :ref:`restore-sharded-dumps`.

- To a replica set or standalone, run
  :program:`mongorestore` directly against
  :program:`mongod`:

  .. code-block:: bash

     mongorestore --nsExclude='config.*' /path/to/backup
