...
generated_at: "2026-08-29T09:39:19.594786Z"
---
.. _drop-a-hashed-shard-key-index:

# Drop a Hashed Shard Key Index

**meta:** :description: Drop a hashed shard key index to speed up CRUD operations. Understand the impact on collection balancing, including how dropping the index affects adding and removing shards from your cluster.
...
Dropping an :ref:`unnecessary index <unnecessary-indexes-antipattern>`
...
- The server disables balancing for your collection and excludes
  the collection from future balancing rounds. As a result, if you
  later add or remove a shard, the server cannot rebalance the
  collection's data. To include the collection in future balancing rounds,
  recreate the hashed shard key index.
