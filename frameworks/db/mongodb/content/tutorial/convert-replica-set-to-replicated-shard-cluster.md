...
generated_at: "2026-08-29T09:39:19.613806Z"
---
...
**meta:** :keywords: on-prem
   :description: Convert a self-managed replica set to a sharded cluster for better scalability with large data sets and high throughput operations.
...
**procedure:** :style: normal
   ...
   .. step:: Restart the Initial Replica Set as a Shard
      ...
      .. warning:: 
         ...
         You can't run the :dbcommand:`setDefaultRWConcern` command to change 
         your global default read or write concern until your replica set 
         completes its conversion to a sharded cluster. 
