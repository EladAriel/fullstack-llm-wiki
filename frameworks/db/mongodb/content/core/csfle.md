...
generated_at: "2026-08-29T09:39:19.526264Z"
---
.. _manual-csfle-feature:

# {+csfle+}

**meta:** :description: Enable Client-Side Field Level Encryption to secure data before sending it to MongoDB. Use automatic or explicit encryption methods to protect sensitive fields throughout their lifecycle.
...
{+csfle+} ({+csfle-abbrev+}) enables you to encrypt data in your
application before you send it over the network to MongoDB. With
{+csfle-abbrev+} enabled, no MongoDB product has access to your
...
For reference on {+csfle-abbrev+}-enabled applications, see the
:ref:`csfle-reference` section:
