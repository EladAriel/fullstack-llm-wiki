...
generated_at: "2026-08-29T09:39:19.516932Z"
---
.. _authentication:
...
**meta:** :description: Authentication mechanisms for locally and cloud-deployed MongoDB databases.
   :keywords: on-prem
...
enabled, MongoDB requires all clients to authenticate themselves
to determine their access.

Authentication and :ref:`authorization <authorization>` are
distinct:
