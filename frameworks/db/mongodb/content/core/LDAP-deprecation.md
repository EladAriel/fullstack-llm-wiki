...
generated_at: "2026-08-29T09:39:19.535611Z"
---
.. _ldap-deprecation:
...
**meta:** :description: LDAP deprecation information
   :keywords: LDAP, OIDC, Workforce Identity Federation, Workload Identity Federation, on-prem
...
MongoDB databases using any |idp-abbr| that supports OIDC, such
...
- **Improved security with access tokens:** Identity Federation grants
  ...
  time period can usually be customized based on the |idp|.
...
with any |idp| that supports OIDC, such as Microsoft Entra
...
- **Improved network security:** LDAP requires a public Fully Qualified
  ...
  |idp| and synchronize part of the user directory to
...
- **Improved security with access tokens:** Workforce and Workload
  ...
  can usually be customized based on the |idp|.
