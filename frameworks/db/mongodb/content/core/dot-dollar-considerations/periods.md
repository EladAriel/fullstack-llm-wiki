...
generated_at: "2026-08-29T09:39:19.804679Z"
---
.. _period-field-names:

# Field Names with Periods

**meta:** :description: Insert, query, and update documents with field names containing periods using operators like `$getField` and `$setField`.
