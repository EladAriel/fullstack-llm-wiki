...
generated_at: "2026-08-29T09:39:19.555190Z"
---
.. _replica-set-three-members:

# Three Member Replica Sets

**meta:** :description: Explore the benefits and configurations of three-member replica sets, including setups with two secondaries or an arbiter for redundancy and high availability.
...
- One :ref:`primary <replica-set-primary>`.

- Two :ref:`secondary <replica-set-secondary-members-ref>` members. Both
  secondaries can become the primary in an :ref:`election
...
- One :ref:`secondary <replica-set-secondary-members-ref>` member. The
  secondary can become primary in an :ref:`election
  <replica-set-election-internals>`.
