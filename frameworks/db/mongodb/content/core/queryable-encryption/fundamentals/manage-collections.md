...
generated_at: "2026-08-29T09:39:19.821149Z"
---
**facet:** :name: genre
   :values: reference

**meta:** :keywords: queryable encryption, encrypted collections, metadata collections, code example, node.js, shell
...
**example:** If you create a collection called "patients", MongoDB creates the
...
**example:** Inserting a document with two indexed fields requires:
...
**example:** Updating a document with two indexed fields requires:
...
**example:** In this example, the encrypted collection is named "patients".
