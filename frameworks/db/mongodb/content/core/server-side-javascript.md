...
generated_at: "2026-08-29T09:39:19.542466Z"
---
:orphan:
...
**meta:** :description: Explore server-side JavaScript functions in MongoDB, including deprecated features and how to disable execution.
...
**important:** Server-side JavaScript Deprecated
   ...
   :ref:`Map-reduce <map-reduce>` is deprecated starting in MongoDB 5.0.
