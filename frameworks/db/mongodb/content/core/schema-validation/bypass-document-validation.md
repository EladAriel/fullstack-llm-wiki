...
generated_at: "2026-08-29T09:39:19.785453Z"
---
.. _schema-bypass-document-validation:

# Bypass Schema Validation

**meta:** :description: Bypass schema validation rules for specific operations, allowing insertion of documents that don't meet current validation criteria.
...
**procedure:** .. step:: Create a collection with validation rules
