...
generated_at: "2026-08-29T09:39:19.785044Z"
---
.. _schema-validation-query-expression:

# Specify Validation With Query Operators

**meta:** :description: Specify validation rules using query operators to ensure field values are correctly proportional, with examples of creating and validating collections.
...
**procedure:** .. step:: Create a collection with validation.
