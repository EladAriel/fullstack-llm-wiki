...
generated_at: "2026-08-29T09:39:19.787564Z"
---
.. _schema-validation-handle-invalid-docs:

# Choose How to Handle Invalid Documents

**meta:** :description: Specify how MongoDB handles documents violating validation rules, either rejecting them or logging the violations.
...
**procedure:** .. step:: Create a collection with ``validationAction: "error"``.
...
**procedure:** .. step:: Create a collection with ``validationAction: "warn"``.
