...
generated_at: "2026-08-29T09:39:19.788921Z"
---
.. _schema-update-validation:

# Modify Schema Validation

**meta:** :description: Modify schema validation rules in MongoDB collections using the `collMod` command to update validation criteria like field requirements and lengths.
