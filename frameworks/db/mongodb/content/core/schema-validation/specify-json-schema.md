...
generated_at: "2026-08-29T09:39:19.786492Z"
---
...
**meta:** :description: Use JSON Schema to specify validation rules for your collection fields in a human-readable format. Define required fields, allowed data types, and field value ranges using JSON Schema keywords.
...
JSON Schema is a vocabulary that lets you annotate and validate JSON
documents. Use JSON Schema to specify validation rules for your fields
...
**procedure:** .. step:: Connect to your MongoDB deployment.

      To connect to a local MongoDB instance or {+atlas+} deployment
      using :binary:`~bin.mongosh`, see
      :mongosh:`Connect to a Deployment </connect>` or
      :atlas:`Connect via mongosh </mongo-shell-connection/>`.
   ...
   .. step:: Create a collection with validation.
      ...
      .. tip:: Clarify Rules with Title and Description Fields
         ...
         Use ``title`` and ``description`` fields to explain validation
         rules that aren't immediately clear. When a document fails
         validation, MongoDB includes these fields in the error output.
   ...
   .. step:: Insert a valid document.
      ...
      .. literalinclude:: /code-examples/tested/command-line/mongosh/core/schema-validation/specify-json-schema/insert-valid-document.snippet.insert-valid-document.js
         :language: javascript
         :emphasize-lines: 5
   ...
   .. step:: Query for the valid document.
      ...
      .. io-code-block::
         ...
         .. input:: /code-examples/tested/command-line/mongosh/core/schema-validation/specify-json-schema/find-students.snippet.find-students.js
            :language: javascript

         .. output:: /code-examples/tested/command-line/mongosh/core/schema-validation/specify-json-schema/find-students-output.sh
            :language: javascript
