...
generated_at: "2026-08-29T09:39:19.547697Z"
---
.. _users:
...
**meta:** :keywords: on-prem
   :description: Manage users in self-managed MongoDB deployments by creating, updating, and assigning roles, with special considerations for LDAP and sharded clusters.
...
also grant or revoke roles and update passwords by updating
...
A user's privileges are not limited to their authentication database
and can span multiple databases. For more information on roles, see
