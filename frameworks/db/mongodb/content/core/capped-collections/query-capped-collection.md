...
generated_at: "2026-08-29T09:39:19.783458Z"
---
.. _capped-collections-query:

# Query a Capped Collection

**meta:** :description: Query a capped collection in MongoDB to retrieve documents in insertion order or reverse order using the `$natural` parameter.
