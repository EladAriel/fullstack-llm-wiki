...
generated_at: "2026-08-29T09:39:19.784345Z"
---
.. _capped-collections-create:

# Create a Capped Collection

**meta:** :description: Create capped collections by specifying size and optional document limits using `db.createCollection()`.
