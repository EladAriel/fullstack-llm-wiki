...
generated_at: "2026-08-29T09:39:19.525405Z"
---
.. _transport-encryption:

# TLS/SSL (Transport Encryption)

**meta:** :description: Secure MongoDB network traffic with TLS/SSL, supporting strong ciphers and forward secrecy, and manage certificates for encryption and identity verification.
...
To configure your deployment to use TLS, follow the :ref:`quickstart <tls-plan-deployment>`.
...
To use TLS with MongoDB, you must have TLS certificates. See :ref:`tls-certificate-tutorial`.
...
**sharedinclude:** server/lets-encrypt-ocsp-note.rst
