...
generated_at: "2026-08-29T09:39:19.508220Z"
---
.. _index-feature-ttl:
...
**meta:** :description: TTL indexes are special single-field indexes for automatically removing documents from a collection after a certain amount of time or at a specific clock time.
...
it increments the :serverstatus:`metrics.ttl.deletedDocuments` server status metric.
...
``system.local.replset`` collection contains data.
...
**seealso:** :ref:`Schema Validation <schema-validation-document>`.
