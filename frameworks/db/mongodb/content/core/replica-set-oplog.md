...
generated_at: "2026-08-29T09:39:19.515179Z"
---
.. _replica-set-oplog:

# Replica Set Oplog

**meta:** :description: Understand the role and management of the oplog in MongoDB replica sets, including its size, retention, and application behavior.
...
hours without becoming too stale to continue replicating.
...
database does not grow significantly in disk use, but the size
...
- Not affected by the
  ...
  :setting:`systemLog.component.replication.verbosity` level); that is,
