...
generated_at: "2026-08-29T09:39:19.526652Z"
---
.. _replica-set-arbiter-configuration:

# Replica Set Arbiter

**meta:** :description: Understand the role of an arbiter in a replica set, including its participation in elections and limitations in data operations.
...
**warning:** Using a :ref:`primary-secondary-arbiter (PSA) <rs-architecture-psa>`
