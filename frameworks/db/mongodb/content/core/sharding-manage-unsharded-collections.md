...
generated_at: "2026-08-29T09:39:19.536560Z"
---
...
**figure:** /images/sharding-move-unsharded-collection.bakedsvg.svg
   :figwidth: 600px
   :alt: Unsharded collections moving to a specified shard to distribute across two shards evenly.
...
If a specific collection uses :atlas:`{+fts+} </atlas-search/>`, be aware 
...
to manually rebuild its {+fts+} index. Until the indexes are fully rebuilt, 
{+fts+} functionality will be unavailable for this specific collection, 
