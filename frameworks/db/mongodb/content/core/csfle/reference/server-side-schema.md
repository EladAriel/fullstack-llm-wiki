...
generated_at: "2026-08-29T09:39:19.812708Z"
---
...
**meta:** :description: Use schema validation in CSFLE-enabled applications to enforce encryption of specific fields in MongoDB collections using `$jsonSchema` validation.
