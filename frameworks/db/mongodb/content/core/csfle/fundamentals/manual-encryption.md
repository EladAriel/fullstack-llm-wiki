...
generated_at: "2026-08-29T09:39:19.807172Z"
---
**facet:** :name: programming_language
   :values: csharp, go, java, javascript/typescript, python, shell

**meta:** :keywords: code example, node.js, compass, java sync
   :description: Use explicit encryption in CSFLE with MongoDB for fine-grained field security with ClientEncryption instance creation and automatic decryption options.
