...
generated_at: "2026-08-29T09:39:19.809103Z"
---
**facet:** :name: programming_language
   :values: csharp, go, java, javascript/typescript, python, shell

**meta:** :keywords: code example, node.js, compass, java sync
   :description: Learn to manage encryption keys in a CSFLE-enabled application using various Key Management Systems, including creating, rotating, and deleting keys.
...
You must refer to a key alternate name with a :term:`JSON pointer`. Use
