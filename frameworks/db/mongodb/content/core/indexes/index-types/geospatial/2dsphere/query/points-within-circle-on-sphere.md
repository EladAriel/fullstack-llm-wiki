...
generated_at: "2026-08-29T09:39:19.846915Z"
---
.. _2dsphere-query-points-within-circle-on-sphere:

# Query for Locations within a Circle on a Sphere

**meta:** :description: Query location data within a spherical cap using `$geoWithin` and `$centerSphere` operators for geospatial searches.
