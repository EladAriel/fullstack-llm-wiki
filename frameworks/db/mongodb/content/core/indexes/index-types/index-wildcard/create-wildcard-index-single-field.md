...
generated_at: "2026-08-29T09:39:19.839754Z"
---
...
**meta:** :description: Create a wildcard index on a single field to support queries on any subfield of the indexed field using the `$**` specifier.
