...
generated_at: "2026-08-29T09:39:19.849944Z"
---
.. _wildcard-projection-signature:

# Wildcard Index Signature

**meta:** :description: Explore how to use the `wildcardProjection` option in MongoDB to create multiple wildcard indexes with unique index signatures.
...
:ref:`wildcard indexes <wildcard-index-core>` is included in the
:term:`index signature`. This means that you can create multiple
