...
generated_at: "2026-08-29T09:39:19.525914Z"
---
.. _read-preference-use-cases:

# Read Preference Use Cases

**meta:** :description: Explore common use cases and considerations for different MongoDB read preference modes, including when to use non-primary modes for operations and availability.
