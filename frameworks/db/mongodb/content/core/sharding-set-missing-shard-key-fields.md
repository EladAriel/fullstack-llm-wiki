...
generated_at: "2026-08-29T09:39:19.548544Z"
---
.. _shard-key-missing-set:

# Set Missing Shard Key Fields

**meta:** :description: Set missing shard key fields to `null` using various MongoDB update methods, ensuring specific query conditions are met.
