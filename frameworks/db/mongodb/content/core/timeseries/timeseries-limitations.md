...
generated_at: "2026-08-29T09:39:19.792815Z"
---
**meta:** :keywords: IOT
...
.. composable-tutorial::
   ...
   .. selected-content::
      ...
      .. include:: /includes/time-series/timeseries-distinct-command-csharp.rst
      
   .. selected-content::
      :selections: driver, python

      .. include:: /includes/time-series/timeseries-distinct-command-python.rst

   .. selected-content::
      :selections: driver, nodejs

      .. include:: /includes/time-series/timeseries-distinct-command-javascript.rst

   .. selected-content::
      :selections: driver, java-sync

      .. include:: /includes/time-series/timeseries-distinct-command-java.rst
...
series collection. This differs from regular collections which have an index on
the ``_id`` field by default. Commands that specify a hint on the ``_id`` field
on time series collections return an error unless you manually create an index
on the ``_id`` field. 
...
- You can only create :ref:`multikey indexes <index-type-multikey>` on the ``metaField``.
...
Use the :dbcommand:`collMod` command to modify the parameters.

For more information on modifying time series intervals, see 
:ref:`Change Time Series Granularity <change-granularity>`.
