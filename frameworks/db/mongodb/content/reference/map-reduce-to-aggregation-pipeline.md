...
generated_at: "2026-08-29T09:39:19.721976Z"
---
.. _map-reduce-to-agg-pipeline:

# Map-Reduce to Aggregation Pipeline

**meta:** :description: Translate map-reduce operations to aggregation pipelines for improved performance and usability, using operators like `$group` and `$merge`.
