...
generated_at: "2026-08-29T09:39:19.720328Z"
---
...
**meta:** :keywords: on-prem
   :description: Load externally sourced values into MongoDB configuration files using expansion directives to obscure confidential information.
   ...
   .. list-table::
      ...
      * - :ref:`__rest <expansion-rest>`
        ...
        - .. _expansion-rest:
          ...
          *Required* The URL against which the |mongods|
          ...
          :gold:`IMPORTANT:` The value returned by the specified ``REST`` endpoint
          **cannot** include any additional expansion directives. The
          |mongods| does **not** perform additional
          processing on the returned data and will terminate with an
          error code if the returned data includes additional
      ...
      * - :ref:`digest <expansion-rest-digest>`
        ...
        - .. _expansion-rest-digest:
          ...
          *Optional*. The HMAC-SHA256 output of the expansion result,
          calculated as ``HMAC-SHA256(digest_key, message)``, where
          ``message`` is the value of the configuration setting to be
          retrieved.
      ...
      * - :ref:`digest_key <expansion-rest-digest-key>`
        ...
        - .. _expansion-rest-digest-key:
          ...
          *Optional*. The 64-character hexadecimal string
          representation of the 32-byte key used to calculate the
          HMAC-SHA256 :ref:`digest <expansion-rest-digest>` of the
          expansion result.

          If specified, you must also specify the :ref:`digest
          <expansion-rest-digest>`.

          .. include:: /includes/expansion-digest-example.rst
   ...
   .. list-table::
      ...
      * - ``__exec``
        ...
        - *Required* The string which the |mongods| executes on the 
          ...
          :gold:`IMPORTANT:` The data returned by executing the specified 
      ...
      * - :ref:`digest_key <expansion-exec-digest-key>`
        ...
        - .. _expansion-exec-digest-key:
          ...
          *Optional*. The 64-character hexadecimal string
          representation of the 32-byte key used to calculate the
          HMAC-SHA256 :ref:`digest <expansion-exec-digest>` of the
          expansion result.
