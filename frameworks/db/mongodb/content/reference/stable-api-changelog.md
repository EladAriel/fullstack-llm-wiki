...
generated_at: "2026-08-29T09:39:19.669111Z"
---
.. _stable-api-changelog:

# Stable API Changelog

**meta:** :description: Explore the changelog for MongoDB's Stable API, detailing new database commands and aggregation operators by version.
