...
generated_at: "2026-08-29T09:39:19.664836Z"
---
.. _database-commands:
...
**meta:** :description: How to run MongoDB commands and their parameters with examples. 
...
.. list-table::
   ...
   * - :dbcommand:`abortMoveCollection`
     ...
     - No support for Atlas :atlas:`Free and Flex tier </manage-clusters/>`.
   ...
   * - :dbcommand:`abortRewriteCollection`
     ...
     - .. include:: /includes/command/abortRewriteCollection.rst
   ...
   * - :dbcommand:`cleanupOrphaned`
     ...
     - Removes orphaned documents from a shard without disabling
       the balancer.
   ...
   * - :dbcommand:`mergeAllChunksOnShard`
     ...
     - Merges all :ref:`mergeable chunks <mergeability>` that a shard
   ...
   * - :dbcommand:`stopShardDraining`
     ...
     - .. include:: /includes/command/stopShardDraining.rst
...
.. list-table::
   ...
   * - :dbcommand:`killOp`
     ...
     - Limited support for :atlas:`Free, </unsupported-commands/#unsupported-commands>` 
   ...
   * - :dbcommand:`removeQuerySettings`
     ...
     - Removes query settings for a query shape.
   ...
   * - :dbcommand:`setQuerySettings`
     ...
     - Sets query settings for a query shape.
