...
source_branch: "main"
source_path: "content/manual/manual/source/reference/bson-types/migrate-undefined.txt"
...
- `null-migrate-remove-undefined-values`.
- `null-migrate-update-values`.
- `null-migrate-update-queries`.
> **Note:** `undefined` is a deprecated BSON type. Recent versions of the
...
- `null-migrate-remove-undefined-values-known`
- `null-migrate-remove-undefined-values-unknown`
...
- `null-migrate-update-undefined-values-known`
- `null-migrate-update-undefined-values-unknown`
