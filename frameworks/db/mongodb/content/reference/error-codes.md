...
source_branch: "main"
source_path: "content/manual/manual/source/reference/error-codes.txt"
source_commit: "b9f2bc487a2878b65e3c1f80024bebab76954f27"
source_commit_short: "b9f2bc48"
source_commit_date: "2026-08-28T17:09:45-05:00"
generated_at: "2026-08-29T09:39:19.706392Z"
---
.. _server-error-codes:

# Error Codes

**meta:** :description: Interpret MongoDB error codes to troubleshoot issues with `mongod` and `mongos` instances.
...
MongoDB returns one of the following codes when an error occurs. Use
this guide to interpret :ref:`log messages <log-messages-ref>` and
troubleshoot issues with :binary:`~bin.mongod` and
...
.. list-table::
   ...
   * - .. error:: 63
     -   StaleShardVersion (*deprecated starting in 6.0*)
   * - .. error:: 64 
     -   WriteConcernTimeout
   * - .. error:: 65 
   ...
   * - .. error:: 192 
     -   FailPointEnabled
   * - .. error:: 193
     -   NoShardingEnabled (*deprecated starting in 6.0*)
   * - .. error:: 194 
     -   BalancerInterrupted
   * - .. error:: 195 
   ...
   * - .. error:: 253
     -   FreeMonHttpInFlight (*deprecated starting in 7.1*)
   * - .. error:: 254
     -   FreeMonHttpTemporaryFailure (*deprecated starting in 7.1*)
   * - .. error:: 255
     -   FreeMonHttpPermanentFailure (*deprecated starting in 7.1*)    
   * - .. error:: 256 
   ...
   * - .. error:: 303 
     -   SplitHorizonChange
   * - .. error:: 304
     -   ShardInvalidatedForTargeting (*deprecated starting in 7.1*)   
   * - .. error:: 306 
   ...
   * - .. error:: 347 
     -   APIMismatchError
   * - .. error:: 348 
     -   ChangeStreamTopologyChange (*deprecated starting in 8.3*)
   * - .. error:: 349 
   ...
   * - .. error:: 376 
     -   ChangeStreamNotEnabled (*deprecated starting in 8.3*)
   * - .. error:: 377 
   ...
   * - .. error:: 467 
     -   StreamProcessorRetryableIcebergError
   * - .. error:: 468 
