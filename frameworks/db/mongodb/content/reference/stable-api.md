...
generated_at: "2026-08-29T09:39:19.695553Z"
---
**facet:** :name: programming_language
   :values: c, cpp, csharp, go, java, javascript/typescript, kotlin, php, python, ruby, rust, shell, swift

**meta:** :keywords: code example, node.js, compass, java sync
   :description: Ensure application stability across MongoDB upgrades using the Stable API to specify which API version your application runs against and guarantee backward compatibility.
...
The default behavior for your driver connection continues to
...
Your application does not experience significant behavior changes
from server upgrades. This guarantee holds if the new server
supports your specified API version.
...
to run any command, regardless of whether it belongs to the
Stable API.
...
Attempts to use commands outside of the Stable API receive the
...
and be confident that future server upgrades do not negatively
