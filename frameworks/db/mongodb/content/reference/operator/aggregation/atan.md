...
generated_at: "2026-08-29T09:39:20.212911Z"
---
# $atan (expression operator)

**meta:** :description: Calculate the inverse tangent of a value using the `$atan` operator in MongoDB, with results in radians or converted to degrees.
