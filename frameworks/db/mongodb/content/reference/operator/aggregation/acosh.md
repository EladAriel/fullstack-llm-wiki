...
generated_at: "2026-08-29T09:39:20.224433Z"
---
# $acosh (expression operator)

**meta:** :description: Calculate the inverse hyperbolic cosine of a number using the `$acosh` operator, returning results in radians or degrees.
