...
generated_at: "2026-08-29T09:39:20.116187Z"
---
# $dateTrunc (expression operator)

**meta:** :description: Explore how to use the `$dateTrunc` operator in MongoDB to truncate dates in aggregation pipelines, with examples for different time units and configurations.
