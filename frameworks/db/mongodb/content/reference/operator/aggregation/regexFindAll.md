...
generated_at: "2026-08-29T09:39:20.135719Z"
---
# $regexFindAll (expression operator)

**meta:** :description: Utilize `$regexFindAll` in aggregation expressions for regex pattern matching, returning an array of match details or an empty array if no match is found.
...
.. |regex-operator| replace:: ``$regexFindAll``
