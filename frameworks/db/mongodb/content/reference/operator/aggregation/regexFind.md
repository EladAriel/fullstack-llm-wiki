...
generated_at: "2026-08-29T09:39:20.202324Z"
---
# $regexFind (expression operator)

**meta:** :description: Utilize `$regexFind` in MongoDB aggregation to match regex patterns and return details of the first match, including captured groups.
...
.. |regex-operator| replace:: ``$regexFind``
