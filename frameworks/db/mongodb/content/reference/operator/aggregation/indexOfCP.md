...
generated_at: "2026-08-29T09:39:20.148540Z"
---
# $indexOfCP (expression operator)

**meta:** :description: Use `$indexOfCP` to find the UTF-8 code point index of a substring in a string, returning `-1` if not found, with optional start and end indices.
