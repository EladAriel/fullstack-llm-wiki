...
generated_at: "2026-08-29T09:39:20.192775Z"
---
# $setIsSubset  (expression operator)

**meta:** :description: Determine if one array is a subset of another using the `$setIsSubset` operator in MongoDB aggregation.
