...
generated_at: "2026-08-29T09:39:20.221393Z"
---
# $slice  (expression operator)

**meta:** :description: Use the `$slice` aggregation operator to return a subset of an array, specifying the start position and number of elements.
