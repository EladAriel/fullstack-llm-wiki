...
generated_at: "2026-08-29T09:39:20.176457Z"
---
# $bucketAuto (aggregation stage)

**meta:** :description: Categorize documents into buckets using `$bucketAuto` in MongoDB, automatically determining boundaries to evenly distribute documents.
   ...
   .. list-table::
      ...
      * - ``granularity``
        ...
        - Optional. A string that specifies the `preferred number series
          ...
          The supported values of ``granularity`` are:
...
**seealso:** :doc:`/core/aggregation-pipeline-limits`
...
**example:** The ``R5`` series is based off of the fifth root of 10, which is
...
**example:** The following values are part of the ``1-2-5`` series:
...
**example:** The following numbers adhere to the power of two Series:
...
### Multi-Faceted Aggregation
   ...
   .. tab::
      ...
      The following example performs the same ``$bucketAuto`` operation as the
      previous example, but sets the bucket boundaries as powers of 2 by using the
