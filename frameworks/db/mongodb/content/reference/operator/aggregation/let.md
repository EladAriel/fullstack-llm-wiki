...
generated_at: "2026-08-29T09:39:20.159314Z"
---
# $let (expression operator)

**meta:** :description: Bind variables within an expression using `$let` in MongoDB aggregation to compute results based on defined conditions.
