...
generated_at: "2026-08-29T09:39:20.188806Z"
---
# $tsSecond  (expression operator)

**meta:** :description: Use `$tsSecond` to extract seconds from a timestamp in MongoDB aggregation pipelines, returning a `long` value.
