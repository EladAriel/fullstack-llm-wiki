...
generated_at: "2026-08-29T09:39:20.154370Z"
---
# $firstN (accumulator operator)

**meta:** :description: Use `$firstN` to return the first `n` elements from a group or array, supporting aggregation and array operations.
