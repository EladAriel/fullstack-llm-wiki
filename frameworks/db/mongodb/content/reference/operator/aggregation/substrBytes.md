...
generated_at: "2026-08-29T09:39:20.130048Z"
---
# $substrBytes (expression operator)

**meta:** :description: Use `$substrBytes` to extract a substring from a string based on UTF-8 byte index and count, handling single and multibyte characters.
