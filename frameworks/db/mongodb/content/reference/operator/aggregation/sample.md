...
generated_at: "2026-08-29T09:39:20.192063Z"
---
# $sample (aggregation stage)

**meta:** :description: Use the $sample aggregation stage to randomly select a specified number of documents from a MongoDB collection. Learn about the syntax, behavior, and usage.
...
.. tabs-drivers::
   ...
   .. tab::
      ...
      .. literalinclude:: /code-examples/tested/csharp/driver/Aggregation/Builders/Sample.snippet.sample.cs
         :language: csharp
         :copyable: true
