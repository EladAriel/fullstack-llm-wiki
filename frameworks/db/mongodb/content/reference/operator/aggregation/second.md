...
generated_at: "2026-08-29T09:39:20.130460Z"
---
# $second  (expression operator)

**meta:** :description: Use the `$second` operator in MongoDB to extract the second from a date, accommodating leap seconds, with optional timezone support.
