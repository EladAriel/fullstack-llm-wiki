...
generated_at: "2026-08-29T09:39:20.166473Z"
---
# $rank (Window Function) (expression operator)

**meta:** :description: Explore how to use the `$rank` operator in MongoDB's `$setWindowFields` stage to determine document positions within partitions based on specified fields.
