...
generated_at: "2026-08-29T09:39:20.152863Z"
---
# $switch (expression operator)

**meta:** :description: Evaluate case expressions with `$switch` in MongoDB aggregation, executing the first true case or a default expression if none match.
