...
generated_at: "2026-08-29T09:39:20.227689Z"
---
# $unsetField  (expression operator)

**meta:** :description: Remove specified fields from documents using the `$unsetField` operator in MongoDB aggregation pipelines.
