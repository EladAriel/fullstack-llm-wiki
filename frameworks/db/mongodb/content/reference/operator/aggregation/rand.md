...
generated_at: "2026-08-29T09:39:20.220620Z"
---
# $rand (expression operator)

**meta:** :description: Generate random float values between 0 and 1 using the `$rand` operator in MongoDB aggregation pipelines.
