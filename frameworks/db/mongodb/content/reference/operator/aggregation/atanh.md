...
generated_at: "2026-08-29T09:39:20.191644Z"
---
# $atanh (expression operator)

**meta:** :description: Calculate the inverse hyperbolic tangent of a value using the `$atanh` operator, returning results in radians or converting to degrees.
