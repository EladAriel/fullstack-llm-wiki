...
generated_at: "2026-08-29T09:39:20.157040Z"
---
# $atan2 (expression operator)

**meta:** :description: Calculate the inverse tangent of two values using the `$atan2` operator in MongoDB aggregation, returning results in radians or degrees.
