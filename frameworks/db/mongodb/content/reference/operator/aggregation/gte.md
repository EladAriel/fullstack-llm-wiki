...
generated_at: "2026-08-29T09:39:20.227225Z"
---
.. _gte-aggregation-operator:

# $gte (expression operator)

**meta:** :description: Use the `$gte` operator in MongoDB to compare two values, returning true if the first is greater than or equal to the second.
