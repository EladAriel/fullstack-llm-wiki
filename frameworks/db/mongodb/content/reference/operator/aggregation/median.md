...
generated_at: "2026-08-29T09:39:20.137752Z"
---
.. _median-aggregation:

# $median (accumulator operator)

**meta:** :description: Calculate the median using the `$median` operator in MongoDB aggregation stages, supporting approximate methods for large data sets.
