...
generated_at: "2026-08-29T09:39:20.177729Z"
---
.. _bottomN_accumulator_operator:

# $bottomN (accumulator operator)

**meta:** :description: Use `$bottomN` to aggregate the lowest `n` elements in a group based on a specified sort order, preserving null values and supporting dynamic `n` values.
...
**note:** Disambiguation
   ...
   This page describes the ``$bottomN`` accumulator operator. For the ``$bottomN``
   expression operator, see :ref:`$bottomN (expression operator) <bottomN_expression_operator>`. 
