...
generated_at: "2026-08-29T09:39:20.164464Z"
---
# $bucket (aggregation stage)

**meta:** :description: Categorize documents into buckets using `$bucket` in MongoDB aggregation, specifying boundaries and output fields for each bucket.
   ...
   .. tab::
      ...
      .. include:: /includes/driver-examples/node/aggregation/stage-intro.rst
         ...
         .. replacement:: method-description
            ...
            groups incoming documents by the value of their ``runtime`` field,
            inclusive of the lower boundary and exclusive of the upper boundary.
            The aggregation stage groups all documents with a ``runtime`` value
            greater than ``999`` into the default bucket, named ``"other"``
