...
generated_at: "2026-08-29T09:39:20.151758Z"
---
# $degreesToRadians (expression operator)

**meta:** :description: Convert degrees to radians using the `$degreesToRadians` operator in MongoDB aggregation pipelines, handling various input types.
