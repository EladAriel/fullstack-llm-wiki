...
generated_at: "2026-08-29T09:39:20.197322Z"
---
# $tanh (expression operator)

**meta:** :description: Calculate the hyperbolic tangent of a value in radians using the `$tanh` operator in MongoDB aggregation.
