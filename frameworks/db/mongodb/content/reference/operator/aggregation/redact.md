...
source_branch: "main"
source_path: "content/manual/manual/source/reference/operator/aggregation/redact.txt"
source_commit: "b9f2bc487a2878b65e3c1f80024bebab76954f27"
source_commit_short: "b9f2bc48"
source_commit_date: "2026-08-28T17:09:45-05:00"
generated_at: "2026-08-29T09:39:20.218019Z"
---
# $redact (aggregation stage)

**meta:** :description: Restrict document content using `$redact` aggregation based on embedded document information and system variables like `$$DESCEND`, `$$PRUNE`, and `$$KEEP`.
   ...
   .. tab::
      ...
      .. include:: /includes/driver-examples/node/aggregation/stage-intro.rst
         ...
         .. replacement:: method-description
            ...
            keeps documents in which the value of the ``imdb.rating`` field is
            greater than or equal to ``9``. The stage excludes all other
            documents

         .. replacement:: more-method-description

      .. literalinclude:: /includes/driver-examples/node/aggregation/examples.js
         :start-after: //start redact
         :end-before: //end redact
         :language: javascript
         :dedent: 2

## Learn More

To learn more about the system variables in this guide, see the
:ref:`Aggregation Variables <aggregation-variables>` page.