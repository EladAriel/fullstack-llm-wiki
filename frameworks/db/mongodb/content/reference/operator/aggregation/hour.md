...
generated_at: "2026-08-29T09:39:20.221007Z"
---
# $hour (expression operator)

**meta:** :description: Use the `$hour` operator in MongoDB to extract the hour from a date, supporting timezone adjustments.
