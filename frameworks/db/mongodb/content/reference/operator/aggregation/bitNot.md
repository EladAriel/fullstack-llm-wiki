...
generated_at: "2026-08-29T09:39:20.172993Z"
---
# $bitNot (expression operator)

**meta:** :description: Perform a bitwise `not` operation on an `int` or `long` value using the `$bitNot` aggregation operator.
