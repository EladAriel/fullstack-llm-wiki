...
generated_at: "2026-08-29T09:39:20.183215Z"
---
# $dateToParts (expression operator)

**meta:** :description: Use `$dateToParts` in MongoDB to extract date components like year, month, and day from a BSON Date, with optional ISO week date and timezone adjustments.
