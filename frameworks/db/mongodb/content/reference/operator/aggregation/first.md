...
generated_at: "2026-08-29T09:39:20.215102Z"
---
# $first (accumulator operator)

**meta:** :description: Use `$first` in aggregation to return the result of an expression for the first document in a group, applicable in stages like `$group` and `$setWindowFields`.
