...
generated_at: "2026-08-29T09:39:20.229960Z"
---
# $avg (accumulator operator)

**meta:** :description: Calculate the average of numeric values using `$avg` in various aggregation stages, ignoring non-numeric values.
