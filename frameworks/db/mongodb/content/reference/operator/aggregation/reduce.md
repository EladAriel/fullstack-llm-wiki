...
source_branch: "main"
source_path: "content/manual/manual/source/reference/operator/aggregation/reduce.txt"
source_commit: "b9f2bc487a2878b65e3c1f80024bebab76954f27"
source_commit_short: "b9f2bc48"
source_commit_date: "2026-08-28T17:09:45-05:00"
generated_at: "2026-08-29T09:39:20.123589Z"
---
# $reduce (expression operator)

**meta:** :description: Apply the `$reduce` operator to combine array elements into a single value using specified expressions in MongoDB aggregation.
   ...
   .. list-table::
      ...
      * - ``as``
        ...
        - Optional. A name for the variable that represents each
          individual element of the ``input`` array. If omitted,
      ...
      * - ``valueAs``
        ...
        - Optional. A name for the variable that represents the
          cumulative value of the expression. If omitted, the variable
      ...
      * - ``arrayIndexAs``
        ...
        - .. include:: /includes/arrayIndexAs-field.rst
          ...
          For examples, see :ref:`reduce-index-example` and
          :ref:`reduce-IDX-example`.
...
- Person name.
- ``text`` field, which includes the hobby name and the position of each
  hobby in the list.
...
**include:** /includes/reduce-index-example-output.rst
...
previous section :ref:`reduce-index-example`, but uses ``$$IDX`` instead
of ``arrayIndexAs``:
