...
generated_at: "2026-08-29T09:39:20.171829Z"
---
# $documents (aggregation stage)

**meta:** :description: Explore how to use the `$documents` stage in MongoDB aggregation pipelines to return literal documents from input values.
...
### Use a ``$documents`` Stage in a ``$lookup`` Stage
   ...
   .. tab::
      ...
      .. io-code-block::
         ...
         .. input:: /code-examples/tested/csharp/driver/Aggregation/Builders/Documents.snippet.documents.cs
            :language: csharp
            :category: usage example

         .. output:: /code-examples/tested/csharp/driver/Aggregation/Builders/OutputFiles/DocumentsOutput.txt
            :language: json
            :visible: false
...
For details on subqueries using the :pipeline:`$lookup` syntax, see
