...
generated_at: "2026-08-29T09:39:20.233835Z"
---
# $derivative (Window Function) (expression operator)

**meta:** :description: Calculate the average rate of change using `$derivative` in the `$setWindowFields` stage to analyze data trends over specified time intervals.
