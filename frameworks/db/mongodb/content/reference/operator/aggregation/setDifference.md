...
generated_at: "2026-08-29T09:39:20.118586Z"
---
# $setDifference  (expression operator)

**meta:** :description: Perform set operations with `$setDifference` to find elements unique to the first array in MongoDB aggregation.
