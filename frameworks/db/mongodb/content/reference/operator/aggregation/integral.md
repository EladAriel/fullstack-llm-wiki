...
generated_at: "2026-08-29T09:39:20.223203Z"
---
# $integral (expression operator)

**meta:** :description: Explore how to use the `$integral` operator in MongoDB to calculate the area under a curve using the trapezoidal rule within the `$setWindowFields` stage.
