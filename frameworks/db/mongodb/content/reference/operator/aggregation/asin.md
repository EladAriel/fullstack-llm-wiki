...
generated_at: "2026-08-29T09:39:20.144513Z"
---
# $asin (expression operator)

**meta:** :description: Calculate the inverse sine of a value using the `$asin` operator in MongoDB aggregation, returning results in radians or degrees.
