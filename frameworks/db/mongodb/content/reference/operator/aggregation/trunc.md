...
generated_at: "2026-08-29T09:39:20.231550Z"
---
# $trunc  (expression operator)

**meta:** :description: Use `$trunc` in MongoDB to truncate numbers to a whole integer or specified decimal place in aggregation operations.
...
If you print a double-precision floating point number ``4.56`` with 20
digits after the decimal separator, you will see
``4.55999999999999960920``, which is slightly less than ``4.56`` and is
truncated to ``4.55``.
