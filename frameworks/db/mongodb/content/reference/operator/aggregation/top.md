...
generated_at: "2026-08-29T09:39:20.206396Z"
---
.. _top_accumulator_operator:

# $top (accumulator operator)

**meta:** :description: Use the `$top` accumulator to return the top element within a group based on specified sort order in MongoDB aggregation.
...
**note:** Disambiguation
   ...
   This page describes the ``$top`` accumulator operator. For the ``$top``
   expression operator, see :ref:`$top (expression operator) <top_expression_operator>`. 
