...
generated_at: "2026-08-29T09:39:20.129512Z"
---
# $dateAdd (expression operator)

**meta:** :description: Increment a date by specified time units using `$dateAdd` in MongoDB aggregation, with options for timezone adjustments.
   ...
   .. list-table::
      ...
      * - ``unit``
        ...
        - The ``unit`` used to measure the ``amount`` of time added to
          ...
          .. include:: /includes/aggregation/fact-agg-epoch-millisecond-change.rst
