...
generated_at: "2026-08-29T09:39:20.231930Z"
---
# $reverseArray  (expression operator)

**meta:** :description: Use `$reverseArray` in MongoDB to reverse the order of elements in an array expression, returning null for non-array inputs.
