...
generated_at: "2026-08-29T09:39:20.143235Z"
---
.. _convert-aggregation-operator:
...
**meta:** :description: Learn how to use an aggregation operator to convert a value to a specified data type.
  :keywords: data type
...
.. list-table::
   ...
   * - ``input``
     ...
     - The argument can be any valid :ref:`expression
       ...
       Starting in MongoDB 8.3, you can also set the ``to`` field to ``binData``
       if the ``input`` field is an ``array`` of numeric values. For examples,
       see :ref:`Convert an Array of Numeric Values to binData 
       <convert-array-of-numeric-values-to-bindata>`.
   ...
   * - ``to.type``
     ...
     - The argument can be any valid :ref:`expression
       <aggregation-expressions>` that resolves to a numeric or string
       identifier. For available identifiers, see
       :ref:`convert-type-identifiers`.

   * - ``to.subtype``
     - Optional
     - If ``to.type`` is ``binData``, ``to.subtype`` specifies the
       binData subtype to convert to. For valid values, see
       :ref:`convert-binary-subtypes`. *Default:* 0 (Generic binary
       subtype).

   * - ``byteOrder``
     - Optional
     - Specifies big or little endian byte ordering for conversions between ``binData``
       and numeric types. If unspecified, the default is little endian byte
       ordering. 
   ...
   * - ``base``
     ...
     - Integer base for conversions between string and numeric types.
       ...
       - If ``null``, :expression:`$convert` behaves as if you omitted
         base.
         
       - If specified, MongoDB interprets the value in the chosen base
         when converting between strings and the numeric types
         ``int``, ``long``, ``double``, and ``decimal``. For other
         conversions, MongoDB validates the value of ``base`` but
...
.. _convert-type-identifiers:

### Type Identifiers

The ``to.type`` field accepts the following numeric and string
identifiers:
...
.. list-table::
   ...
   * - "double"
     - 1
     - See :ref:`convert-to-double`.

   * - "string"
     - 2
     - See :ref:`convert-to-string`.

   * - "object"
     - 3
     - See :ref:`convert-to-object`.

   * - "array"
     - 4
     - See :ref:`convert-to-array`.

   * - "binData"
     - 5
     - See :ref:`convert-to-binData`.

   * - "objectId"
     - 7
     - See :ref:`convert-to-objectId`.

   * - "bool"
     - 8
     - See :ref:`convert-to-bool`.

   * - "date"
     - 9
     - See :ref:`convert-to-date`.

   * - "int"
     - 16
     - See :ref:`convert-to-int`.

   * - "long"
     - 18
     - See :ref:`convert-to-long`.

   * - "decimal"
     - 19
     - See :ref:`convert-to-decimal`.

.. _convert-binary-subtypes:

### Binary Subtypes

The following table lists the valid values for the ``to.subtype``
field:
...
The following sections describe how to convert values to different
types.
...
**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/long/load-data.snippet.insert-long.js
   :language: javascript
   :category: usage example

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/long/convert-long-to-bindata.snippet.convert-long-to-bindata.js
   :language: javascript
   :category: usage example

**Output**:

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/long/output.sh
   :language: javascript
   :category: usage example
   :copyable: false
...
**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/long-big-endian/load-data.snippet.insert-long-big-endian.js
   :language: javascript
   :category: usage example

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/long-big-endian/convert-long-big-endian-to-bindata.snippet.convert-long-big-endian-to-bindata.js
   :language: javascript
   :category: usage example

**Output**:

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/long-big-endian/output.sh
   :language: javascript
   :category: usage example
   :copyable: false
...
**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/double/load-data.snippet.insert-double.js
   :language: javascript
   :category: usage example

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/double/convert-double-to-bindata.snippet.convert-double-to-bindata.js
   :language: javascript
   :category: usage example

**Output**:

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/double/output.sh
   :language: javascript
   :category: usage example
   :copyable: false
...
**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/int/load-data.snippet.insert-int.js
   :language: javascript
   :category: usage example

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/int/convert-int-to-bindata.snippet.convert-int-to-bindata.js
   :language: javascript
   :category: usage example

**Output**:

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/int/output.sh
   :language: javascript
   :category: usage example
   :copyable: false

.. _convert-array-of-numeric-values-to-bindata:
...
**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/array/load-data.snippet.insert-variants-array.js
   :language: javascript
   :category: usage example

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/array/convert-array-to-bindata.snippet.convert-array-to-bindata.js
   :language: javascript
   :category: usage example

**Output**:

**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/array/output.sh
   :language: javascript
   :category: usage example
   :copyable: false
...
**literalinclude:** /code-examples/tested/command-line/mongosh/aggregation/expressions/convert/bindata-to-array/variants/convert-bindata-to-array-variants.snippet.convert-bindata-to-array-variants.js
   :language: javascript
   :category: usage example
...
.. list-table::
   ...
   * - String
     - Returns the numerical value of the string as an integer.
       ...
       If you omit ``base`` or set to ``null``, the string value must
       be a valid base\ :sub:`10` integer and fall within the minimum
       and maximum value for an integer.

       If you specify ``base``, the string must only contain digits
       valid in that base. Prefixes, such as ``"0x"``, are not allowed.
       The resulting integer must be within the minimum and maximum
...
.. list-table::
   ...
   * - String
     - Returns the numerical value of the string as a decimal.
       ...
       If you omit ``base`` or set to ``null``, the string value must
       be a valid base\ :sub:`10` decimal and fall within the
       minimum and maximum value for a decimal.

       If you specify ``base``, the string must only contain digits
       valid in that base. Prefixes, such as ``"0x"``, are not allowed.
       The resulting decimal must be within the minimum and maximum
       value for a decimal.
...
.. list-table::
   ...
   * - String
     - Returns the numerical value of the string as a double.
       ...
       If you omit ``base`` or set to ``null``, the string value must
       be a valid base\ :sub:`10` double and fall within the
       minimum and maximum value for a double.

       If you specify ``base``, the string must only contain digits
       valid in that base. Prefixes, such as ``"0x"``, are not allowed.
       The resulting double must be within the minimum and maximum
       value for a double.
...
.. _subnormal-numbers-parse-behavior-convert:
...
.. list-table::
   ...
   * - String
     - Returns the numerical value of the string.
       ...
       If you omit ``base`` or set to ``null``, the string value must
       be a valid base\ :sub:`10` long and fall within the
       minimum and maximum value for a long.

       If you specify ``base``, the string must only contain digits
       valid in that base. Prefixes, such as ``"0x"``, are not allowed.
       The resulting long must be within the minimum and maximum
       value for a long.
...
The following example converts between numbers and strings using
different bases:
