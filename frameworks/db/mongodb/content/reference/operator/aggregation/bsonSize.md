...
generated_at: "2026-08-29T09:39:20.231093Z"
---
# $bsonSize (expression operator)

**meta:** :description: Calculate the size in bytes of a document using the `$bsonSize` operator in MongoDB aggregation pipelines.
