...
generated_at: "2026-08-29T09:39:20.154738Z"
---
# $allElementsTrue (expression operator)

**meta:** :description: Evaluate arrays using `$allElementsTrue` to return `true` if no element is `false`, including handling nested arrays and specific values like `null` and `0`.
