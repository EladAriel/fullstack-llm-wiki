...
generated_at: "2026-08-29T09:39:20.164920Z"
---
# $asinh (expression operator)

**meta:** :description: Calculate the inverse hyperbolic sine of a value using the `$asinh` operator in MongoDB, with results in radians or degrees.
