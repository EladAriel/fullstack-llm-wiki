...
generated_at: "2026-08-29T09:39:20.146587Z"
---
# $sinh  (expression operator)

**meta:** :description: Calculate the hyperbolic sine of a value in radians using the `$sinh` operator in MongoDB aggregation.
