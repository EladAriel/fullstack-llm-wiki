...
source_branch: "main"
source_path: "content/manual/manual/source/reference/operator/aggregation/last.txt"
...
Returns the result of an `expression <aggregation-expressions>` for the last document in a group of documents. Only meaningful when documents are in a defined order.
...
:pipeline:`$setWindowFields` stages, `$last` returns the entire array from the last document. It does not traverse array elements.
