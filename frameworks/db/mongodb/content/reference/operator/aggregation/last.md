...
generated_at: "2026-08-29T09:39:20.225309Z"
---
# $last (accumulator operator)

**meta:** :description: Use `$last` in aggregation to return the result of an expression for the last document in a defined order within a group.
