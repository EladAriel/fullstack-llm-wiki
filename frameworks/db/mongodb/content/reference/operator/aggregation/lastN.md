...
generated_at: "2026-08-29T09:39:20.223971Z"
---
# $lastN (accumulator operator)

**meta:** :description: Use `$lastN` to aggregate or retrieve the last `n` elements from a group or array, supporting sorting and dynamic `n` values.
...
When ``$lastN`` is used as an aggregation accumulator, the elements returned 
