...
generated_at: "2026-08-29T09:39:20.219852Z"
---
# $indexOfBytes (expression operator)

**meta:** :description: Search for a substring in a string using `$indexOfBytes` to return the UTF-8 byte index of the first occurrence or `-1` if not found.
