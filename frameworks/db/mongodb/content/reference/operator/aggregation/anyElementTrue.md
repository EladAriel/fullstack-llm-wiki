...
generated_at: "2026-08-29T09:39:20.198418Z"
---
# $anyElementTrue (expression operator)

**meta:** :description: Evaluate arrays using `$anyElementTrue` to return `true` if any element is `true`, and `false` for empty arrays or elements like `null`, `0`, or `undefined`.
