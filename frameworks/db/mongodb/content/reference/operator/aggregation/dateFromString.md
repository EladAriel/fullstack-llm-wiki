...
generated_at: "2026-08-29T09:39:20.148073Z"
---
# $dateFromString (expression operator)

**meta:** :description: Convert date/time strings to date objects using `$dateFromString` in MongoDB aggregation, with options for format, timezone, error handling, and null values.
