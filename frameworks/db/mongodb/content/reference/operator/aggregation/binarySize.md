...
generated_at: "2026-08-29T09:39:20.139179Z"
---
# $binarySize (expression operator)

**meta:** :description: Calculate the size in bytes of a string or binary data using the `$binarySize` operator in MongoDB aggregation.
