...
generated_at: "2026-08-29T09:39:20.169341Z"
---
# $setField  (expression operator)

**meta:** :description: Modify documents by adding, updating, or removing fields using the `$setField` operator in MongoDB aggregation.
...
document, ``"price.usd"``. The value of ``"price.usd"`` equals the
...
of ``"$price"`` equals the value of ``"price"`` in each document.
