...
generated_at: "2026-08-29T09:39:20.137273Z"
---
# $shift  (expression operator)

**meta:** :description: Use the `$shift` operator in the `$setWindowFields` stage to return a field value from a document at a specified position relative to the current document.
