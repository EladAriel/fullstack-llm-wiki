...
generated_at: "2026-08-29T09:39:20.136257Z"
---
# $setIntersection  (expression operator)

**meta:** :description: Use `$setIntersection` to find common elements in arrays, treating them as sets, and return unique entries in the result.
