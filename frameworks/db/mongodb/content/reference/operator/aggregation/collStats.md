...
generated_at: "2026-08-29T09:39:20.207828Z"
---
.. _coll-stats-agg:

# $collStats (aggregation stage)

**meta:** :description: Retrieve collection statistics using the `$collStats` aggregation stage, including latency, storage, count, and query execution stats.
