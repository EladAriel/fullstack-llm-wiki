...
generated_at: "2026-08-29T09:39:20.194448Z"
---
# $trim  (expression operator)

**meta:** :description: Use the `$trim` operator in MongoDB to remove whitespace or specified characters from the beginning and end of a string in aggregation operations.
