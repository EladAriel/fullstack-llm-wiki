...
generated_at: "2026-08-29T09:39:20.151360Z"
---
# $zip  (expression operator)

**meta:** :description: Transpose arrays using the `$zip` operator in MongoDB aggregation, with options for handling arrays of different lengths.
