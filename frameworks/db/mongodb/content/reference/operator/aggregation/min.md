...
generated_at: "2026-08-29T09:39:20.199536Z"
---
# $min (accumulator operator)

**meta:** :description: Discover how to use the `$min` operator in various aggregation stages to find the minimum value in MongoDB collections.
