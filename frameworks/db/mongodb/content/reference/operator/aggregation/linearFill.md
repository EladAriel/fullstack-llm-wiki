...
generated_at: "2026-08-29T09:39:20.136742Z"
---
# $linearFill (expression operator)

**meta:** :description: Fill null and missing fields using `$linearFill` for linear interpolation in the `$setWindowFields` stage of MongoDB aggregation.
