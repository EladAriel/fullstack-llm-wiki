...
generated_at: "2026-08-29T09:39:20.122224Z"
---
# $covariancePop (expression operator)

**meta:** :description: Calculate population covariance of two numeric expressions using `$covariancePop` in the `$setWindowFields` stage.
