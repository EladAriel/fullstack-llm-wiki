...
generated_at: "2026-08-29T09:39:20.168644Z"
---
# $minN (aggregation accumulator)

**meta:** :description: Use `$minN` to aggregate the minimum `n` values within a group, filtering out null and missing values, with dynamic `n` based on group keys.
