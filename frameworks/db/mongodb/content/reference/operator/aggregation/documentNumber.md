...
generated_at: "2026-08-29T09:39:20.179658Z"
---
# $documentNumber (expression operator)

**meta:** :description: Use the `$documentNumber` operator in `$setWindowFields` to assign unique sequential positions to documents within partitions based on sorting criteria.
