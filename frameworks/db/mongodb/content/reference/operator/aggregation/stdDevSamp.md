...
generated_at: "2026-08-29T09:39:20.216577Z"
---
# $stdDevSamp (accumulator operator)

**meta:** :description: Calculate the sample standard deviation of input values using `$stdDevSamp` in various aggregation stages, ignoring non-numeric values.
