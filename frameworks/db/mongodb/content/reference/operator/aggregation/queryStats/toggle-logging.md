...
generated_at: "2026-08-29T09:39:20.254505Z"
---
.. _queryStats-toggle-logging:

# Toggle $queryStats Log Output

**meta:** :description: Toggle the logging of `$queryStats` output in MongoDB Atlas to manage performance impact and information detail.
