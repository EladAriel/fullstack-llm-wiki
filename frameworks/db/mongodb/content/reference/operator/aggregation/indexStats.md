...
generated_at: "2026-08-29T09:39:20.175467Z"
---
# $indexStats (aggregation stage)

**meta:** :description: Retrieve index usage statistics for a collection using the `$indexStats` aggregation stage.
   ...
   .. list-table::
      ...
      * - :ref:`accesses <indexStats-output-accesses>`
        ...
        - .. _indexStats-output-accesses:
          ...
          Index usage metrics for the associated :ref:`host
          <indexStats-output-host>`, including: 

          - ``ops``: the number of user operations that used the index.
            This does not include internal operations like deletion via
            :ref:`TTL indexes <index-feature-ttl>` or chunk split and
            migration operations.

          - ``since``: the time from which MongoDB gathered the
            statistics

          :red:`WARNING:` The ``accesses`` field reports index usage
          metrics only for the node where the query runs. For more
          comprehensive index usage statistics, run
          :pipeline:`$indexStats` on each node in the cluster.
...
via :ref:`TTL indexes <index-feature-ttl>` or chunk split and migration operations.
   ...
   .. tab::
      ...
      .. include:: /includes/driver-examples/node/aggregation/stage-intro.rst
         ...
         .. replacement:: method-description
            ...
            returns a document that contains usage statistics for each index on
            the collection
         
         .. replacement:: more-method-description

      .. literalinclude:: /includes/driver-examples/node/aggregation/examples.js
         :start-after: //start indexStats
         :end-before: //end indexStats
         :language: javascript
         :dedent: 2