...
generated_at: "2026-08-29T09:39:20.235756Z"
---
# $strLenBytes (expression operator)

**meta:** :description: Calculate the number of UTF-8 encoded bytes in a string using the `$strLenBytes` operator in MongoDB aggregation.
