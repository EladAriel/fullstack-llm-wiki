...
generated_at: "2026-08-29T09:39:20.224853Z"
---
# $cosh (expression operator)

**meta:** :description: Calculate the hyperbolic cosine of a value in radians using the `$cosh` operator in MongoDB aggregation.
