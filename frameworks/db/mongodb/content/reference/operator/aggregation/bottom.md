...
generated_at: "2026-08-29T09:39:20.204904Z"
---
.. _bottom_accumulator_operator:

# $bottom (accumulator operator)

**meta:** :description: Use the `$bottom` accumulator to return the lowest element in a group based on a specified sort order in MongoDB aggregation.
...
**note:** Disambiguation
   ...
   This page describes the ``$bottom`` accumulator operator. For the ``$bottom``
   expression operator, see :ref:`$bottom (expression operator) <bottom_expression_operator>`. 
