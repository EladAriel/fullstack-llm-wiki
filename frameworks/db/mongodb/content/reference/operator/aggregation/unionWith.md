...
generated_at: "2026-08-29T09:39:20.114397Z"
---
# $unionWith (aggregation stage)

**meta:** :description: Use `$unionWith` to combine two aggregations into a single result set, allowing for duplicate entries and supporting various MongoDB aggregation pipeline stages.
...
document, the operation uses that collation and ignores any other
collations.
   ...
   .. tab::
      ...
      .. sharedinclude:: dbx/csharp/aggregation/rst-files/method-intro.rst
         ...
         .. replacement:: method-description
            ...
            combines movies with a ``Metacritic`` score of ``100``
            from the ``sample_mflix.movies`` collection with movies
      ...
      .. io-code-block::
         ...
         .. input:: /code-examples/tested/csharp/driver/Aggregation/Builders/UnionWith.snippet.union-with.cs
            :language: csharp
            :category: usage example

         .. output:: /code-examples/tested/csharp/driver/Aggregation/Builders/OutputFiles/UnionWithOutput.txt
            :language: json
