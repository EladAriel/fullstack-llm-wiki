...
generated_at: "2026-08-29T09:39:20.147468Z"
---
# $substrCP  (expression operator)

**meta:** :description: Extract substrings from strings using the `$substrCP` operator based on UTF-8 code points in MongoDB aggregation.
