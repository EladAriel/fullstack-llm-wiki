...
generated_at: "2026-08-29T09:39:20.214550Z"
---
# $planCacheStats

**meta:** :description: Retrieve plan cache information for a collection using the `$planCacheStats` aggregation stage, which must be the first stage in the pipeline.
...
**seealso:** :ref:`query-plans-query-optimization`
...
**tabs:** .. tab:: Classic Execution Engine
            ...
            "creationExecStats" : [   // Exec Stats Document for each candidate plan
               {
                  ...
                  "peakTrackedMemBytes" : <num>,  // Available starting in MongoDB 8.3
