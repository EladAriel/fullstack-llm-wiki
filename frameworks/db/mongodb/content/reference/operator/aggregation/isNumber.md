...
generated_at: "2026-08-29T09:39:20.217058Z"
---
# $isNumber (expression operator)

**meta:** :description: Use `$isNumber` in MongoDB aggregation to check if an expression resolves to a numeric BSON type, returning true for numbers and false for other types.
