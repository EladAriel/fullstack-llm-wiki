...
generated_at: "2026-08-29T09:39:20.121860Z"
---
# $toLower  (expression operator)

**meta:** :description: Convert strings to lowercase using the `$toLower` aggregation operator, which returns an empty string for null values.
