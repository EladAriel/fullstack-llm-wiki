...
generated_at: "2026-08-29T09:39:20.150209Z"
---
# $sin  (expression operator)

**meta:** :description: Calculate the sine of a value in radians using the `$sin` operator, with examples for handling different input types.
