...
source_branch: "main"
source_path: "content/manual/manual/source/reference/operator/aggregation/listSessions.txt"
source_commit: "b9f2bc487a2878b65e3c1f80024bebab76954f27"
source_commit_short: "b9f2bc48"
source_commit_date: "2026-08-28T17:09:45-05:00"
generated_at: "2026-08-29T09:39:20.218876Z"
---
# $listSessions (aggregation stage)

**meta:** :description: List sessions stored in the `system.sessions` collection using the `$listSessions` aggregation stage, with options for user-specific or all-user sessions.
...
### List All Sessions for the Current User
   ...
   .. tab::
      ...
      To use the {+node-driver-full+} to add a ``$listSessions`` stage to an
      aggregation pipeline, use the ``$listSessions`` operator in a pipeline
      object. Run the pipeline on the :data:`system.sessions
...
### List All Sessions
      ...
      .. literalinclude:: /includes/driver-examples/node/aggregation/examples.js
         :start-after: //start listSessionsAll
         :end-before: //end listSessionsAll
         :language: javascript
         :dedent: 2
...
### List All Sessions for the Specified Users
      ...
      The following aggregation operation lists all sessions for the specified
      user ``myAppReader@test``:

      .. literalinclude:: /includes/driver-examples/node/aggregation/examples.js
         :start-after: //start listSessionsSpec
         :end-before: //end listSessionsSpec
         :language: javascript
         :dedent: 2
...
### List All Sessions for the Current User
      ...
      .. literalinclude:: /includes/driver-examples/node/aggregation/examples.js
         :start-after: //start listSessionsCurrent
         :end-before: //end listSessionsCurrent
         :language: javascript
         :dedent: 2
...
:pipeline:`$listSessions` returns a cursor with one document per
session. Each document has the following prototype:
...
.. list-table::
   ...
   * - ``_id.id``
     - UUID
     - The universally unique identifier (UUID) of the session.

   * - ``_id.uid``
     - BinData
     - A hash of the authenticated user's credentials associated with
       the session.

   * - ``lastUse``
     - date
     - The date and time the session was last used.