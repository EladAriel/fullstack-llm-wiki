...
generated_at: "2026-08-29T09:39:20.168037Z"
---
# $denseRank (expression operator)

**meta:** :description: Explore how to use the `$denseRank` operator in MongoDB to rank documents within partitions, handling duplicates, nulls, and missing values without gaps.
