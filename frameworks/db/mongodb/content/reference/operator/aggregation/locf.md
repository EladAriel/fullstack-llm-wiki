...
generated_at: "2026-08-29T09:39:20.185263Z"
---
# $locf (expression operator)

**meta:** :description: Use the `$locf` operator in the `$setWindowFields` stage to fill missing values with the last non-null observation in a sequence.
