...
generated_at: "2026-08-29T09:39:20.126571Z"
---
# $acos (expression operator)

**meta:** :description: Calculate the inverse cosine of a value using the `$acos` operator in MongoDB, returning results in radians or degrees.
