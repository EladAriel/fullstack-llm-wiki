...
generated_at: "2026-08-29T09:39:20.140074Z"
---
# $dateSubtract (expression operator)

**meta:** :description: Use `$dateSubtract` to decrement a `Date()` object by specified time units, with optional timezone adjustments.
