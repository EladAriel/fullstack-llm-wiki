...
generated_at: "2026-08-29T09:39:20.236157Z"
---
# $covarianceSamp (expression operator)

**meta:** :description: Calculate the sample covariance of two numeric expressions using `$covarianceSamp` in the `$setWindowFields` stage.
