...
generated_at: "2026-08-29T09:39:20.203839Z"
---
# $count (accumulator operator)

**meta:** :description: Explore how to use the `$count` aggregation accumulator to count documents in MongoDB, including examples with `$group` and `$setWindowFields` stages.
