...
generated_at: "2026-08-29T09:39:20.222698Z"
---
...
**meta:** :description: Learn how to use an aggregation operator to return a subset of an array based on a specified condition.
...
.. list-table::
   ...
   * - ``as``
     ...
     - Optional. A name for the :ref:`variable
       <aggregation-variables>` that represents each
   ...
   * - ``arrayIndexAs``
     ...
     - .. include:: /includes/arrayIndexAs-field.rst
       ...
       For examples, see :ref:`filter-index-example` and
       :ref:`filter-IDX-example`.
...
previous section :ref:`filter-index-example`, but uses ``$$IDX`` instead
of ``arrayIndexAs``:
