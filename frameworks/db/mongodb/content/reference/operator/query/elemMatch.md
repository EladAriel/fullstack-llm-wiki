...
generated_at: "2026-08-29T09:39:20.251112Z"
---
...
**meta:** :description: Use the $elemMatch operator to match documents with array fields containing elements that meet specified criteria.
...
The document with an ``_id`` of ``5`` doesn't contain an array. The
document is included to show that ``$elemMatch`` matches only array
elements.
