...
generated_at: "2026-08-29T09:39:20.244321Z"
---
# $lt (query predicate operator)

**meta:** :description: Select documents with fields less than a specified value using the `$lt` operator in MongoDB queries.
