...
generated_at: "2026-08-29T09:39:20.247214Z"
---
# $lte (query predicate operator)

**meta:** :description: Select documents with fields less than or equal to a specified value using the `$lte` operator in MongoDB queries.
