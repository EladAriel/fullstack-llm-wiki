...
generated_at: "2026-08-29T09:39:20.249312Z"
---
.. _text-query-operator:
...
**meta:** :description: Use $text to perform full-text search on fields with a text index. Supports multi-term OR, negation, exact phrases, and relevance scoring for self-managed deployments.
   :keywords: on-prem
...
**seealso:** :ref:`match-operation-stemmed-words`
...
The examples assume a :ref:`version 3 text <index-type-text>`
index on the ``title`` and ``fullplot`` fields:

**literalinclude:** /code-examples/tested/command-line/mongosh/operators/text/text-create-index.snippet.text-create-index.js
   :language: javascript
   :copyable: true
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-single-word.snippet.text-search-single-word.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-single-word-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-multi-term.snippet.text-search-multi-term.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-multi-term-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-exact-phrase.snippet.text-search-exact-phrase.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-exact-phrase-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-exact-phrase-or.snippet.text-search-exact-phrase-or.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-exact-phrase-or-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-negation.snippet.text-search-negation.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-negation-output.sh
      :language: javascript
...
:expression:`$meta` to append the relevance score to each
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-score.snippet.text-search-score.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-score-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-top-two.snippet.text-search-top-two.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-top-two-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-sort-combined.snippet.text-search-sort-combined.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-sort-combined-output.sh
      :language: javascript
...
**literalinclude:** /code-examples/tested/command-line/mongosh/operators/text/text-articles-create-index.snippet.text-articles-create-index.js
   :language: javascript
   :copyable: true
   :category: usage example
...
**literalinclude:** /code-examples/tested/command-line/mongosh/operators/text/text-articles-insert-data.snippet.text-articles-insert-data.js
   :language: javascript
   :copyable: true
   :category: usage example
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-language.snippet.text-search-language.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-language-output.sh
      :language: javascript
...
Using version 3 text indexes, the query matches documents
containing the stemmed versions of the search terms:

.. io-code-block::
   :copyable: true

   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-diacritic-insensitive.snippet.text-search-case-diacritic-insensitive.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-diacritic-insensitive-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-sensitive-term.snippet.text-search-case-sensitive-term.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-sensitive-term-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-sensitive-exact.snippet.text-search-case-sensitive-exact.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-sensitive-exact-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-sensitive-negated.snippet.text-search-case-sensitive-negated.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-case-sensitive-negated-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-diacritic-sensitive-term.snippet.text-search-diacritic-sensitive-term.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-diacritic-sensitive-term-output.sh
      :language: javascript
...
.. io-code-block::
   ...
   .. input:: /code-examples/tested/command-line/mongosh/operators/text/text-search-diacritic-sensitive-negated.snippet.text-search-diacritic-sensitive-negated.js
      :language: javascript
      :category: usage example

   .. output:: /code-examples/tested/command-line/mongosh/operators/text/text-search-diacritic-sensitive-negated-output.sh
      :language: javascript

**seealso:** - :ref:`index-type-text`
