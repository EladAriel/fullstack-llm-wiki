...
generated_at: "2026-08-29T09:39:20.238914Z"
---
# $geoIntersects (query predicate operator)

**meta:** :description: Select documents with geospatial data intersecting a specified GeoJSON object using the `$geoIntersects` operator.
