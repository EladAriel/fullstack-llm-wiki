...
generated_at: "2026-08-29T09:39:20.111189Z"
---
# $slice (projection operator)

**meta:** :description: Specify the number of elements to return from an array in a query result using the `$slice` projection operator.
