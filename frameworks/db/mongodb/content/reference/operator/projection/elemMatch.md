...
generated_at: "2026-08-29T09:39:20.110637Z"
---
# $elemMatch (projection operator)

**meta:** :description: Limit array field results using `$elemMatch` to return only the first element matching specified conditions in MongoDB queries.
