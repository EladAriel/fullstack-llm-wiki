...
generated_at: "2026-08-29T09:39:20.110045Z"
---
# \$  (projection operator)

**meta:** :description: Limit array contents using the positional `$` operator to return the first element matching a query condition in MongoDB.
