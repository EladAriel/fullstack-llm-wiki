...
generated_at: "2026-08-29T09:39:20.108016Z"
---
# $rename (update operator)

**meta:** :description: Rename fields in MongoDB documents using the `$rename` operator, which updates field names and handles embedded documents.
