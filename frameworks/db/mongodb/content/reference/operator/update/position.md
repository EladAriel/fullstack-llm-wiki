...
generated_at: "2026-08-29T09:39:20.103777Z"
---
# $position (update operator)

.. default-domain:: mongodb

**meta:** :description: Use the $position operator to update array elements without specifying their position.
...
:update:`$position` can accept a negative array index (position) value 
