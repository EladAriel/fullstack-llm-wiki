...
generated_at: "2026-08-29T09:39:20.102688Z"
---
...
**meta:** :description: Use the $currentDate operator to set field values to the current date or timestamp.
...
.. |operator-method| replace:: ``$currentDate``
