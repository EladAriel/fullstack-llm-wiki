...
generated_at: "2026-08-29T09:39:19.675010Z"
---
...
.. list-table::
   ...
   * - :method:`sp.processor.modify()`
     ...
     - Modifies an existing stream processor.
...
.. list-table::
   ...
   * - :method:`db.createEncryptedCollection()`
     ...
     - Creates an encrypted collection.
...
**toctree:** :titlesonly: 
   ...
   sp.processor.modify </reference/method/sp.processor.modify>
