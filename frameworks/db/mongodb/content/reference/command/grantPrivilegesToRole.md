...
generated_at: "2026-08-29T09:39:20.051659Z"
---
# grantPrivilegesToRole (database command)

**meta:** :description: Assign additional privileges to a user-defined role using the `grantPrivilegesToRole` command in MongoDB.
