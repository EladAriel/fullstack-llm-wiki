...
generated_at: "2026-08-29T09:39:20.095121Z"
---
.. _profile-command:

# profile (database command)

**meta:** :description: Configure the database profiler in MongoDB to capture performance data on operations, with options for filtering and logging slow operations.
...
**seealso:** :ref:`Database Profiling <database-profiling>`
