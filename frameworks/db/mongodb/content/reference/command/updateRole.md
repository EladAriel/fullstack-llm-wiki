...
generated_at: "2026-08-29T09:39:20.059669Z"
---
# updateRole (database command)

**meta:** :description: Update user-defined roles in MongoDB by specifying privileges, roles, and authentication restrictions using the `updateRole` command.
