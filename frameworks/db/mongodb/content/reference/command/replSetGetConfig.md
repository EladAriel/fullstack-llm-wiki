...
generated_at: "2026-08-29T09:39:20.078639Z"
---
# replSetGetConfig (database command)

**meta:** :description: Retrieve the current configuration of a replica set using the `replSetGetConfig` command, with options for additional fields like commitment status.
   ...
   * - :ref:`commitmentStatus <replSetGetConfig-output-commitmentStatus>`
     ...
     - .. _replSetGetConfig-output-commitmentStatus:
       ...
       - The last write operation to the replica set with the previous
         configuration has been :data:`majority-committed
