...
generated_at: "2026-08-29T09:39:20.025549Z"
---
# commitShardRemoval (database command)
**meta:** :description: Removes a shard from a sharded cluster.
...
"drainingComplete" }``, the balancer has finished moving chunks off the
