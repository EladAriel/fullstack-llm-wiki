...
generated_at: "2026-08-29T09:39:20.027800Z"
---
# removeShardFromZone (database command)

**meta:** :description: Remove the association between a shard and a zone using the `removeShardFromZone` command in MongoDB.
