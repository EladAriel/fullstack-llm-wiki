...
generated_at: "2026-08-29T09:39:20.050232Z"
---
.. _hostinfo-database-command:

# hostInfo (database command)

**meta:** :description: Retrieve system information for `mongod` or `mongos` using the `hostInfo` command, which provides details about the underlying environment and hardware.
