...
generated_at: "2026-08-29T09:39:20.029228Z"
---
# moveChunk (database command)

**meta:** :description: Move chunks between shards using the `moveChunk` command in MongoDB, specifying options like destination shard and write concern.
