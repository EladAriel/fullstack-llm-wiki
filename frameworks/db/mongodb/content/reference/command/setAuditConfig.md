...
generated_at: "2026-08-29T09:39:20.048242Z"
---
# setAuditConfig (database command)

**meta:** :description: Configure audit settings for `mongod` and `mongos` instances using the deprecated `setAuditConfig` command.
