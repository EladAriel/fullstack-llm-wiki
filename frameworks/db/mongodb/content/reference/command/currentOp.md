...
generated_at: "2026-08-29T09:39:20.047679Z"
---
# currentOp (database command)

**meta:** :description: Retrieve information on in-progress operations using the `$currentOp` aggregation stage, replacing the deprecated `currentOp` command.
