...
generated_at: "2026-08-29T09:39:20.027435Z"
---
.. _getlog-database-command:

# getLog (database command)

**meta:** :description: Retrieve recent `mongod` events using the `getLog` command, which reads from a RAM cache and returns data in JSON format.
