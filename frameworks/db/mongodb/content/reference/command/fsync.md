...
generated_at: "2026-08-29T09:39:20.044323Z"
---
...
**meta:** :description: the fsync command flushes all pending writes from the storage layer to disk.
...
**important:** :program:`mongod` uses :term:`journaling <journal>` to improve durability.
   Use :ref:`a file system or volume/block level snapshot tool <backup-with-journaling>`
