...
generated_at: "2026-08-29T09:39:20.020686Z"
---
# connPoolStats (database command)

**meta:** :description: Retrieve statistics on outgoing connections from a MongoDB instance using the `connPoolStats` command.
