...
generated_at: "2026-08-29T09:39:20.094576Z"
---
.. _usersinfo-database-command:

# usersInfo (database command)

**meta:** :description: Retrieve information about MongoDB users using the `usersInfo` command, with options to display credentials, privileges, and authentication restrictions.
