...
generated_at: "2026-08-29T09:39:20.079157Z"
---
# rotateCertificates (database command)

**meta:** :description: Rotate TLS certificates for `mongod` or `mongos` using the `rotateCertificates` command, ensuring updated values are defined in the configuration file.
