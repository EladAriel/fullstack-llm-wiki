...
generated_at: "2026-08-29T09:39:20.090113Z"
---
# createIndexes (database command)

**meta:** :description: Build one or more indexes on a collection using the `createIndexes` command, with options for write concern, commit quorum, and index types.
...
.. list-table::
   ...
   * - ``commitQuorum``
     ...
     - .. _createIndexes-cmd-commitQuorum:
       ...
       ``"votingMembers"``. See :dbcommand:`setIndexCommitQuorum`.
