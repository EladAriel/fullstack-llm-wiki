...
generated_at: "2026-08-29T09:39:20.011025Z"
---
# replSetStepDown (database command)

**meta:** :description: Use the replSetStepDown database command to step down a replica set primary to secondary. Accepts stepdown duration and an optional force step-down parameter.
