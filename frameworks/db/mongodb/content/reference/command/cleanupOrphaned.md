...
generated_at: "2026-08-29T09:39:20.009693Z"
---
# cleanupOrphaned (database command)

**meta:** :description: Use the `cleanupOrphaned` command to remove orphaned documents from a shard's primary replica set member without disabling the balancer.
