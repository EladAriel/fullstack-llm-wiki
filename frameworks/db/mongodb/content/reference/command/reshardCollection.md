...
generated_at: "2026-08-29T09:39:20.030039Z"
---
# reshardCollection (database command)

**meta:** :description: Change the shard key and data distribution of a collection using the `reshardCollection` command, with options for zones and forced redistribution.
...
.. list-table::
   ...
   * - ``numSamplesPerChunk``
     - integer
     - .. include:: /includes/fact-numSamplesPerChunk-desc.rst
   ...
   * - ``demoMode``
     - boolean
     - Optional. Allows resharding operations to complete quickly. When set to true, 
       ``demoMode`` bypasses the minimum resharding operation duration of 5 minutes. You 
       can use this parameter for resharding testing or demonstration purposes.
