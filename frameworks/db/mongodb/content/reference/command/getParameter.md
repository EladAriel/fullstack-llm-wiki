...
generated_at: "2026-08-29T09:39:20.067350Z"
---
# getParameter (database command)

**meta:** :description: Retrieve parameter values using the getParameter command in the admin database, with options for detailed reports and filtering by runtime or startup settings.
