...
generated_at: "2026-08-29T09:39:20.042668Z"
---
# lockInfo (database command)

**meta:** :description: Retrieve information on current locks held or pending on `mongod` instances using the `lockInfo` command.
