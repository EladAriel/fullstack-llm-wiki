...
When using `Stable API <stable-api>` V1, all :dbcommand:`find` command fields are supported except the following fields, which are not available in Stable API V1:
