...
generated_at: "2026-08-29T09:39:20.018621Z"
---
# planCacheClearFilters (database command)

**meta:** :description: Remove index filters from a collection using the `planCacheClearFilters` command, with options to clear specific or all filters.
...
**dbcommand:** planCacheClearFilters
   ...
   Specify the :term:`plan cache query shape` to remove a specific index filter.
