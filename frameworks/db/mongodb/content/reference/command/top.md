...
generated_at: "2026-08-29T09:39:20.072970Z"
---
# top (database command)

**meta:** :description: Retrieve usage statistics for collections using the `top` command, which provides metrics on read and write operations.
