...
generated_at: "2026-08-29T09:39:20.081587Z"
---
# enableSharding (database command)

**meta:** :description: Create a database using the `enableSharding` command, which is not required for sharding collections starting from MongoDB 6.0.
