...
generated_at: "2026-08-29T09:39:20.062184Z"
---
# dbHash (database command)

**meta:** :description: Compare databases across `mongod` instances using the `dbHash` command to return hash values and MD5 values for collections.
