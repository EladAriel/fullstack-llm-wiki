...
generated_at: "2026-08-29T09:39:20.093120Z"
---
# setDefaultRWConcern (database command)

**meta:** :description: Configure global default read and write concerns for replica sets or sharded clusters using the `setDefaultRWConcern` command.
