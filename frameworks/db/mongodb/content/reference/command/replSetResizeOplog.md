...
generated_at: "2026-08-29T09:39:20.080137Z"
---
# replSetResizeOplog (database command)

**meta:** :description: Resize the oplog or adjust its retention period dynamically using the `replSetResizeOplog` command without restarting `mongod`.
...
**note:** To resize the oplog in Atlas, see :ref:`set-oplog-min-window`.
