...
generated_at: "2026-08-29T09:39:20.077709Z"
---
# collMod (database command)

**meta:** :description: Modify collection options or view definitions using the `collMod` command, including changing index properties, validation rules, and time series settings.
...
**seealso:** :ref:`manual-timeseries-automatic-removal`
