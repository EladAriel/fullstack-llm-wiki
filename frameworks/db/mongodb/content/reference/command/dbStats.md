...
generated_at: "2026-08-29T09:39:20.026095Z"
---
.. _dbstats-database-command:

# dbStats (database command)

**meta:** :description: Retrieve storage statistics for a database using the `dbStats` command, including options for scaling and free storage details.
...
**data:** dbStats.indexSize
   ...
   .. note::
      ...
      .. |Clustered-collections| replace:: :ref:`clustered collections <clustered-collections>`
