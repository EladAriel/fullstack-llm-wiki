...
generated_at: "2026-08-29T09:39:20.024314Z"
---
# bulkWrite (database command)

**meta:** :description: Use the bulkWrite database command to perform CRUD operations across multiple collections in a single request. Includes syntax, command fields, output reference, and examples.
...
.. list-table::
  ...
  * - ``bypassDocumentValidation``
    - boolean
    - Optional
    - If ``true``, the operation bypasses
...
Replacing multiple separate write commands with a single ``bulkWrite``
command can improve performance by reducing network latency. For
...
**procedure:** :style: normal
   ...
   .. step:: Examine the output
      ...
      For details about the output fields, see the
