...
generated_at: "2026-08-29T09:39:20.016710Z"
---
# dataSize (database command)

**meta:** :description: Determine the size in bytes of specified data using the `dataSize` command, with options for key patterns and range bounds.
