...
generated_at: "2026-08-29T09:39:20.013041Z"
---
# updateZoneKeyRange (database command)

**meta:** :description: Manage shard key value ranges and zones using the `updateZoneKeyRange` command in MongoDB.
...
**tabs:** .. tab:: Hashed Field Is Prefix
      :tabid: hash-prefix
