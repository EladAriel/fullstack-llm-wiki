...
generated_at: "2026-08-29T09:39:20.058891Z"
---
.. _mapreduce-database-command:

# mapReduce (database command)

**meta:** :description: Explore alternatives to the deprecated map-reduce in MongoDB, focusing on using aggregation pipelines for better performance and usability. Includes syntax, fields, and output reference.
...
**dbcommand:** mapReduce
   ...
   Runs :term:`map-reduce` aggregation operations over a collection.
...
.. list-table::
   ...
   * - :ref:`mapReduce <cmd-mapreduce-collection>`
     ...
     - .. _cmd-mapreduce-collection:
       ...
       This collection is filtered using ``query`` before being processed
       by the ``map`` function.
   ...
   * - :ref:`sort <cmd-mapreduce-sort>`
     ...
     - .. _cmd-mapreduce-sort:
       ...
       Optional. Sorts the *input* documents. For example, specify
       the sort key to be the same as the emit key so that there are
       fewer reduce operations. The sort key must be in an existing
   ...
   * - :ref:`scope <cmd-mapreduce-scope>`
     ...
     - .. _cmd-mapreduce-scope:
       ...
       Optional. Specifies global variables that are available in the ``map``,
   ...
   * - :ref:`bypassDocumentValidation <cmd-mapreduce-bypassDocumentValidation>`
     ...
     - .. _cmd-mapreduce-bypassDocumentValidation:
       ...
       ``inline``, no :ref:`schema validation <schema-validation-overview>`
   ...
   * - :ref:`writeConcern <cmd-mapreduce-writeConcern>`
     ...
     - .. _cmd-mapreduce-writeConcern:
       ...
       to use when outputting to a collection. Omit to use the
...
In addition to the command-specific return fields above,
