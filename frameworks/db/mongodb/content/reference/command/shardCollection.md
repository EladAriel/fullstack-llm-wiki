...
generated_at: "2026-08-29T09:39:20.069889Z"
---
# shardCollection (database command)

**meta:** :description: Distribute documents across shards using the `shardCollection` command, specifying shard keys and optional parameters for initial chunk distribution.
...
.. list-table::
   ...
   * - ``timeField``
     ...
     - .. include:: /includes/time-series/fact-time-field-description.rst
       ...
       :red:`WARNING:` Starting in MongoDB 8.0, use of the ``timeField`` as a
       shard key in a time series collection is deprecated.
