...
generated_at: "2026-08-29T09:39:20.017899Z"
---
.. _sharding-remove-shard:

# removeShard (database command)

**meta:** :description: Remove a shard from a sharded cluster by draining its chunks to other shards using the balancer, ensuring no backups during the process.
...
**dbcommand:** removeShard
   ...
   .. warning::
      ...
      The shard draining process has been replaced by the
      following commands:
      ...
      Once the shard is drained, you can removed it with the
   ...
   .. note::
      ...
      The balancer must be enabled for ``removeShard`` to complete. If
      the balancer is disabled, the command remains in the draining state
      and does not finish, even if you have already moved all data off
      the shard.
