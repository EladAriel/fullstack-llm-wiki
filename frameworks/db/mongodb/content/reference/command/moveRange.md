...
generated_at: "2026-08-29T09:39:20.061685Z"
---
# moveRange (database command)

**meta:** :description: Execute the `moveRange` command to transfer data ranges between shards in MongoDB, specifying parameters like `min`, `max`, and `toShard`.
...
**seealso:** :ref:`<create-chunks-in-a-sharded-cluster>`
