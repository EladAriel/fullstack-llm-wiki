...
generated_at: "2026-08-29T09:39:20.014339Z"
---
...
**meta:** :keywords: Search
   :description: Create {+fts+} or Vector Search indexes on a specified collection using the `createSearchIndexes` command in MongoDB.
