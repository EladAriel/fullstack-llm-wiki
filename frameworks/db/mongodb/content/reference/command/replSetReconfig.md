...
generated_at: "2026-08-29T09:39:20.083547Z"
---
# replSetReconfig (database command)

**meta:** :description: Modify replica set configurations using the `replSetReconfig` command to add or remove members and alter options on existing members.
