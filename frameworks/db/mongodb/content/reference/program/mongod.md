...
`mongod` command-line options should primarily be used for testing. In production environments, use `configuration file options </reference/configuration-options>` to control database behavior.
