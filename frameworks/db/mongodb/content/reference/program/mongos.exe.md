...
generated_at: "2026-08-29T09:39:19.872904Z"
---
...
**meta:** :keywords: on-prem
   :description: Install and manage `mongos.exe` as a Windows Service with options for service name, display name, user, and password.
...
To install and use :binary:`mongos.exe`, see
