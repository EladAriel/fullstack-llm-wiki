...
generated_at: "2026-08-29T09:39:19.903484Z"
---
# db.getUser() (mongosh method)

**meta:** :description: Retrieve user information from a database using `db.getUser()`, with options to display credentials, custom data, privileges, and authentication restrictions.
