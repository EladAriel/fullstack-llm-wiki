...
generated_at: "2026-08-29T09:39:19.930952Z"
---
# cursor.tailable() (mongosh method)

**meta:** :description: Use `cursor.tailable()` to keep a cursor open on a capped collection, allowing it to await new data even after exhausting current results.
