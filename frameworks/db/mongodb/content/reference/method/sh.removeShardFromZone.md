...
generated_at: "2026-08-29T09:39:19.953603Z"
---
# sh.removeShardFromZone() (mongosh method)

**meta:** :description: Remove the association between a zone and a shard using `sh.removeShardFromZone()` in a sharded cluster.
