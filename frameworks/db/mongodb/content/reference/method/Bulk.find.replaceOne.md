...
generated_at: "2026-08-29T09:39:19.907008Z"
---
# Bulk.find.replaceOne() (mongosh method)

**meta:** :description: Use `Bulk.find.replaceOne()` to add a single document replacement operation to a bulk operations list, specifying conditions with `Bulk.find()`.
