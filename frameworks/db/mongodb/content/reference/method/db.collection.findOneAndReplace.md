...
generated_at: "2026-08-29T09:39:20.003377Z"
---
# db.collection.findOneAndReplace() (mongosh method)

**meta:** :description: Replace a single document in a collection using `findOneAndReplace()` with options for filtering, sorting, and projection.
