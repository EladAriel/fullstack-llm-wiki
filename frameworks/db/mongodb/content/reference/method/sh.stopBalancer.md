...
generated_at: "2026-08-29T09:39:19.893653Z"
---
# sh.stopBalancer() (mongosh method)

**meta:** :description: Disable the balancer in a sharded cluster using `sh.stopBalancer()` with optional timeout and interval parameters.
