...
generated_at: "2026-08-29T09:39:19.986642Z"
---
# Session.startTransaction() (mongosh method)

**meta:** :description: Start a multi-document transaction with `Session.startTransaction()` in MongoDB, specifying read and write concerns for operations within the session.
...
**method:** Session.startTransaction(<options>)
   ...
   .. note::
      ...
      server until the first command is sent on the session. Therefore,
      the snapshot time of the transaction won't be set until the first
      command is sent on the session.
   ...
   .. list-table::
      ...
      * - ``writeConcern``
        ...
        - *Optional*. A document that specifies the :ref:`write concern
          ...
          :ref:`failover process <replica-set-rollbacks>`.
...
**note:** If running with :ref:`access control <authorization>`, you
