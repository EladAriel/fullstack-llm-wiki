...
generated_at: "2026-08-29T09:39:19.902073Z"
---
# db.getRoles() (mongosh method)

**meta:** :description: Retrieve information about all roles in a database using `db.getRoles()`, including options for privileges and authentication restrictions.
