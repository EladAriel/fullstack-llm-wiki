...
generated_at: "2026-08-29T09:39:19.987384Z"
---
# Session

**meta:** :description: Explore methods for managing sessions in `mongosh`, including starting, ending, and handling transactions within a session.
...
### General Session Methods
   ...
   .. list-table::
      ...
      * - .. method:: Session.bulkWrite(operations, options)
        - Performs multiple write operations across databases and
          collections within the session. Requires MongoDB 8.0 or
          later. For parameters and return value details, see
