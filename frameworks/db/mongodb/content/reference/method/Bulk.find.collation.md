...
generated_at: "2026-08-29T09:39:19.962962Z"
---
# Bulk.find.collation() (mongosh method)

**meta:** :description: Specify collation for bulk write operations using `Bulk.find.collation()` to customize string comparison settings.
