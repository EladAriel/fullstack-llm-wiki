...
generated_at: "2026-08-29T09:39:19.933136Z"
---
# sh.enableAutoMerger() (mongosh method)

**meta:** :description: Enable automatic chunk merges for a specified namespace using the `sh.enableAutoMerger()` method in `mongosh`.
