...
generated_at: "2026-08-29T09:39:19.987722Z"
---
# Bulk.find.hint() (mongosh method)

**meta:** :description: Specify an index for bulk operations using `Bulk.find.hint()` to optimize update and replace operations in MongoDB.
