...
generated_at: "2026-08-29T09:39:19.940294Z"
---
# db.getCollection() (mongosh method)

**meta:** :description: Access collections with names that conflict with `mongosh` methods using `db.getCollection(name)` to perform operations like inserts.
...
**method:** db.getCollection(name)
   ...
   that begin with ``_`` or that match a :ref:`database shell method
   <js-database>`.
