...
generated_at: "2026-08-29T09:39:19.968812Z"
---
# db.collection.findOneAndDelete() (mongosh method)

**meta:** :description: Use `findOneAndDelete()` to delete a document matching filter and sort criteria, returning the deleted document with optional projection and collation settings.
