...
generated_at: "2026-08-29T09:39:19.963839Z"
---
# sp.createStreamProcessor() (mongosh method)

**meta:** :description: Create a Stream Processor on Atlas Stream Processing Workspaces using `sp.createStreamProcessor()` with specified pipeline and options.
...
.. list-table::
   ...
   * - ``name``
     ...
     - Logical name for the stream processor. This must be unique
       within the stream processing workspace.
   ...
   * - ``options.dlq``
     ...
     - Conditional
     - Object assigning a 
       :term:`dead letter queue` for your stream processing workspace.
