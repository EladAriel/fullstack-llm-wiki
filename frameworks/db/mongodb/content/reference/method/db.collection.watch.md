...
generated_at: "2026-08-29T09:39:19.945152Z"
---
# db.collection.watch() (mongosh method)

**meta:** :description: Explore how to use `db.collection.watch()` to open a change stream cursor on a collection, with options for filtering and resuming streams.
