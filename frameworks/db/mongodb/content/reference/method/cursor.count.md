...
generated_at: "2026-08-29T09:39:19.914408Z"
---
# cursor.count() (mongosh method)

**meta:** :description: Count documents using `cursor.count()` in MongoDB, noting its deprecation in favor of `countDocuments()` and `estimatedDocumentCount()`.
