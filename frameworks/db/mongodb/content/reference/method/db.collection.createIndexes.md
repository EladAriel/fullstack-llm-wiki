...
generated_at: "2026-08-29T09:39:19.979387Z"
---
# db.collection.createIndexes() (mongosh method)

**meta:** :description: Create one or more indexes on a MongoDB collection using `db.collection.createIndexes()` with customizable options and commit quorum settings.
...
- :ref:`Wildcard Index Concepts <wildcard-index-core>`
...
**literalinclude:** /code-examples/wildcard/specific.fields.insertMany.js
   :language: javascript
...
**literalinclude:** /code-examples/wildcard/specific.fields.find.js
   :language: javascript
...
``product_attributes.colors`` and ``product_attributes.material``
fields in the index. 
...
**literalinclude:** /code-examples/wildcard/specifc.fields.find.scalar.js
   :language: javascript
...
The wildcard index excludes the ``product_attributes.colors`` and
``product_attributes.material`` fields:
