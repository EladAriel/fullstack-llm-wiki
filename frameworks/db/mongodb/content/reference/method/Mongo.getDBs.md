...
generated_at: "2026-08-29T09:39:19.994144Z"
---
# Mongo.getDBs() (mongosh method)

**meta:** :description: Retrieve information about all available databases using the `Mongo.getDBs()` method, which utilizes the `listDatabases` command.
