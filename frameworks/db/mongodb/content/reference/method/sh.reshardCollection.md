...
generated_at: "2026-08-29T09:39:19.961136Z"
---
# sh.reshardCollection() (mongosh method)

**meta:** :description: Change the shard key and data distribution for a collection using the `sh.reshardCollection()` method, with options for zones and forced redistribution.
   ...
   .. list-table::
      ...
      * - ``options``
        ...
        - Optional. A document containing optional fields, including
          ``numInitialChunks``, ``numSamplesPerChunk``, ``collation``,
          ``zones``, and ``forceRedistribution``.
