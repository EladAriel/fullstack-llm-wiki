...
generated_at: "2026-08-29T09:39:19.971108Z"
---
# rs.reconfig() (mongosh method)

**meta:** :description: Reconfigure a replica set using `rs.reconfig()` to update its configuration, including options for force and maxTimeMS.
