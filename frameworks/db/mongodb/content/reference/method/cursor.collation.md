...
generated_at: "2026-08-29T09:39:19.982209Z"
---
.. _method-cursor-collation:

# cursor.collation() (mongosh method)

**meta:** :description: Specify collation for a cursor in MongoDB using `cursor.collation()` to customize string comparison rules like locale, case, and diacritics.
