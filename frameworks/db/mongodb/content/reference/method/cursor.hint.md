...
generated_at: "2026-08-29T09:39:19.970435Z"
---
.. _cursor-hint:

# cursor.hint() (mongosh method)

**meta:** :description: Override MongoDB's default index selection for queries using the `cursor.hint()` method to specify a particular index.
