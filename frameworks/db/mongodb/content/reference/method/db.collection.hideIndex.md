...
generated_at: "2026-08-29T09:39:19.891789Z"
---
.. _collection-hide-index:

# db.collection.hideIndex() (mongosh method)

**meta:** :description: Hide an existing index from the query planner using `db.collection.hideIndex()` to evaluate the impact of dropping an index without actually removing it.
