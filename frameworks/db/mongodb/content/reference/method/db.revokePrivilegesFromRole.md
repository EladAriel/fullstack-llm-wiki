...
generated_at: "2026-08-29T09:39:20.001197Z"
---
# db.revokePrivilegesFromRole() (mongosh method)

**meta:** :description: Remove specified privileges from a user-defined role using `db.revokePrivilegesFromRole()` in MongoDB.
