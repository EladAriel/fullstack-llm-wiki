...
generated_at: "2026-08-29T09:39:19.939261Z"
---
# sp.processor.stats() (mongosh method)

**meta:** :description: Retrieve statistics of a running Stream Processor using `sp.processor.stats()` with optional settings for scale and verbosity.
