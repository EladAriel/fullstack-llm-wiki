...
generated_at: "2026-08-29T09:39:19.970098Z"
---
...
**meta:** :description: db.fsyncLock() flushes all pending writes from the storage layer to disk and locks the server to prevent additional writes until the lock is released.
