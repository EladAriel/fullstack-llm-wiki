...
generated_at: "2026-08-29T09:39:19.971457Z"
---
# Bulk.find() (mongosh method)

**meta:** :description: Specify query conditions for bulk write operations using `Bulk.find()` to select documents for updates or removals.
