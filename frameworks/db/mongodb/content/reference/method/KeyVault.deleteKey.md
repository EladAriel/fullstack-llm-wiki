...
generated_at: "2026-08-29T09:39:19.883159Z"
---
.. _keyvault-deletekey-method:

# KeyVault.deleteKey() (mongosh method)

**meta:** :description: Delete a data encryption key from the key vault using the `deleteKey()` method with a specified UUID.
...
**seealso:** :ref:`field-level-encryption-data-key-delete`