...
generated_at: "2026-08-29T09:39:19.904721Z"
---
.. _cursor-maxTimeMS:

# cursor.maxTimeMS() (mongosh method)

**meta:** :description: Specify a cumulative time limit in milliseconds for processing operations on a cursor using the `maxTimeMS()` method.
