...
generated_at: "2026-08-29T09:39:19.916221Z"
---
# getKeyVault() (mongosh method)

**meta:** :description: Access the KeyVault object for managing data encryption keys in Client-Side Field Level Encryption using the `getKeyVault()` method.
