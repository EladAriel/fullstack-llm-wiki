...
generated_at: "2026-08-29T09:39:19.929005Z"
---
.. _method-createIndex:
...
**meta:** :description: Create an index on a collection to improve performance for queries.
...
**literalinclude:** /includes/driver-examples/mongosh/indexes/create-syntax.js
   :language: javascript
   :copyable: false
...
**literalinclude:** /includes/driver-examples/mongosh/indexes/create-example.js
   :language: javascript
   :copyable: false
...
.. list-table::
   ...
   * - ``storageEngine``
     ...
     - Optional. Allows users to configure the storage engine on a
       ...
       .. literalinclude:: /includes/driver-examples/mongosh/indexes/storage-engine.js
          :language: javascript
          :copyable: false
...
.. list-table::
   ...
   * - ``wildcardProjection``
     ...
     - Optional. Allows users to include or exclude specific field paths
       ...
       .. literalinclude:: /includes/driver-examples/mongosh/indexes/wildcard-syntax.js
          :language: javascript
          :copyable: false
...
- To change the ``hidden`` option for an index to ``true``, use the
  ...
  .. literalinclude:: /code-examples/tested/command-line/mongosh/indexes/hidden/hide/hide.snippet.hide-index.js
     :language: javascript
     :copyable: true
...
- To change the ``hidden`` option for an index to ``false``, use the
  ...
  .. literalinclude:: /code-examples/tested/command-line/mongosh/indexes/hidden/unhide/unhide.snippet.unhide-index.js
     :language: javascript
     :copyable: true
     :category: usage example
...
The following example creates a compound index on the ``year``, ``runtime``, and
``title`` fields:
...
The following example creates a compound index on the ``title`` field
(in ascending order) and the ``runtime`` field (hashed):

**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/compound/create-compound-index-hashed-field/create-index.snippet.create-compound-index-hashed-field.js
   :language: javascript
   :category: usage example

For more information on hashed indexes, see :ref:`index-type-hashed`.
...
**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/create-wildcard/create-wildcard-awards-field/create.snippet.create-wildcard-index.js
   :language: javascript
   :copyable: true
   :category: usage example

With this wildcard index, MongoDB indexes all scalar values of
``awards``. If the field is a nested document or array, the
wildcard index recurses into the document or array and indexes all scalar
fields in the document or array.

The wildcard index can support arbitrary single-field queries on 
``awards`` or one of its nested fields:

**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/find-wildcard/find-awards-wins/find.snippet.find-wildcard-awards-wins.js
   :language: javascript
   :copyable: true
   :category: usage example

**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/find-wildcard/find-awards-nominations/find.snippet.find-wildcard-index-awards-nominations.js
   :language: javascript
   :copyable: true
   :category: usage example
...
**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/create-wildcard/create-wildcard-all-field-paths/create.snippet.create-wildcard-all-field-paths.js
   :language: javascript
   :copyable: true
   :category: usage example
...
array, the wildcard index recurses into the document or array and indexes
all scalar fields in the document or array.

The created index can support queries on any arbitrary field within documents in
the collection:

**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/find-wildcard/find-runtime/find.snippet.find-wildcard-runtime.js
   :language: javascript
   :copyable: true
   :category: usage example
...
``tomatoes.viewer`` and ``tomatoes.critic`` fields in the index. 

**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/create-wildcard/create-wildcard-include-specific-fields/create.snippet.create-wildcard-include-specific-fields.js
   :language: javascript
   :copyable: true
   :category: usage example
...
**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/find-wildcard/find-wildcard-include-specific-fields/find.snippet.find-wildcard-include-specific-fields.js
   :language: javascript
   :copyable: true
   :category: usage example
...
The wildcard index excludes the ``tomatoes.viewer`` and
``tomatoes.critic`` fields:

**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/create-wildcard/create-wildcard-omit-specific-fields/create.snippet.create-wildcard-omit-specific-fields.js
   :language: javascript
   :copyable: true
   :category: usage example
...
index recurses into the document or array and indexes all scalar fields in 
the document or array.

The index can support queries on any scalar field **except** those
excluded by ``wildcardProjection``:

**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/wildcard/find-wildcard/find-wildcard-omit-specific-fields/find.snippet.find-wildcard-omit-specific-fields.js
   :copyable: false
   :language: javascript
   :category: usage example
...
**literalinclude:** /code-examples/tested/command-line/mongosh/indexes/commit-quorum/create.snippet.create-index-commit-quorum.js
   :copyable: true
   :language: javascript
   :category: usage example
