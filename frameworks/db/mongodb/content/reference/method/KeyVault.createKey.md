...
generated_at: "2026-08-29T09:39:19.900254Z"
---
.. _keyvault-createkey-method:

# KeyVault.createKey() (mongosh method)

**meta:** :description: Create a data encryption key in the key vault using `KeyVault.createKey()` for client-side field level encryption with various Key Management Services.
