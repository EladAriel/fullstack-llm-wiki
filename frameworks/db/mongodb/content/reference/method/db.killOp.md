...
generated_at: "2026-08-29T09:39:19.932518Z"
---
# db.killOp() (mongosh method)

**meta:** :description: Terminate operations using `db.killOp(opid)` with caution, ensuring you only target client-initiated operations and not internal database processes.
