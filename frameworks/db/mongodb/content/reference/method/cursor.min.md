...
generated_at: "2026-08-29T09:39:19.888188Z"
---
# cursor.min() (mongosh method)

**meta:** :description: Specify the inclusive lower bound for an index using `cursor.min()` to constrain `find()` results in MongoDB.
