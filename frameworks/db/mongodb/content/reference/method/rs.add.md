...
generated_at: "2026-08-29T09:39:19.882805Z"
---
# rs.add() (mongosh method)

**meta:** :description: Add a member to a replica set using `rs.add()` by specifying the host and optional configuration settings.
