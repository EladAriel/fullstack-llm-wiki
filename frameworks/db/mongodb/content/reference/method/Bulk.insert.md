...
generated_at: "2026-08-29T09:39:19.916555Z"
---
# Bulk.insert() (mongosh method)

**meta:** :description: Add insert operations to a bulk list using `Bulk.insert()` for efficient document insertion in MongoDB.
