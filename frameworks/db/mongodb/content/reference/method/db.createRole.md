...
generated_at: "2026-08-29T09:39:19.996694Z"
---
# db.createRole() (mongosh method)

**meta:** :description: Create a role in a MongoDB database with specified privileges and optional authentication restrictions using `db.createRole()`.
