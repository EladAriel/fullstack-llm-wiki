...
generated_at: "2026-08-29T09:39:19.995618Z"
---
# db.stats() (mongosh method)

**meta:** :description: Retrieve database statistics using `db.stats()` to understand usage state, with options for scaling and free storage details.
