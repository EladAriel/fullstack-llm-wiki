...
generated_at: "2026-08-29T09:39:19.937573Z"
---
# db.collection.getShardDistribution() (mongosh method)

**meta:** :description: Print data distribution statistics for a sharded collection using `db.collection.getShardDistribution()`.
