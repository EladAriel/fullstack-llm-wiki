...
generated_at: "2026-08-29T09:39:19.924827Z"
---
# db.setLogLevel() (mongosh method)

**meta:** :description: Set the verbosity level for log messages in MongoDB using `db.setLogLevel()` with optional component specification.
