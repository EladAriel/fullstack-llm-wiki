...
generated_at: "2026-08-29T09:39:19.925271Z"
---
# cursor.allowDiskUse() (mongosh method)

**meta:** :description: Enable or disable writing temporary files to disk for sort operations exceeding 100MB memory limit using `cursor.allowDiskUse()`.
