...
generated_at: "2026-08-29T09:39:19.917759Z"
---
# cursor.limit() (mongosh method)

**meta:** :description: Use `cursor.limit()` to specify the maximum number of documents returned, enhancing performance by limiting results before retrieval.
