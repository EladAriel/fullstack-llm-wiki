...
generated_at: "2026-08-29T09:39:19.945585Z"
---
# sh.addTagRange() (mongosh method)

**meta:** :description: Attach a range of shard key values to a shard tag using `sh.addTagRange()` for optimized initial chunk distribution in MongoDB.
