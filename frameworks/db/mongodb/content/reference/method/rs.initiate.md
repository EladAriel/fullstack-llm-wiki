...
generated_at: "2026-08-29T09:39:19.978053Z"
---
# rs.initiate() (mongosh method)

**meta:** :description: Initiate a replica set using `rs.initiate()` with optional configuration for MongoDB Enterprise or Community environments.
