...
generated_at: "2026-08-29T09:39:19.975310Z"
---
# db.revokeRolesFromRole() (mongosh method)

**meta:** :description: Remove specified inherited roles from a role using the `db.revokeRolesFromRole()` method in MongoDB.
