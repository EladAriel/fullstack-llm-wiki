...
generated_at: "2026-08-29T09:39:19.958449Z"
---
.. _keyvault-addkeyaltname-method:

# KeyVault.addKeyAlternateName() (mongosh method)

**meta:** :description: Add a unique alternate name to a data encryption key using `KeyVault.addKeyAlternateName(UUID, keyAltName)` in MongoDB.
...
**seealso:** :ref:`field-level-encryption-data-key-manage`