...
generated_at: "2026-08-29T09:39:19.985233Z"
---
# db.getCollectionInfos() (mongosh method)

**meta:** :description: Retrieve collection or view information from the current database using `db.getCollectionInfos()`, with options for filtering and access control.
