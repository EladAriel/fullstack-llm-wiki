...
generated_at: "2026-08-29T09:39:19.927662Z"
---
# PlanCache.list() (mongosh method)

**meta:** :description: Retrieve plan cache entries for a collection using `PlanCache.list()` to analyze query shapes and cached plans.
