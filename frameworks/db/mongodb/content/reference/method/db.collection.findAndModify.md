...
generated_at: "2026-08-29T09:39:19.921123Z"
---
# db.collection.findAndModify() (mongosh method)

.. default-domain:: mongodb

**meta:** :description: Update or delete a single document.
...
``db.collection.findAndModify()`` has the following
form:
...
``db.collection.findAndModify()`` takes a document
parameter with the following embedded document fields:

.. |operation| replace:: ``findAndModify()``
...
.. list-table::
   ...
   * - ``bypassDocumentValidation``
     - boolean
     - Optional. Enables ``findAndModify()`` to bypass schema validation
...
.. |findMethod| replace:: ``findAndModify()``
...
If a ``findAndModify()`` operation successfully finds and
...
:data:`writeConcernError` document if the shard response contains
