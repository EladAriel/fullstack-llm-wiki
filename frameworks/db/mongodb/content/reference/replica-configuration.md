...
generated_at: "2026-08-29T09:39:19.699958Z"
---
...
**meta:** :keywords: on-prem
   :description: Access and modify replica set configurations using `rs.conf()` and `rs.reconfig()`, with details on configuration fields and settings.
   ...
   *Type*: array
   ...
   .. rsconf::  members[n].host
      ...
      *Type*: string
      ...
      The host name must be resolvable for every host in the
      replica set.
   ...
   .. rsconf::  members[n].buildIndexes
      ...
      *Default*: true
      ...
      ``_id`` field to facilitate operations required for
      replication.
   ...
   .. rsconf::  members[n].hidden
      ...
      *Default*: false
      ...
      read operations (that is, queries) from ever reaching this host by
      ...
      also be a voting member (that is, :rsconf:`~members[n].votes` is
      greater than ``0``).
   ...
   .. rsconf::  members[n].secondaryDelaySecs
      ...
      *Default*: 0
      ...
      a voting member (that is, :rsconf:`~members[n].votes` is greater than
      ``0``).
...
**rsconf:** settings
   ...
   *Type*: document
   ...
   The :rsconf:`settings` document contains the
   following fields:
   ...
   .. rsconf::  settings.getLastErrorModes
      ...
      *Type*: document
      ...
      to the :ref:`wc-w`, for example:

      .. code-block:: none

         { w: "datacenter" }

      See :ref:`replica-set-configuration-tag-sets` for more
   ...
   .. rsconf::  settings.catchUpTakeoverDelayMillis
      ...
      *catchup takeover* after determining it is ahead of the current
      ...
      Set Elections, see :ref:`replica-set-elections`.
