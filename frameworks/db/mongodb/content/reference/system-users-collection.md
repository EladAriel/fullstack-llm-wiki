...
generated_at: "2026-08-29T09:39:19.680020Z"
---
.. _system-users:
...
**meta:** :keywords: on-prem
   :description: Explore the `system.users` collection schema for managing user authentication and authorization in self-managed MongoDB deployments.
