...
generated_at: "2026-08-29T09:39:19.854647Z"
---
...
**meta:** :keywords: on-prem
   :description: Create test X.509 client certificates using OpenSSL for self-managed MongoDB deployments, ensuring they differ from server certificates.
...
servers, see :ref:`appendix-server-certificate`.
...
#. *Optional*. You can update the default Distinguished Name (DN)
   ...
   .. important::
      ...
      Ensure that client certificates differ from server certificates
