...
generated_at: "2026-08-29T09:39:19.499317Z"
---
.. _7.0-upgrade-replica-set:

# Upgrade a Replica Set to 7.0

**meta:** :description: Upgrade a replica set from MongoDB 6.0 to 7.0 using a rolling upgrade process, ensuring compatibility and minimal downtime.
...
To learn more, see :ref:`Downgrade 7.0 to 6.0 <7.0-downgrade>`.
...
upgrade all members of the replica set to the latest 6.0-series release, and 
then follow the procedure to upgrade from MongoDB |oldversion| to |newversion|.
...
**procedure:** :style: normal
   ...
   .. step:: Step down the replica set primary.
      ...
      .. _7.0-upgrade-rs-step-down-primary:
   ...
   .. step:: Enable backwards-incompatible |newversion| features. 
      ...
      .. _7.0-upgrade-enable-features-primary:
      ...
      Setting :ref:`featureCompatibilityVersion (FCV) : "7.0" <set-fcv>`
...
- To upgrade a standalone, see :ref:`7.0-upgrade-standalone`.
