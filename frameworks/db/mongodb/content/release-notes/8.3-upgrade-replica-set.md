...
generated_at: "2026-08-29T09:39:19.491569Z"
---
.. _8.3-upgrade-replica-set:
...
8.0-series release <8.3-upgrade-replica-set>`, and then follow the procedure to 
...
**procedure:** :style: normal
   ...
   .. step:: Step down the replica set primary
      ...
      .. _8.3-upgrade-rs-step-down-primary:
   ...
   .. step:: Enable backwards-incompatible |newversion| features
      ...
      .. _8.3-upgrade-enable-features-primary:                 
...
- To upgrade a sharded cluster, see :ref:`8.3-upgrade-sharded-cluster`.