...
generated_at: "2026-08-29T09:39:19.492555Z"
---
**meta:** :robots: noindex, nosnippet

.. _8.3-downgrade-to-8.0-sharded-cluster:
...
.. |cluster| replace:: sharded cluster
...
**procedure:** :style: normal
   ...
   .. step:: Ensure No Resharding Operations are in Progress
      ...
      successfully completed before downgrading the
   ...
   .. step:: Downgrade Feature Compatibility Version (FCV)
      ...
      .. _8.3-downgrade-to-8.0-feature-compatibility-sharded-cluster:
      ...
      #. .. include:: /includes/8.3-downgrade-to-8.0-fcv.rst
         ...
         .. note:: Troubleshooting
            ...
            - If :dbcommand:`setFeatureCompatibilityVersion` fails with a
              ...
              an election, you must run the ``abortReshardCollection``
...
**procedure:** :style: normal
   ...
   .. step:: Download the latest |oldversion| binaries
      ...
      release of |oldversion|. If using a package manager, add a new
