...
generated_at: "2026-08-29T09:39:19.501100Z"
---
.. _7.0-upgrade-sharded-cluster:

# Upgrade a Sharded Cluster to 7.0

**meta:** :description: Upgrade a sharded cluster from MongoDB 6.0 to 7.0 by following detailed steps, including prerequisites and compatibility checks.
...
**procedure:** :style: normal
   ...
   .. step:: Re-enable the balancer.
      ...
      .. _7.0-upgrade-reenable-balancer:
   ...
   .. step:: Enable backwards-incompatible |newversion| features.
      ...
      .. _7.0-upgrade-enable-features-mongos:
