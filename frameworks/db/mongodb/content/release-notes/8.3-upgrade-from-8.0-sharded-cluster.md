...
generated_at: "2026-08-29T09:39:19.494008Z"
---
.. _8.3-upgrade-from-8.0-sharded-cluster:
...
To learn more, see :ref:`Downgrade 8.3 to 8.0 <8.3-downgrade-to-8.0>`.
...
**procedure:** :style: normal
   ...
   .. step:: Disable the balancer
      ...
      .. _8.3-upgrade-from-8.0-disable-balancer:
   ...
   .. step:: Upgrade the config servers
      ...
      .. _8.3-upgrade-from-8.0-config-servers:
   ...
   .. step:: Upgrade the ``mongos`` instances
      ...
      .. _8.3-upgrade-from-8.0-mongos-instances:
   ...
   .. step:: Re-enable the balancer
      ...
      .. _8.3-upgrade-from-8.0-reenable-balancer:
   ...
   .. step:: Enable backwards-incompatible |newversion| features
      ...
      .. _8.3-upgrade-from-8.0-enable-features-mongos:
