...
generated_at: "2026-08-29T09:39:19.491022Z"
---
.. _release-notes-8.0:

# Release Notes for MongoDB 8.0

**meta:** :description: Discover new features and changes in MongoDB 8.0, including platform support updates, performance improvements, security improvements, and sharding and replication changes.
...
.. _MongoDB Security Bulletins: https://www.mongodb.com/resources/products/alerts/?tck=docs
...
MongoDB Atlas auto-upgrades dedicated clusters (M10+) to the |lts|
version when the ``Latest Release (auto-upgrades)`` option is enabled.
To manually upgrade your cluster, see :ref:`Upgrade a Cluster to a New
MongoDB Version <upgrade-major-MongoDB-version>`. To learn more about
MongoDB cluster versions in Atlas, see :ref:`Which versions of MongoDB
do Atlas clusters use <supported-mdb-versions>`.

To learn more about the differences between |lts| and Rapid releases, see :ref:`release-version-numbers`. 
...
- `All JIRA issues closed in 8.0.30
  <https://jira.mongodb.org/issues/?jql=project%20in%20(SERVER%2CTOOLS%2CWT)%20AND%20resolution%3D%27Fixed%27%20and%20fixversion%3D%278.0.30%27>`__

- :ref:`8.0.30-changelog`

.. _8.0.29-release-notes:

### 8.0.29 - Aug 11, 2026

This release contains important security and reliability improvements.

**important:** MongoDB 8.0.29 contains fixes for:

   - `CVE-2026-18687 <https://www.cve.org/CVERecord?id=CVE-2026-18687>`_
   - `CVE-2026-18688 <https://www.cve.org/CVERecord?id=CVE-2026-18688>`_
   - `CVE-2026-18690 <https://www.cve.org/CVERecord?id=CVE-2026-18690>`_
   - `CVE-2026-18691 <https://www.cve.org/CVERecord?id=CVE-2026-18691>`_
   - `CVE-2026-18693 <https://www.cve.org/CVERecord?id=CVE-2026-18693>`_
   - `CVE-2026-18694 <https://www.cve.org/CVERecord?id=CVE-2026-18694>`_
   - `CVE-2026-18695 <https://www.cve.org/CVERecord?id=CVE-2026-18695>`_
   - `CVE-2026-18696 <https://www.cve.org/CVERecord?id=CVE-2026-18696>`_
   - `CVE-2026-18697 <https://www.cve.org/CVERecord?id=CVE-2026-18697>`_
   - `CVE-2026-18698 <https://www.cve.org/CVERecord?id=CVE-2026-18698>`_
   - `CVE-2026-18699 <https://www.cve.org/CVERecord?id=CVE-2026-18699>`_
   - `CVE-2026-18700 <https://www.cve.org/CVERecord?id=CVE-2026-18700>`_
   - `CVE-2026-18701 <https://www.cve.org/CVERecord?id=CVE-2026-18701>`_
   - `CVE-2026-18702 <https://www.cve.org/CVERecord?id=CVE-2026-18702>`_
   - `CVE-2026-18705 <https://www.cve.org/CVERecord?id=CVE-2026-18705>`_
   - `CVE-2026-18708 <https://www.cve.org/CVERecord?id=CVE-2026-18708>`_
   - `CVE-2026-18709 <https://www.cve.org/CVERecord?id=CVE-2026-18709>`_
   - `CVE-2026-18711 <https://www.cve.org/CVERecord?id=CVE-2026-18711>`_
   - `CVE-2026-18712 <https://www.cve.org/CVERecord?id=CVE-2026-18712>`_

   For the latest information about MongoDB security updates, see
   `MongoDB Security Bulletins`_.
...
- :issue:`SERVER-129460` Ensure valid ``jsonSchema`` in time series
  updates
- :issue:`SERVER-129617` Better validation for ``NaN`` in
  ``$percentile`` and ``$median``
- :issue:`SERVER-129618` Disallow user-provided ``$vectorSearch``
  arguments from overriding internally generated options
- :issue:`SERVER-129994` Fix a malformed ``FlatBSON`` store caused by
  inserting duplicate field names
- :issue:`SERVER-130110` Gate the internal-only
  ``_internalSetObjToThis`` field of ``$function`` behind an
  internal-client check
- :issue:`SERVER-130111` Prevent invalid type conversion during match
  expression serialization
- :issue:`SERVER-130117` Fix a heap use-after-free in collection
  validation for big polygons
- :issue:`SERVER-130139` Account for the ``o``-versus-UUID consistency
  check
- :issue:`SERVER-130167` Stop the JavaScript scope from constructing
  delete requests by concatenating unsanitized ``_id`` fields
- :issue:`SERVER-130188` Exclude partial indexes from ``2dsphere``
  geometry skip-validation
- :issue:`SERVER-130198` Increase the authorization requirement for
  ``slowms`` and ``sampleRate`` in the ``profile`` command
- :issue:`SERVER-130247` Treat ``Decimal128`` values as potentially
  invalid when preparing to yield or detach a cursor
- :issue:`SERVER-130264` Apply the intra-cluster SASL mechanism
  allowlist in egress connection setup
- :issue:`SERVER-130266` Prohibit ``$text`` and ``$near`` in
  ``$_internalSchemaCond``
- :issue:`SERVER-130481` Allow the symbol type in
  ``CommandHelpers::parseNsFromCommand``
- :issue:`SERVER-130544` Enforce the internal user for
  ``commitTransaction`` and ``abortTransaction`` on prepared
  transactions
- :issue:`SERVER-130628` Prevent excessive range padding insertions into
  the ESC during FLE2 compaction
- :issue:`SERVER-130633` Authorize ``compactStructuredEncryptionData``
  and ``cleanupStructuredEncryptionData`` at database scope

- `All JIRA issues closed in 8.0.29
  <https://jira.mongodb.org/issues/?jql=project%20in%20(SERVER%2CTOOLS%2CWT)%20AND%20resolution%3D%27Fixed%27%20and%20fixversion%3D%278.0.29%27>`__

- :ref:`8.0.29-changelog`

.. _8.0.28-release-notes:
...
**important:** MongoDB 8.0.28 contains fixes for:
   ...
   - `CVE-2026-9737 <https://www.cve.org/CVERecord?id=CVE-2026-9737>`_
   - `CVE-2026-13055 <https://www.cve.org/CVERecord?id=CVE-2026-13055>`_
   - `CVE-2026-13056 <https://www.cve.org/CVERecord?id=CVE-2026-13056>`_
   - `CVE-2026-13057 <https://www.cve.org/CVERecord?id=CVE-2026-13057>`_
   - `CVE-2026-13058 <https://www.cve.org/CVERecord?id=CVE-2026-13058>`_
   - `CVE-2026-13059 <https://www.cve.org/CVERecord?id=CVE-2026-13059>`_
   - `CVE-2026-13060 <https://www.cve.org/CVERecord?id=CVE-2026-13060>`_
   - `CVE-2026-13061 <https://www.cve.org/CVERecord?id=CVE-2026-13061>`_
   - `CVE-2026-13062 <https://www.cve.org/CVERecord?id=CVE-2026-13062>`_
   - `CVE-2026-13064 <https://www.cve.org/CVERecord?id=CVE-2026-13064>`_
   - `CVE-2026-13065 <https://www.cve.org/CVERecord?id=CVE-2026-13065>`_
   - `CVE-2026-13066 <https://www.cve.org/CVERecord?id=CVE-2026-13066>`_
   - `CVE-2026-13067 <https://www.cve.org/CVERecord?id=CVE-2026-13067>`_
   - `CVE-2026-13068 <https://www.cve.org/CVERecord?id=CVE-2026-13068>`_
   - `CVE-2026-13069 <https://www.cve.org/CVERecord?id=CVE-2026-13069>`_
   - `CVE-2026-13070 <https://www.cve.org/CVERecord?id=CVE-2026-13070>`_
   - `CVE-2026-13071 <https://www.cve.org/CVERecord?id=CVE-2026-13071>`_
   - `CVE-2026-13072 <https://www.cve.org/CVERecord?id=CVE-2026-13072>`_
   - `CVE-2026-13073 <https://www.cve.org/CVERecord?id=CVE-2026-13073>`_
   - `CVE-2026-13074 <https://www.cve.org/CVERecord?id=CVE-2026-13074>`_
   - `CVE-2026-13077 <https://www.cve.org/CVERecord?id=CVE-2026-13077>`_
   - `CVE-2026-13078 <https://www.cve.org/CVERecord?id=CVE-2026-13078>`_
...
- :issue:`SERVER-124355` Improve memory checks for array expressions to
  prevent huge in-memory arrays from ``$concatArrays`` combined with
  ``$range``
...
- :issue:`SERVER-128198` Fix ``mongos`` ``killCursors`` to check
  authorization against the cursor's namespace instead of the request
  namespace
- :issue:`SERVER-128341` Fix a server crash caused by sorting on a
  ``$meta`` expression
- :issue:`SERVER-129103` Restrict target BinData subtypes in $convert and $constant/$literal
...
- :issue:`SERVER-128517` Add a configurable minimum timeout for pre-auth
  streamable ``hello`` to prevent a hot loop from very small
  ``maxAwaitTimeMS`` values
...
- :ref:`8.0.28-changelog`

.. _8.0.26-release-notes:

### 8.0.26 - June 11, 2026

**important:** MongoDB 8.0.26 contains a fix for
   `CVE-2026-11933 <https://www.cve.org/CVERecord?id=CVE-2026-11933>`_
...
- :ref:`8.0.26-changelog`

.. _8.0.25-release-notes:
...
- :issue:`SERVER-127984` Speed up isMetadataFieldName with compile-time field 
  matching
- :ref:`8.0.25-changelog`

.. _8.0.24-release-notes:

### 8.0.24 - June 9, 2026

**important:** MongoDB 8.0.24 contains a fix for:

   - `CVE-2026-9740 <https://www.cve.org/CVERecord?id=CVE-2026-9740>`_
   - `CVE-2026-9741 <https://www.cve.org/CVERecord?id=CVE-2026-9741>`_
   - `CVE-2026-9743 <https://www.cve.org/CVERecord?id=CVE-2026-9743>`_
   - `CVE-2026-9746 <https://www.cve.org/CVERecord?id=CVE-2026-9746>`_
   - `CVE-2026-9747 <https://www.cve.org/CVERecord?id=CVE-2026-9747>`_
   - `CVE-2026-9748 <https://www.cve.org/CVERecord?id=CVE-2026-9748>`_
   - `CVE-2026-9749 <https://www.cve.org/CVERecord?id=CVE-2026-9749>`_
   - `CVE-2026-9750 <https://www.cve.org/CVERecord?id=CVE-2026-9750>`_
   - `CVE-2026-9751 <https://www.cve.org/CVERecord?id=CVE-2026-9751>`_
   - `CVE-2026-9752 <https://www.cve.org/CVERecord?id=CVE-2026-9752>`_
   - `CVE-2026-9753 <https://www.cve.org/CVERecord?id=CVE-2026-9753>`_
...
- :ref:`8.0.24-changelog`

.. _8.0.23-release-notes:

### 8.0.23 - May 12, 2026

**important:** MongoDB 8.0.23 contains a fix for:

   - `CVE-2026-8053 <https://www.cve.org/CVERecord?id=CVE-2026-8053>`_
   - `CVE-2026-8199 <https://www.cve.org/CVERecord?id=CVE-2026-8199>`_
   - `CVE-2026-8200	<https://www.cve.org/CVERecord?id=CVE-2026-8200>`_
   - `CVE-2026-8201	<https://www.cve.org/CVERecord?id=CVE-2026-8201>`_
   - `CVE-2026-8202	<https://www.cve.org/CVERecord?id=CVE-2026-8202>`_
...
- :ref:`8.0.23-changelog`

.. _8.0.21-release-notes:

### 8.0.21 - Apr 29, 2026

**important:** MongoDB 8.0.21 contains a fix for:

   - `CVE-2026-6914 <https://www.cve.org/CVERecord?id=CVE-2026-6914>`_
   - `CVE-2026-6915 <https://www.cve.org/CVERecord?id=CVE-2026-6915>`_
...
- :ref:`8.0.21-changelog`

.. _8.0.20-release-notes:

### 8.0.20 - Mar 17, 2026

**important:** MongoDB 8.0.20 contains a fix for: 
   
   - `CVE-2026-4147 <https://www.cve.org/CVERecord?id=CVE-2026-4147>`_
   - `CVE-2026-4148 <https://www.cve.org/CVERecord?id=CVE-2026-4148>`_
...
- :ref:`8.0.20-changelog`

.. _8.0.19-release-notes:
...
- :ref:`8.0.19-changelog`

.. _8.0.18-release-notes:

### 8.0.18 - Jan 27, 2026

**important:** MongoDB 8.0.18 contains a fix for: 
   
   - `CVE-2026-1847 <https://www.cve.org/CVERecord?id=CVE-2026-1847>`_
   - `CVE-2026-1848 <https://www.cve.org/CVERecord?id=CVE-2026-1848>`_
   - `CVE-2026-1849 <https://www.cve.org/CVERecord?id=CVE-2026-1849>`_
   - `CVE-2026-1850 <https://www.cve.org/CVERecord?id=CVE-2026-1850>`_
   - `CVE-2026-25609 <https://www.cve.org/CVERecord?id=CVE-2026-25609>`_
   - `CVE-2026-25611 <https://www.cve.org/CVERecord?id=CVE-2026-25611>`_
   - `CVE-2026-25612 <https://www.cve.org/CVERecord?id=CVE-2026-25612>`_
   - `CVE-2026-25613 <https://www.cve.org/CVERecord?id=CVE-2026-25613>`_
...
- :ref:`8.0.18-changelog`

.. _8.0.17-release-notes: 

### 8.0.17 - Dec 19, 2025

**important:** MongoDB 8.0.17 contains a fix for `CVE-2025-14847 <https://www.cve.org/CVERecord?id=CVE-2025-14847>`_. 
...
- :ref:`8.0.17-changelog`

.. _8.0.16-release-notes:

### 8.0.16 - Nov 19, 2025

**important:** MongoDB 8.0.16 includes fixes for `CVE-2025-12893 <https://www.cve.org/CVERecord?id=CVE-2025-12893>`_,
   `CVE-2025-13507 <https://www.cve.org/CVERecord?id=CVE-2025-13507>`_,
   and `CVE-2025-14345 <https://www.cve.org/CVERecord?id=CVE-2025-14345>`_.
...
- :issue:`SERVER-82688`: Fixes a bug that caused ``mongod`` to crash,
  when the number of connections exceeded WiredTiger's ``session_max``
  limit
- :issue:`SERVER-95374`: Resolves an issue where compound wildcard
  indexes could push predicates down incorrectly during union or query
  planning
...
- :ref:`8.0.16-changelog`


.. _8.0.15-release-notes:
...
- :ref:`8.0.15-changelog`

.. _8.0.14-release-notes:

### 8.0.14 - Sep 25, 2025

**important:** MongoDB 8.0.14 includes a fix for `CVE-2025-13643 <https://www.cve.org/CVERecord?id=CVE-2025-13643>`_.
...
- :ref:`8.0.14-changelog`

.. _8.0.13-release-notes:

### 8.0.13 - Aug 21, 2025

**important:** MongoDB 8.0.13 includes a fix for `CVE-2025-13644 <https://www.cve.org/CVERecord?id=CVE-2025-13644>`_.
...
.. |cve-version-list| replace:: MongoDB 8.0 prior to 8.0.12
...
.. |cve-version-list| replace:: MongoDB 8.0 prior to 8.0.10
...
.. list-table::
   ...
   * - 8.0.18, 8.0.19
     - .. include:: /includes/known-issue-mongrocryptd-size-limit.rst
     - Unresolved.

.. _8.0-performance-improvements: 

## Performance Improvements

**include:** /includes/8.0-performance-improvement-intro.rst 

**seealso:** `MongoDB 8.0: Raising the Bar <https://www.mongodb.com/blog/post/mongodb-8-0-raising-the-bar/>`_

### New Bulk Write Command

**include:** /includes/bulkWrite-introduction.rst

``bulkWrite`` operations on MongoDB 8.0 can run up to 56% faster than bulk write 
operations on MongoDB 7.0.
...
on a shard. For a full list of node direct commands, see 
:ref:`node-direct-commands`.
...
MongoDB 8.0 introduces significant performance improvements in resharding 
operations, substantially reducing the amount of time the operation takes to 
run.
...
**seealso:** :ref:`TCMalloc Compatibility Changes <8.0-tcmalloc-compatibility>`
...
Starting in MongoDB 7.1, you can kill the :dbcommand:`compact` command by
running :dbcommand:`killOp`.
...
Starting in MongoDB 7.1, an aggregation command throws an error when a pipeline
...
Starting in MongoDB 8.0.22, the length of the string you provide to ``chars`` is 
limited to 4096 characters. For details, see :ref:`$trim Limitations
<trim-limitations>`.
...
:products:`MongoDB Consulting </consulting>`.
...
<https://www.mongodb.com/try/download/community-edition/>`__.
