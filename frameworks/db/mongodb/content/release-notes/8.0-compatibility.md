...
generated_at: "2026-08-29T09:39:19.496537Z"
---
.. _8.0-compatibility:
...
**important:** The undefined BSON type is `deprecated
   ...
   information, see the :ref:`mongosh compatibility documentation <compatibility>`.
...
.. list-table::
   ...
   * - ``timeField`` in shard key for time series collection
     - :red:`WARNING:` Starting in MongoDB 8.0, use of the ``timeField`` as a shard key in a
