...
generated_at: "2026-08-29T09:39:19.486322Z"
---
.. _release-notes-7.0:

# Release Notes for MongoDB 7.0
**meta:** :description: Discover new features and changes in MongoDB 7.0, including Atlas Search index management, security updates, and aggregation enhancements.
...
- `All JIRA issues closed in 7.0.41
  <https://jira.mongodb.org/issues/?jql=project%20in%20(SERVER%2CTOOLS%2CWT)%20AND%20resolution%3D%27Fixed%27%20and%20fixversion%3D%277.0.41%27>`__

- :ref:`7.0.41-changelog`

.. _7.0.40-release-notes:

### 7.0.40 - Aug 11, 2026

This release contains important security and reliability improvements.

**important:** MongoDB 7.0.40 contains fixes for:
...
- `All JIRA issues closed in 7.0.40
  <https://jira.mongodb.org/issues/?jql=project%20in%20(SERVER%2CTOOLS%2CWT)%20AND%20resolution%3D%27Fixed%27%20and%20fixversion%3D%277.0.40%27>`__

- :ref:`7.0.40-changelog`

.. _7.0.39-release-notes:
...
- :ref:`7.0.39-changelog`

.. _7.0.37-release-notes:
...
- :ref:`7.0.37-changelog`

.. _7.0.36-release-notes:
...
- :issue:`SERVER-127984` Speed up isMetadataFieldName with compile-time field 
  matching
- :ref:`7.0.36-changelog`

.. _7.0.35-release-notes:
...
- :ref:`7.0.35-changelog`

.. _7.0.34-release-notes:
...
- :ref:`7.0.34-changelog`

.. _7.0.32-release-notes:
...
- :ref:`7.0.32-changelog`

.. _7.0.31-release-notes:
...
- :ref:`7.0.31-changelog`


.. _7.0.30-release-notes:
...
- :ref:`7.0.30-changelog`

.. _7.0.29-release-notes:
...
**important:** MongoDB 7.0.29 contains a fix for: 
   ...
   - `CVE-2026-25610 <https://www.cve.org/CVERecord?id=CVE-2026-25610>`_
...
- :ref:`7.0.29-changelog`

.. _7.0.28-release-notes: 

### 7.0.28 - Dec 19, 2025

**important:** MongoDB 7.0.28 contains a fix for `CVE-2025-14847 <https://www.cve.org/CVERecord?id=CVE-2025-14847>`_. 
...
- :ref:`7.0.28-changelog`

.. _7.0.26-release-notes:

### 7.0.26 - Nov 21, 2025

**important:** MongoDB 7.0.26 includes fixes for `CVE-2025-12893 <https://www.cve.org/CVERecord?id=CVE-2025-12893>`_,
   `CVE-2025-13507 <https://www.cve.org/CVERecord?id=CVE-2025-13507>`_,
   `CVE-2025-13643 <https://www.cve.org/CVERecord?id=CVE-2025-13643>`_,
   `CVE-2025-13644 <https://www.cve.org/CVERecord?id=CVE-2025-13644>`_,
...
This section describes known issues in MongoDB 7.0 and their resolution
status.
...
parameter which lets you specify whether a set of :ref:`log messages
...
you to specify |idp-abbr| configurations when using 
...
Starting in MongoDB 7.0.33, the length of the string you provide to ``chars`` is 
...
``enableAutoMerger`` to set whether the
...
Starting in MongoDB 6.3, MongoDB automatically generates a :ref:`compound index
<index-type-compound>` on the ``metaField`` and ``timeField`` fields when 
...
size rather than number of chunks. As a result, note the
...
<https://www.mongodb.com/try/download>`__.
