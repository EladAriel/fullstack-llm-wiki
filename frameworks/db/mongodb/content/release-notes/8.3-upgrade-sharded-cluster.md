...
generated_at: "2026-08-29T09:39:19.496108Z"
---
.. _8.3-upgrade-sharded-cluster:
...
**include:** /includes/upgrade-minor-versions-guidance-checklists.rst
   :end-before: start-upgrade-path-xref

**include:** /includes/upgrade-minor-versions-guidance-checklists.rst
   :start-after: end-upgrade-path-xref

To learn more, see :ref:`Downgrade 8.3 to 8.2 <8.3-downgrade>`.
...
checks all components of the cluster and produces warnings if any
component is running a version earlier than |oldversion|.
...
Then, check the ``featureCompatibilityVersion``:
...
*Optional but Recommended.* As a precaution, create a backup of the
...
Center <https://www.mongodb.com/try/download>`_.
...
**procedure:** :style: normal
   ...
   .. step:: Disable the balancer
      ...
      .. note::
         ...
         If a migration is in progress, the system completes the
   ...
   .. step:: Upgrade the config servers
      ...
      a. Upgrade the :ref:`secondary <replica-set-secondary-members>` members of the replica set, one at a time.
         ...
         #. Start the |newversion| binary. 
            ...
            If you use a :ref:`configuration file
   ...
   .. step:: Upgrade the ``mongos`` instances
      ...
      .. _8.3-upgrade-mongos-instances:

      .. include:: /includes/release-notes/upgrade-order-note.rst
   ...
   .. step:: Re-enable the balancer
      ...
      .. _8.3-upgrade-reenable-balancer:
   ...
   .. step:: Enable backwards-incompatible |newversion| features
      ...
      .. _8.3-upgrade-enable-features-mongos:
      ...
      Setting :ref:`featureCompatibilityVersion (FCV) : "8.3" <set-fcv>`
      ...
      If the command does not complete, you can safely retry the command
      on the :binary:`~bin.mongos` as the operation is idempotent.
...
- To upgrade a standalone, see :ref:`8.3-upgrade-standalone`.
- To upgrade a replica set, see :ref:`8.3-upgrade-replica-set`.