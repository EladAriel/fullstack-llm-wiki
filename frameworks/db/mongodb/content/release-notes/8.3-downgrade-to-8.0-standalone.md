...
generated_at: "2026-08-29T09:39:19.497722Z"
---
**meta:** :robots: noindex, nosnippet

.. _8.3-downgrade-to-8.0-standalone:
...
**procedure:** :style: normal
   ...
   .. step:: Remove Backward-Incompatible Features
      ...
      To ensure a successful downgrade, remove any |newversion| features
      that are incompatible with |oldversion|. For a list of
      incompatible features and how to remove them, see
   ...
   .. step:: Downgrade Feature Compatibility Version (FCV)
      ...
      1. Use :binary:`mongosh` to connect to the |target|.
...
**procedure:** :style: normal
   ...
   .. step:: Download the latest |oldversion| binaries
      ...
      latest patch release of |oldversion|. If using a
   ...
   .. step:: Update configuration files
      ...
      :ref:`8.3 Release Notes <release-notes-8.3>`.
