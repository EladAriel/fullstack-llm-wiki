...
generated_at: "2026-08-29T09:39:19.495393Z"
---
.. _8.3-upgrade-from-8.0-replica-set:
...
All replica set members must run version |oldversion|. To
upgrade a replica set from |oldseries| and earlier, *first*
:ref:`upgrade all members of the replica set to the latest
8.0-series release <8.0-upgrade-replica-set>`, and then follow the
procedure to upgrade from MongoDB |oldversion| to |newversion|.
...
Issue the :dbcommand:`replSetGetStatus` command to ensure that no
replica set member is in the :replstate:`ROLLBACK` or
...
**procedure:** :style: normal
   ...
   .. step:: Upgrade secondary members of the replica set
      ...
      .. _8.3-upgrade-from-8.0-rs-secondaries:
   ...
   .. step:: Enable backwards-incompatible |newversion| features
      ...
      .. _8.3-upgrade-from-8.0-enable-features-primary:
      ...
      .. tip::
         ...
         initial sync is in progress causes the initial sync to
         restart.
      ...
      collection. If the command does not complete, you can safely
      retry the command on the primary as the operation is idempotent.
