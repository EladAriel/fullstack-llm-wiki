...
generated_at: "2026-08-29T09:39:20.298469Z"
---
...
**procedure:** :style: normal
   ...
   .. step:: Evaluate index usage.

      To determine which indexes are rarely used, use the
      :pipeline:`$indexStats` aggregation stage:
      ...
      The output includes the :ref:`accesses
      <indexStats-output-accesses>` field, which reports the number of
      times users have used each index to run an operation on the node
      ``M-C02FJ3BDML85:27017``: 

      .. code-block:: javascript 
         :emphasize-lines: 6,13,20,27,34,41 
