...
generated_at: "2026-08-29T09:39:19.760829Z"
---
.. _performance-tuning:

# Performance Tuning

**meta:** :description: Explore common methods for MongoDB performance tuning tips to ensure your queries run at optimal speed and efficiency.
...
with :ref:`MongoDB Atlas <unified-get-started>`, which 
...
- **Unbound arrays:** Arrays in a document that can grow without
  ...
  information, see :ref:`unbounded-arrays-antipattern`.
