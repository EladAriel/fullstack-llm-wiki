...
generated_at: "2026-08-29T09:39:19.765804Z"
---
...
**meta:** :keywords: on-prem
   :description: Operations checklist for self-managed deployments covering filesystem, replication, sharding, journaling, hardware, cloud, backups, monitoring, and security.
...
- :ref:`Adjust the readahead settings <readahead>` on the devices
  ...
  - For the WiredTiger storage engine, set readahead between 8
    ...
    <https://support.mongodb.com/welcome>`_ can provide
...
- Use |mms-home| or :products:`Ops Manager, an on-premise
  ...
  </mongodb-enterprise-advanced>` or another monitoring system to
