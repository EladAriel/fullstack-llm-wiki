...
generated_at: "2026-08-29T09:39:19.760098Z"
---
.. _monitoring-for-mdb:
...
.. dismissible-skills-card::
   :skill: MongoDB Monitoring Tooling
   :url: https://learn.mongodb.com/skills?openTab=monitoring%2C+tuning%2C+and+automation
...
- MongoDB Ops Manager is :products:`an on-premises solution available in
  MongoDB Enterprise Advanced </mongodb-enterprise-advanced>`
...
</mongodb-enterprise-advanced>`. Nevertheless, all
...
</mongodb-enterprise-advanced>` monitor config servers and can
...
**note:** The :ref:`Storage Node Watchdog <storage-node-watchdog>` is available in 
