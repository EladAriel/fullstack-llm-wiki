...
source_branch: "main"
source_path: "content/manual/manual/source/tutorial.txt"
...
This page lists the tutorials available as part of the `MongoDB Manual <contents>`. In addition to these tutorial in the manual, MongoDB provides `Getting Started Guides <getting-started>` in various driver editions. If there is a process or pattern that you would like to see included here, please open a :issue:`Jira Case <DOCS>`.

## Installation

- `install-mdb-community-edition`
- `install-mdb-enterprise`
## Administration
...
- `/tutorial/embedded-to-dedicated`
...
- `/tutorial/aggregation-complete-examples`
