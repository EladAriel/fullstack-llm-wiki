...
source_branch: "main"
source_path: "content/manual/manual/source/includes/installation/install-search-tarball.rst"
...
You can install the search process, `mongot`, in MongoDB Community Edition. The search process is available for deployment as a tarball with the `.tgz` extension.
...
- MongoDB Community Edition. See `install-mdb-community-edition` for installation tutorials.
