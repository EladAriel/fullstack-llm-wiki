...
source_branch: "main"
source_path: "content/manual/manual/source/includes/tutorials/automatic/aws/client-nodejs.rst"
...
> **Tip:**    Make sure to update the following code to include your Base64
   ...
   `Generate your {+dek-long+} <csfle-aws-create-dek-nodejs>` step of this
   guide.
