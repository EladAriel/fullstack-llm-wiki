...
source_branch: "main"
source_path: "content/manual/manual/source/includes/queryable-encryption/tutorials/exp/dek.rst"
...
Retrieve the contents of the {+cmk-long+} file that you generated in the `Create a {+cmk-long+} <qe-manual-enc-create-master-key>` step of this guide.
