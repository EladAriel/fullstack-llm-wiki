...
source_branch: "main"
source_path: "content/manual/manual/source/includes/queryable-encryption/tutorials/automatic/aws/dek.rst"
...
> **Tip:**    You recorded your {+cmk-long+}'s {+aws-arn-abbr+} and Region
   in the `Create a {+cmk-long+} <qe-aws-create-master-key>`
   step of this guide.
.. tabs-drivers::
   .. tab::
      :tabid: shell
