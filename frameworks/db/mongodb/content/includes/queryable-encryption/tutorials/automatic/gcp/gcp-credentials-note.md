...
source_branch: "main"
source_path: "content/manual/manual/source/includes/queryable-encryption/tutorials/automatic/gcp/gcp-credentials-note.rst"
...
in the `Create a GCP Service Account <qe-gcp-register-account>`
step of this guide.
