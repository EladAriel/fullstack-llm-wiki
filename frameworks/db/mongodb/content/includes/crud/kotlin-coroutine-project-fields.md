...
source_branch: "main"
source_path: "content/manual/manual/source/includes/crud/kotlin-coroutine-project-fields.rst"
...
This page provides examples of |query_operations| using the :method:`db.collection.find()` method in :binary:`mongosh`.
