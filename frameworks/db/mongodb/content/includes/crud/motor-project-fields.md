...
source_branch: "main"
source_path: "content/manual/manual/source/includes/crud/motor-project-fields.rst"
...
This page provides examples of |query_operations| using the `motor.motor_asyncio.AsyncIOMotorCollection.find` method in the [Motor](https://motor.readthedocs.io/en/stable/) driver.
