...
source_branch: "main"
source_path: "content/manual/manual/source/includes/crud/nodejs-project-fields.rst"
...
This page provides examples of |query_operations| using the :node-api:`Collection.find() <Collection.html#find>` method in the :node-docs:`MongoDB Node.js Driver <>`.
