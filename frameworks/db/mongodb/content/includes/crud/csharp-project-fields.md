...
source_branch: "main"
source_path: "content/manual/manual/source/includes/crud/csharp-project-fields.rst"
...
This page provides examples of |query_operations| using the :csharp-api:`MongoCollection.Find() <M_MongoDB_Driver_MongoCollection_1_Find>` method in the [MongoDB .NET/C# Driver](https://mongodb.github.io/mongo-csharp-driver/).
...
:projection:`$elemMatch`, :projection:`$slice`, and :projection:`$` are the only operators that you can use to project specific elements to include in the returned array.
