...
source_branch: "main"
source_path: "content/manual/manual/source/includes/crud/ruby-project-fields.rst"
...
This page provides examples of |query_operations| using the :ruby-api:`Mongo::Collection#find()<Collection.html#find-instance_method>` method in the :ruby:`MongoDB Ruby Driver </>`.
