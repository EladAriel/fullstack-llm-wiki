...
source_branch: "main"
source_path: "content/manual/manual/source/includes/crud/compass-project-fields.rst"
...
This page provides examples of |query_operations| using `MongoDB Compass <compass-index>`.
...
#. Click :guilabel:`Options` to open the additional query options.

#. Copy the following expression into the :guilabel:`Project` field:
