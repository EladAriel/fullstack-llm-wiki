...
source_branch: "main"
source_path: "content/manual/manual/source/includes/3.4-featureCompatibility-caveat.rst"
...
Enabling these backwards-incompatible features can `complicate the downgrade process <3.4-downgrade-features-prereq>`. For details, see `3.4-downgrade-features-prereq`.
