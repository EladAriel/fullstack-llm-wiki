...
source_branch: "main"
source_path: "content/manual/manual/source/includes/setWindowFields-introduction-examples.rst"
...
For example, you can use the :pipeline:`$setWindowFields` stage to output the:
