...
source_branch: "main"
source_path: "content/manual/manual/source/includes/fact-tcp-keepalive-windows.rst"
...
an Administrator :guilabel:`Command Prompt`, where `<value>` is expressed in hexadecimal (e.g. `120000` is `0x1d4c0`):
