...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/3.0.7.rst"
...
- :issue:`SERVER-19361 Insert of document with duplicate id` fields should be forbidden
