...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/4.4.27.rst"
...
missing_index_ident_standalone_drop.js from single phase index build variant
