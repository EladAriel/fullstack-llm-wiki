...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.1.1.rst"
...
:issue:`SERVER-70559` tag FLE2 tests such that they do not run with stepdown suites
