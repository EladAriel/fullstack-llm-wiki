...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/7.0.4.rst"
...
for case where feature flag checks could be run when FCV is uninitialized during initial sync
