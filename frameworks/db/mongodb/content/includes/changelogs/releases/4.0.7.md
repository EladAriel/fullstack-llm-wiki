...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/4.0.7.rst"
...
- :issue:`SERVER-36958 Parts of the configsvrShardCollection` command do not retry on network errors
...
- :issue:`SERVER-40010 Shard secondaries with 4.0 binary and 3.6 FCV are calling flushDatabaseCacheUpdates`
### Replication
