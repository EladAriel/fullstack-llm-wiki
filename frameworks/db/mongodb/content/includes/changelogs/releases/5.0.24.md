...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/5.0.24.rst"
...
:issue:`SERVER-82129` FCV 5.0 Upgrade fails due to config.cache.collections missing UUIDs for most collections
