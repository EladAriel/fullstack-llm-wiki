...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.0.8.rst"
...
test in older versions where tracking of large change stream events is not backported
