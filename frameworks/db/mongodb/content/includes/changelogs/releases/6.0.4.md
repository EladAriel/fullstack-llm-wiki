...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.0.4.rst"
...
:issue:`SERVER-58712` Inconsistent update performance on collections with multiple secondary indexes on same key
...
WiredTigerIndexCursorBase::seekWTCursor assertion not following search_near comparison semantics
...
'_internalAllCollectionStatsSpec.getStats()' exists (boost::optional) before calling 'makeStatsForNs' in 'document_source_internal_all_collection_stats.cpp'
...
receiveChunkWaitForRangeDeleterTimeoutMS is too low at agg_collstats_expr.js
