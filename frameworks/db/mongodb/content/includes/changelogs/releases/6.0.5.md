...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.0.5.rst"
...
when reshardCollection has already failed before any failpoints are waited on
...
:issue:`SERVER-73534` Serialization of 'sbe::TypeTags::ArraySet' to 'KeyString' can segfault
...
transactions format) build variant to mongodb-mongo-v6.0 Evergreen project
