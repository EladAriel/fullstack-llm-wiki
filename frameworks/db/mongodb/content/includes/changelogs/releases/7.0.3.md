...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/7.0.3.rst"
...
:issue:`SERVER-77119` fle2_crud.js should use the same session to read from encrypted/unencrypted collections
