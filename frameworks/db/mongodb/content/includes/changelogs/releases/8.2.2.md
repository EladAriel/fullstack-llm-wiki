...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/8.2.2.rst"
...
:issue:`SERVER-106590` moveChunk and movePrimary lock contention during critical section
...
:issue:`WT-15608` Aggregated timestamp validation can fail with a 0 timestamped page deleted structure
...
skipAuthenticationToSearchIndexManagementServer to false for Community Server and Enterprise Server
...
command_registration_startup_behavior_fcv.js now that command registry properly works on older versions
...
check_async_oplog_samping_truncates_new_writes.js to hang during initial sampling, not after
