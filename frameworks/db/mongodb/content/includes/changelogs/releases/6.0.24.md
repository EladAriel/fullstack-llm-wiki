...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.0.24.rst"
...
:issue:`SERVER-97470` findAndModify: Mongos WriteConcernError Behavior Differs from Mongod
...
:issue:`SERVER-95976` Introduce "matchCollectionUUIDForUpdateLookup" parameter in the change stream stage
...
returned by $shardedDataDistribution will report num of buckets for timeseries collections
