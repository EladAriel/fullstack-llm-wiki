...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/5.0.28.rst"
...
fcv_upgrade_succeeds_when_persisted_collection_cache_missing_uuid_field.js with stepdowns on slow variants (5.0)

- :issue:`SERVER-91435` Regenerate test certs with legacy flag
- :issue:`SERVER-91460` [v5.0]
random_moveChunk_timeseries_insert_many.js is not tagged with requires_fcv_50
