...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/4.4.19.rst"
...
replication with session checked out when getLastErrorDefaults are used in replica set config, leading to server crash
...
rolling_index_builds_interrupted.js from running on single phase index build variants
