...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/7.0.6.rst"
...
:issue:`SERVER-79191` continuous_initial_sync.py Can Be in Rollback During FSM Teardown

### Query

:issue:`SERVER-84595` Delete invalid test jstests/noPassthrough/out_majority_read_replset.js

### Aggregation

:issue:`SERVER-82929` $listSearchIndexes requires find privilege action rather than listSearchIndexes privilege action as it intended
...
sharded_collections_jscore_passthrough_with_config_shard from the macOS hosts
...
coordinate_txn_recover_on_stepup_with_tickets_exhausted.js from sharding multiversion suites on 7.0
...
insert_docs_larger_than_max_user_size_standalone.js with requires_persistence and requires_replication
