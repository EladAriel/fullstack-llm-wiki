...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.0.9.rst"
...
PinnedConnectionTaskExecutor can retry before the underlying connection pool processes initial failure
...
its TaskExecutor when leaving to correctly clean its state on step down
