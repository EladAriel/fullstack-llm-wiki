...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.0.17.rst"
...
txn_recover_decision_using_recovery_router.js robust to spurious shard version refreshes
...
written to without synchronization by IgnoreInterruptionsGuard destructor
...
system.buckets collection doesn't set the timeseriesBucketsMayHaveMixedSchemaData flag
...
temporarily retry on KeyNotFound error after restarting the replica set
...
random_moveChunk_timeseries_insert_many.js is not tagged with requires_fcv_51
...
retry NetworkInterfaceTimeLimitExceeded for a sharded find command on versions earlier than 8.0
...
- :issue:`SERVER-91919`
change_stream_pit_pre_image_deletion_asymmetric.js can use excessive amount of memory
...
all_collection_stats.js by eventually comparing $collStats and $_internalAllCollectionStats
...
timeseriesBucketsMayHaveMixedSchemaData during MultiIndexBlock::commit might generate catalog inconsistencies
