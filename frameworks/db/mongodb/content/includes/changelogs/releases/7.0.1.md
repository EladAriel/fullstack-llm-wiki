...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/7.0.1.rst"
...
:issue:`SERVER-80256` QueryPlannerAnalysis::explodeForSort should not assume that index scans produce disjoint results
...
jstests/noPassthrough/metadata_size_estimate.js to use a smaller document size
...
number of sampled queries observed via analyzeShardKey and $listSampledQueries is non-decreasing
...
stale_mongos_updates_and_removes.js and extract_shard_key_values.js on 7.0
