...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/8.0.16.rst"
...
:issue:`SERVER-75278` Consider sleeping only if there are more to fetch in ReshardingOplogFetcher
...
timeseries_insert_idle_bucket_expiration.js from ConcurrencyShardedInitialSync suite
...
remainingReshardingOperationTimeThresholdMillis configurable while resharding is in progress
...
speculative_read_transaction.js and transactions_wait_for_write_concern.js
...
- :issue:`SERVER-110628`
ReshardingCoordinator::_setCriticalSectionTimeoutCallback triggers segfault when accessing status with error
