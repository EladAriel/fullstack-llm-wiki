...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/7.0.9.rst"
...
:issue:`SERVER-89134` Test wrongly assumes multi writes outside of transactions are atomic
...
should not attach dbVersion when targeting local shard by routing table
