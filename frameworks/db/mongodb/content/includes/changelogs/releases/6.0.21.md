...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/6.0.21.rst"
...
:issue:`SERVER-87140` standalone_in_queryable_backup_mode.js test might try to get a primary in a replica set with only secondaries

### Query

:issue:`SERVER-84089` Bulk operation freezes if used in combination with collation and upsert
...
:issue:`SERVER-101523` [v6.0] Allow specifying collMod with changeStreamPreAndPostImages: { enabled: false } in FCV 5.0
...
while testing for change stream events in change_streams_split_event_v1_v2_tokens.js
