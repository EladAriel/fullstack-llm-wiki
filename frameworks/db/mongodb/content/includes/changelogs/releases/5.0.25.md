...
source_branch: "main"
source_path: "content/manual/manual/source/includes/changelogs/releases/5.0.25.rst"
...
:issue:`SERVER-85156` dbCheck throws unexpected "invalidate" change stream event [5.0]
...
max relies on a specific order of documents in the oplog, but that order is not guaranteed
...
fsync/checkpointing behavior which does not hold when running with --nojournal
