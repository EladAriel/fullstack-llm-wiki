...
generated_at: "2026-08-29T09:39:24.389562Z"
---
# Backup and Restore
  ...
  Continuous Archiving and Point-in-Time Recovery (PITR)
   ...
   Setting Up WAL Archiving
    ...
    configuration parameter to replica or higher,
     to on,
    specify the shell command to use in the  configuration parameter
...
test ! -f /mnt/server/archivedir/00000001000000A900000065 && cp pg_wal/00000001000000A900000065 /mnt/server/archivedir/00000001000000A900000065
   ...
   Making an Incremental Backup
    ...
    You can use  to take an incremental
   ...
   Making a Base Backup Using the Low Level API
    ...
    , you can take a base backup using the
