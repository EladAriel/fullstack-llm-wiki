...
generated_at: "2026-08-29T09:39:24.382995Z"
---
# pg_plan_advice — help the planner get the right plan
  ...
  Getting Started
   ...
   First, you must arrange to load the pg_plan_advice
...
-------------------------------------------------------------------
 ...
 Supplied Plan Advice:
   ...
   HASH_JOIN(f) and HASH_JOIN(g).
   By contrast, JOIN_ORDER(f g) is a single request and
   appears as-is.
