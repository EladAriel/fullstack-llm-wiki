...
generated_at: "2026-08-29T09:39:24.446543Z"
---
# Concurrency Control
    ...
    an ACCESS SHARE lock can be held by multiple transactions).
      ...
      Table-Level Lock Modes
        ...
        ACCESS EXCLUSIVE (AccessExclusiveLock)
         ...
         TRUNCATE, REINDEX,
         CLUSTER, VACUUM FULL, and
         REFRESH MATERIALIZED VIEW (without
         CONCURRENTLY) commands.
         REPACK also acquires this lock mode.  When run
         with CONCURRENTLY, REPACK acquires
         it only while swapping the table and index files.
         Many forms of ALTER INDEX and
...
(
  SELECT id FROM foo WHERE id > 12345 LIMIT 100
   ...
   Caveats
    ...
    Some commands, currently only TRUNCATE, the
    table-rewriting forms of ALTER
    TABLE and REPACK with
    the CONCURRENTLY option, are not
