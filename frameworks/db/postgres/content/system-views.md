...
generated_at: "2026-08-29T09:39:24.318679Z"
---
# System Views
  ...
  pg_aios
   ...
   The pg_aios view lists all  handles that are currently in-use.  An I/O handle
   ...
   pg_aios Columns
       ...
       Length of the data associated with the I/O operation. For I/O to/from
        and , this indicates the number of buffers the
       I/O is operating on.
       ...
       High-level result of the I/O operation:
          ...
          UNKNOWN means that the result of the
          ...
          PARTIAL means that the I/O completed without
          ...
          WARNING means that the I/O completed without
          error, but that execution of the IO triggered a warning. E.g. when
          encountering a corrupted buffer with  enabled.
  ...
  pg_available_extensions
   ...
   pg_available_extensions Columns
       ...
       system location, then the value will be $system,
...
SELECT * FROM pg_locks pl LEFT JOIN pg_prepared_xacts ppx
  ...
  pg_replication_slots
   ...
   pg_replication_slots Columns
       ...
       physical slots. NULL if the slot is not invalidated.
       Possible values are:
          ...
          idle_timeout means that the slot has remained
       ...
       on standby servers whose synced field is
       true. It is NULL if slot
       synchronization is successful.
       Possible values are:
       
        
         
          wal_or_rows_removed means that the required WALs or
          ...
          wal_not_flushed means that the standby had not
          ...
          no_consistent_snapshot means that the standby could
          ...
          slot_invalidated means that the synced slot is
          invalidated.
