...
generated_at: "2026-08-29T09:39:24.480141Z"
---
# Index Access Method Interface Definition
  ...
  Index Access Method
   ...
   block number and an item number within that block (see ).  This is sufficient
  ...
  Basic API Structure for Indexes
   ...
   allocated struct of type IndexAmRoutine, which
   ...
   marked static const; but if that is inconvenient,
   ...
   struct as const, and will never free it.)
