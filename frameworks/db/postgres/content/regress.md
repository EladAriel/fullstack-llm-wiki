...
generated_at: "2026-08-29T09:39:24.394361Z"
---
# Regression Tests
...
make check-world PG_TEST_EXTRA='kerberos ldap ssl load_balance libpq_encryption'
   ...
   The following values are currently supported:
     ...
     saslprep
       ...
       Runs the TAP test suite under src/test/modules/test_saslprep.
...
make check LANG=C ENCODING=EUC_JP
   ...
   Path Substitution
    ...
    The test suites driven by pg_regress can use the
...
PG_TEST_NOCLEAN=1 make -C src/bin/pg_dump check
    ...
    PG_TEST_FILE_READ_LINES can be set to limit the number of
