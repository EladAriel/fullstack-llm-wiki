...
generated_at: "2026-08-29T09:39:24.338715Z"
---
# GIN Indexes
 ...
 Extensibility
  ...
  following methods:
     ...
     int comparePartial(Datum partial_key, Datum key, StrategyNumber n,
       ...
       partial_key is a query key that was returned
       by extractQuery with an indication that it
       requires partial match, and key is an index entry.
       Returns an integer
