...
generated_at: "2026-08-29T09:39:24.414776Z"
---
# Database Roles
...
ALTER TABLE bobs_table OWNER TO alice;
   ...
   REASSIGN OWNED is executed in that database.)
...
GRANT pg_signal_backend TO admin_user;
   ...
   should monitor the release notes for changes.
     ...
     pg_write_all_data
       ...
       views, sequences, large objects), as if having SELECT rights on
       ...
       views, sequences, large objects), as if having INSERT,
