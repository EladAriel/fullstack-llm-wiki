...
generated_at: "2026-08-29T09:39:24.419892Z"
---
# amcheck — tools to verify table and index consistency
  ...
  While these checking functions are run, the  is temporarily changed to pg_catalog,
  pg_temp.
...
SET client_min_messages = DEBUG1;
  ...
  failure modes that data checksums will fail
