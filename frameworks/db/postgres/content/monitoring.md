...
generated_at: "2026-08-29T09:39:24.337464Z"
---
...
FROM pg_stat_get_backend_idset() AS backendid;
  ...
  REPACK Progress Reporting
   ...
   pg_stat_progress_repack View
       ...
       The command that is running. One of CLUSTER,
       REPACK, or VACUUM FULL.
  ...
  VACUUM Progress Reporting
   ...
   pg_stat_progress_repack, and is also visible via
   the backwards-compatibility pg_stat_progress_cluster
