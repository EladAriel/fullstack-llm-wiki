...
source_path: "doc/src/sgml/func/func-range.sgml"
...
`range-functions-table` shows the functions available for use with range types. `multirange-functions-table` shows the functions available for use with multirange types.
...
lower `lower` ( `anymultirange` ) anyelement
...
upper `upper` ( `anymultirange` ) anyelement
...
multirange_minus_multi `multirange_minus_multi` ( `anymultirange`, `anymultirange` ) setof anymultirange
