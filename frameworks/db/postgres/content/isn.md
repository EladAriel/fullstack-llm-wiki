...
source_path: "doc/src/sgml/isn.sgml"
...
`isn-datatypes` shows the data types provided by the `isn` module.
...
The `isn` module provides the standard comparison operators, plus B-tree and hash indexing support for all these data types. In addition, there are several specialized functions, shown in `isn-functions`. In this table, `isn` means any one of the module's data types.
...
The information to implement this module was collected from several sites, including: - [https://www.isbn-international.org/](https://www.isbn-international.org/) - [https://www.issn.org/](https://www.issn.org/) - [https://www.ismn-international.org/](https://www.ismn-international.org/) - [https://www.wikipedia.org/](https://www.wikipedia.org/) The prefixes used for hyphenation were also compiled from: - [https://www.gs1.org/standards/id-keys](https://www.gs1.org/standards/id-keys) - [https://en.wikipedia.org/wiki/List_of_ISBN_registration_groups](https://en.wikipedia.org/wiki/List_of_ISBN_registration_groups) - [https://www.isbn-international.org/content/isbn-users-manual/29](https://www.isbn-international.org/content/isbn-users-manual/29) - [https://en.wikipedia.org/wiki/International_Standard_Music_Number](https://en.wikipedia.org/wiki/International_Standard_Music_Number) - [https://www.ismn-international.org/ranges/tools](https://www.ismn-international.org/ranges/tools) Care was taken during the creation of the algorithms and they were meticulously verified against the suggested algorithms in the official ISBN, ISMN, ISSN User Manuals.
