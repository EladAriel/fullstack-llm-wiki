...
source_path: "doc/src/sgml/pgoverexplain.sgml"
...
You can also preload it into some or all sessions by including `pg_overexplain` in `guc-session-preload-libraries` or `guc-shared-preload-libraries` in `postgresql.conf`.
