...
source_path: "doc/src/sgml/pgrowlocks.sgml"
...
The parameter is the name of a table. The result is a set of records, with one row for each locked row within the table. The output columns are shown in `pgrowlocks-columns`.
...
multitransaction; see `transaction-id`
