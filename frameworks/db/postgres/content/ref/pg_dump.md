...
generated_at: "2026-08-29T09:39:24.598299Z"
---
pg_dump
...
# Options
    ...
    format of the output.
      ...
      --file=file
        ...
        directory is created by pg_dump unless the directory
        exists and is empty.
...
```
   ...
   definition (via --no-schema and related options) is
   not recommended.
