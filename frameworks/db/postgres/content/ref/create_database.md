...
generated_at: "2026-08-29T09:39:24.595964Z"
---
CREATE DATABASE
...
# Parameters
      ...
      strategy
        ...
        FILE_COPY strategy is affected by the  setting.
      ...
      locale
        ...
        digit.  Also sets the LC_CTYPE aspect of the
        operating system environment.  The default is the same setting as the
        template database.  See  and  for details.
      ...
      lc_collate
        ...
        If  is
        libc, sets the default collation order to use in
        the new database, overriding the setting . Otherwise, this setting is
        ignored.
       

       
        The default is the setting of 
      ...
      lc_ctype
        ...
        If  is
        libc, sets the default character classification to
        use in the new database, overriding the setting .
