...
generated_at: "2026-08-29T09:39:24.606986Z"
---
CREATE TABLE
...
# Parameters
    ...
    UNLOGGED
      ...
      to unlogged tables is not written to the write-ahead log (see ), which makes them considerably faster than ordinary
    ...
    OF type_name
      ...
      one created using ) though it still
...
# Storage Parameters
  ...
  storage parameters
    ...
    parallel_workers (integer)
     ...
     parallel_workers storage parameter
    ...
    vacuum_truncate, toast.vacuum_truncate (boolean)
     ...
     storage parameter
      ...
      Per-table value for  parameter.  The
    ...
    autovacuum_parallel_workers (integer)
     ...
     autovacuum_parallel_workers storage parameter
       ...
       Per-table value for 
       parameter. If -1 is specified, autovacuum_max_parallel_workers
    ...
    autovacuum_freeze_min_age, toast.autovacuum_freeze_min_age (integer)
     ...
     autovacuum_freeze_min_age storage parameter
    ...
    autovacuum_freeze_table_age, toast.autovacuum_freeze_table_age (integer)
     ...
     autovacuum_freeze_table_age storage parameter
    ...
    autovacuum_multixact_freeze_min_age, toast.autovacuum_multixact_freeze_min_age (integer)
     ...
     autovacuum_multixact_freeze_min_age storage parameter
    ...
    autovacuum_multixact_freeze_table_age, toast.autovacuum_multixact_freeze_table_age (integer)
     ...
     autovacuum_multixact_freeze_table_age storage parameter
    ...
    user_catalog_table (boolean)
     ...
     user_catalog_table storage parameter
...
# Notes
     ...
     index explicitly for primary key columns.  (See  for more information.)
