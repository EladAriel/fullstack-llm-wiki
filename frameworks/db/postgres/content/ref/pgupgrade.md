...
generated_at: "2026-08-29T09:39:24.552008Z"
---
pg_upgrade
...
# Description
  ...
  be checked by pg_upgrade.
   ...
   pg_upgrade supports upgrades from 10.X and later to the current
...
# Usage
   ...
   with pg_upgrade:
     ...
     The steps to upgrade logical replication clusters
...
# Notes
   ...
   (regclass, regdatabase, regrole, and
