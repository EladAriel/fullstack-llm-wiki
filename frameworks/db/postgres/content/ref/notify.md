...
source_path: "doc/src/sgml/ref/notify.sgml"
...
The function `pg_notification_queue_usage` returns the fraction of the queue that is currently occupied by pending notifications. See `functions-info` for more information.
