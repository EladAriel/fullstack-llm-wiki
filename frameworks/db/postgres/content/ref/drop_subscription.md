...
If a conflict log table exists for the subscription (that is, when conflict_log_destination is set to `table` or `all`), `DROP SUBSCRIPTION` automatically drops the associated conflict log table.
