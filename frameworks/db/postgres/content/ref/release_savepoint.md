...
source_path: "doc/src/sgml/ref/release_savepoint.sgml"
...
It is not possible to release a savepoint when the transaction is in an aborted state; to do that, use `sql-rollback-to`.
