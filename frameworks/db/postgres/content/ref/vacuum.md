...
generated_at: "2026-08-29T09:39:24.553542Z"
---
VACUUM
...
# Outputs
    ...
    When VERBOSE is specified, VACUUM
    prints detailed information about vacuuming each table at
    INFO level, including which table is currently
    being processed and various statistics about the tables.
...
# Notes
    ...
    While VACUUM is running, the  is temporarily changed to pg_catalog,
    pg_temp.
...
# Examples
   ...
   the optimizer and print detailed information about vacuuming and
   analyzing it:
