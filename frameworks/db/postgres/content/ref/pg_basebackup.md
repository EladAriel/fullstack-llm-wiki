...
generated_at: "2026-08-29T09:39:24.573259Z"
---
pg_basebackup
...
# Options
    ...
    output:
      ...
      --incremental=old_manifest_file
        ...
        backup. The backup manifest for the reference
      ...
      --write-recovery-conf
        ...
        logical replication slot synchronization will use the same
    ...
    backup and the invocation of the program:
      ...
      --no-verify-checksums
        ...
        Checksums must be enabled on the server for the duration of the base
        backup in order to be verified.  If checksums are in the process of
        being enabled when the base backup starts then checksum verification is
        disabled for the base backup.
