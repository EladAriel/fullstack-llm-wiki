...
generated_at: "2026-08-29T09:39:24.568448Z"
---
...
# Parameters
    ...
    CONNECTION connection_function
      ...
      .  If no connection function or
      NO CONNECTION is specified, then servers using this
      foreign data wrapper cannot be used for CREATE
      SUBSCRIPTION.  The connection function must take three
      arguments: one of type oid for the user, one of type
      oid for the server, and an unused third argument of type
      internal (which prevents calling the function in other
      contexts).
