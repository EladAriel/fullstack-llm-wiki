...
source_path: "doc/src/sgml/ref/create_statistics.sgml"
...
- The name (optionally schema-qualified) of the table containing the column(s) the statistics are computed on; see `sql-analyze` for an explanation of the handling of inheritance and partitions.
