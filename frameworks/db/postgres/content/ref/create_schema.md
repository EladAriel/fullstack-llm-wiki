...
generated_at: "2026-08-29T09:39:24.603832Z"
---
CREATE SCHEMA
...
# Parameters
      ...
      schema_element
        ...
        CREATE TYPE,
        CREATE VIEW,
        and GRANT are accepted as clauses
...
# Notes
   ...
   An exception is that foreign key constraint clauses in CREATE
   TABLE subcommands are postponed and added at the end.
