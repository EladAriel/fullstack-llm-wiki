...
source_path: "doc/src/sgml/ref/analyze.sgml"
...
Each backend running `ANALYZE` will report its progress in the `pg_stat_progress_analyze` view. See `analyze-progress-reporting` for details.
