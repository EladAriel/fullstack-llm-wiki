...
generated_at: "2026-08-29T09:39:24.619380Z"
---
psql
...
# Meta-Commands
    ...
    replaced by the variable's value, as described in  below.
...
```
        ...
        equivalent to \dtvmsEG which will show a list of
        ...
        In this group of commands, the letters E, G,
        i, m, s,
        t, and v
...
# Prompting
    ...
    instead. Defined substitutions are:
       ...
       %S
         ...
         The current value of , or
         ? if connected to a server running
