...
generated_at: "2026-08-29T09:39:24.537719Z"
---
CREATE AGGREGATE
...
# Parameters
    ...
    state_data_size
      ...
      based on the state_data_type. If set to a
    ...
    mstate_data_size
      ...
      state_data_size, except that negative
    ...
    psfunc
      ...
      function to use for this aggregate.  See
       for details.
