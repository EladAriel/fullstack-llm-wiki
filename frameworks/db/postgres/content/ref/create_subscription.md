...
generated_at: "2026-08-29T09:39:24.599938Z"
---
CREATE SUBSCRIPTION
...
# Parameters
    ...
    SERVER server_name
      ...
      wrapper must have a connection_function
    ...
    WITH ( subscription_parameter [= value] [, ... ] )
      ...
      The following parameters control what happens during subscription creation:
        ...
        connect (boolean)
          ...
          false, no tables and sequences are subscribed. To
      ...
      behavior after it has been created:
        ...
        binary (boolean)
          ...
          (see  for more about send/receive
        ...
        conflict_log_destination (enum)
          ...
          The available values are:
            ...
            table
              ...
              pg_conflict_log_<subid> in the
              pg_conflict schema. This allows for easy
            ...
            all
              ...
              This is equivalent to configuring both destinations log
              and table together.
        ...
        retain_dead_tuples (boolean)
          ...
          or higher to allow the replication slot to be used.
           ...
           it is recommended to disable retain_dead_tuples
           if the subscription will be inactive for an extended period.
          

          
           Additionally when enabling retain_dead_tuples for
        ...
        max_retention_duration (integer)
          ...
          retain_dead_tuples is enabled. The default value
          is 0, indicating that the information is retained
          ...
          retain_dead_tuples is enabled, confirm that the
          retention duration has exceeded the
          max_retention_duration set within the corresponding
          ...
          retain_dead_tuples = true. Alternatively, retention
          can be manually resumed by re-enabling retain_dead_tuples.
          ...
          retain_dead_tuples is enabled and the apply
