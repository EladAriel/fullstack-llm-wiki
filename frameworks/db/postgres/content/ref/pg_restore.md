...
generated_at: "2026-08-29T09:39:24.559040Z"
---
pg_restore
...
# Options
    ...
    line arguments.
      ...
      --single-transaction
        ...
        --exit-on-error.
        It cannot be used together with --create, nor with
        multiple jobs (--jobs).
...
# Notes
   ...
   When options -n or -t are specified,
...
```
   ...
   The limitations of pg_restore are detailed below.
      ...
      Parallel restore (--jobs greater than 1) requires
      ...
      (the pre-data section).  Therefore, avoid
      using pg_dump options such
      as --no-schema, -a/--data-only,
      or --section without pre-data when
