...
generated_at: "2026-08-29T09:39:24.451274Z"
---
...
key => NULL
  ...
  hstore Operators and Functions
   ...
   hstore Functions
        ...
        Constructs an hstore from an array, which may be either
...
2
        ...
        Extracts an hstore's keys and values as an array of
        ...
        Extracts an hstore's keys and values as a two-dimensional
        array.
        ...
        This function is used implicitly when an hstore value is
        cast to json.
        ...
        Converts an hstore to a jsonb value,
        converting all non-null values to JSON strings.
        ...
        Converts an hstore to a json value, but
        ...
        Converts an hstore to a jsonb value, but
        attempts to distinguish numerical and Boolean values so they are
        unquoted in the JSON.
        ...
        Extracts a subset of an hstore containing only the
        specified keys.
...
-----+-------
 ...
 b   | 2
        ...
        Does hstore contain a non-NULL value
        for key?
