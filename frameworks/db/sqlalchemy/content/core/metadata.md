...
generated_at: "2026-08-29T09:39:27.518888Z"
---
.. _metadata_toplevel:
...
**seealso:** :ref:`tutorial_working_with_metadata` - tutorial introduction to
...
**tip:** The :attr:`_sql.FromClause.c` collection, synonymous with the
...
**seealso:** :ref:`orm_declarative_table_schema_name` - schema name specification when using the ORM
...
**seealso:** :ref:`multipart_schema_names` - describes use of dotted schema names
...
**seealso:** :paramref:`_schema.MetaData.schema`
...
**seealso:** :ref:`postgresql_alternate_search_path` - in the :ref:`postgresql_toplevel` dialect documentation.
