...
generated_at: "2026-08-29T09:39:27.529603Z"
---
...
**tip:** Within the :meth:`_engine.Engine.begin` block, we can call upon the
...
**seealso:** :ref:`SQLite Transaction Isolation <sqlite_isolation_level>`
...
**tip:** The :class:`.Result` object may be used as a context manager as illustrated
...
**seealso:** :ref:`orm_queryguide_yield_per` - in the :ref:`queryguide_toplevel`
...
**tip:** To use the schema translation feature with the ORM :class:`_orm.Session`,
...
**seealso:** :ref:`faq_new_caching` - in the :ref:`faq_toplevel` section
...
**seealso:** :ref:`postgresql_monotonic_functions`
...
**seealso:** :ref:`faq_dbapi_connection` - includes additional details about how
