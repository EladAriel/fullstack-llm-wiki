...
generated_at: "2026-08-29T09:39:27.511682Z"
---
...
**note:** When using SQL functions with the :attr:`.func` construct, we "call" the
...
**seealso:** :ref:`orm_server_defaults`
...
**tip:** In newer database engines, the :class:`.Identity` construct should likely
...
**seealso:** :ref:`postgresql_sequences` - in the PostgreSQL dialect documentation
...
**seealso:** :class:`.Computed` - produces a GENERATED ALWAYS AS phrase for :class:`.Column`
