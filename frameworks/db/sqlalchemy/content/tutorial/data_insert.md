...
generated_at: "2026-08-29T09:39:27.531340Z"
---
# Data_Insert
...
**tip:** When passing a list of dictionaries to :meth:`_engine.Connection.execute`
...
**deepalchemy:** Hi, welcome to the first edition of **Deep Alchemy**.   The person on the
...
**seealso:** :class:`_sql.Insert` - in the SQL Expression API documentation
