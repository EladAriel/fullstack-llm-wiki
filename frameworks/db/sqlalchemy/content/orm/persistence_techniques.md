...
generated_at: "2026-08-29T09:39:27.570225Z"
---
...
**seealso:** :ref:`mssql_insert_behavior` - background on the SQL Server dialect's
...
**seealso:** :ref:`metadata_defaults_toplevel`
...
**seealso:** :paramref:`.Session.binds`
...
**seealso:** `Django-style Database Routers in SQLAlchemy <https://techspot.zzzeek.org/2012/01/11/django-style-database-routers-in-sqlalchemy/>`_  - blog post on a more comprehensive example of :meth:`.Session.get_bind`
...
**legacy:** SQLAlchemy 2.0 has integrated the :class:`_orm.Session` "bulk insert" and
