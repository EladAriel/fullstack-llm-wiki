...
generated_at: "2026-08-29T09:39:27.558852Z"
---
# Session Basics
...
**note:** Note that after :meth:`_orm.Session.commit` is called, either explicitly or
...
**seealso:** :class:`_orm.sessionmaker`
...
**seealso:** :ref:`queryguide_toplevel`
...
**seealso:** :ref:`cascade_delete` - describes "delete cascade", which marks related
...
**seealso:** :ref:`faq_session_rollback` - further background on why
