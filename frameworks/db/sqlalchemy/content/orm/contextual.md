...
generated_at: "2026-08-29T09:39:27.573923Z"
---
...
**warning:** The :class:`.scoped_session` registry by default uses a Python
    ``threading.local()``
...
**note:** The :class:`.scoped_session` object is a very popular and useful object
