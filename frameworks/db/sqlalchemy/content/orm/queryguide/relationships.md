...
generated_at: "2026-08-29T09:39:27.725948Z"
---
...
**seealso:** :ref:`orm_queryguide_load_only_related` - illustrates examples of combining
...
**seealso:** :ref:`wildcard_loader_strategies`
...
**tip:** When including :func:`_orm.joinedload` in reference to a one-to-many or
...
**seealso:** :ref:`contains_eager` - using :func:`.contains_eager`
...
**tip:** by "simple" we mean that the :paramref:`_orm.relationship.primaryjoin`
...
**seealso:** :ref:`loader_option_criteria` - modern API allowing WHERE criteria directly
