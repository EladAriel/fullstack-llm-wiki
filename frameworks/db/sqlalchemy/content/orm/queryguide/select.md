...
generated_at: "2026-08-29T09:39:27.727854Z"
---
**highlight:** pycon+sql
...
**seealso:** The :class:`_orm.aliased` construct is central for several use cases,
    including:
...
**seealso:** :ref:`tutorial_subqueries_orm_aliased` - in the :ref:`unified_tutorial`
...
**seealso:** :ref:`tutorial_orm_union` - in the :ref:`unified_tutorial`
...
**tip:** Note that using :meth:`_sql.Select.join` to JOIN from one entity to another
...
**seealso:** The :meth:`_orm.PropComparator.and_` method also works with loader
...
**tip:** The :meth:`_sql.Select.select_from` method does not actually have the
