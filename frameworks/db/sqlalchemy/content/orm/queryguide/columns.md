...
generated_at: "2026-08-29T09:39:27.731249Z"
---
**highlight:** pycon+sql
...
**note:** It is not yet possible to mix :func:`_orm.load_only` and :func:`_orm.defer`
...
**seealso:** The :paramref:`_orm.defer.raiseload` feature is the column-level version
...
**seealso:** :ref:`mapper_column_property_sql_expressions` - in the section
...
**seealso:** The :func:`_orm.with_expression` option is a special option used to
