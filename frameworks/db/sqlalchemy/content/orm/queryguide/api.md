...
generated_at: "2026-08-29T09:39:27.729204Z"
---
**highlight:** pycon+sql
...
**seealso:** * :ref:`loading_columns` - details mapper and loading options that affect
...
**seealso:** :ref:`faq_session_identity` - in :doc:`/faq/index`
...
**tip:** From the above, it follows that the :class:`_engine.Result` must be
...
**seealso:** :ref:`engine_stream_results`
...
**seealso:** :ref:`examples_sharding` - in the :ref:`examples_toplevel` section.
