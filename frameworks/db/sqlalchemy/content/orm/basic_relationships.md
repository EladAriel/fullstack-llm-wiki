...
generated_at: "2026-08-29T09:39:27.580205Z"
---
# Basic_Relationships
...
**seealso:** :ref:`custom_collections` - contains further detail on collection
...
**tip:** If using Python 3.10 or greater, :pep:`604` syntax is more convenient
...
**seealso:** :ref:`cascade_delete_many_to_many`
...
**seealso:** :ref:`associationproxy_toplevel` - allows direct "many to many" style
    access between parent and child for a three-class association object mapping.

**warning:** Avoid mixing the association object pattern with the :ref:`many-to-many <relationships_many_to_many>`
...
**warning:** As stated previously, the above parameters to :func:`_orm.relationship`
