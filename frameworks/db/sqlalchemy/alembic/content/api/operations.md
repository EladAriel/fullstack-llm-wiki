...
source_branch: "main"
source_path: "docs/build/api/operations.rst"
...
> **Note:** the internal system of defining migration operation directives.
...
> **Seealso:**  `autogen_custom_ops` - how to add autogenerate support to
 custom operations.
