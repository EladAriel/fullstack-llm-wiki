...
framework: "nextjs"
directory: "content/03-architecture"
...
This directory contains nextjs learning pages related to 03 architecture.

## Breadcrumbs

[Wiki Home](../../index.md) -> [Content](../index.md) -> [03 Architecture](index.md)
...
- [Nextjs Compiler](nextjs-compiler.md)
