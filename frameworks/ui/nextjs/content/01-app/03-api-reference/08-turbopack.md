...
source_path: "docs/01-app/03-api-reference/08-turbopack.mdx"
...
generated_at: "2026-08-29T09:40:24.260218Z"
---
# 08 Turbopack
...
| `turbopackMangleExportNames`                                                                                 | Shorten the export names modules expose to each other, to reduce bundle size. A module whose export names can be observed (an escaping namespace object, a dynamic `import()`, a CommonJS `require()`) keeps its original names. | `false`       | `false`                       |
