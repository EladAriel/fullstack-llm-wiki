...
source_branch: "main"
source_path: "docs/docs/2026-07-28/tools/inspector/authorization.mdx"
...
generated_at: "2026-08-29T09:38:48.035211Z"
---
---
title: Authorization
...
A server can refuse a _single_ request mid-session with a `401` or a `403 insufficient_scope`, and the Inspector handles both without dropping the connection:
...
The `deepLink` in the handoff block navigates a browser straight to a _connected_ Inspector; see [Deep links](/docs/2026-07-28/tools/inspector/web#deep-links).
