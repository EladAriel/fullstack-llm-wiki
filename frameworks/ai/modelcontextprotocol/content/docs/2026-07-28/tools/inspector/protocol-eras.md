...
source_branch: "main"
source_path: "docs/docs/2026-07-28/tools/inspector/protocol-eras.mdx"
...
generated_at: "2026-08-29T09:38:48.035633Z"
---
# Protocol Eras
...
Tasks change the most between protocol eras, including _how the Inspector UI tab is gated_.
...
Tasks are an **extension** (`io.modelcontextprotocol/tasks`, [SEP-2663](/seps/2663-tasks-extension)), so the tab is gated on the _negotiated extension_ rather than on `capabilities.tasks`.
