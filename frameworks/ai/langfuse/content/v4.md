...
source_branch: "main"
source_path: "content/docs/v4.mdx"
...
generated_at: "2026-08-29T09:38:37.745318Z"
---
---
...
- [Alerts](/docs/observability/features/alerts) on your application metrics
...
Langfuse Cloud becomes v4-only on <V4CutoverDate />. Complete every action detected for your projects before this date.
...
- Organizations created before that date can switch the **Langfuse v4 preview** toggle (bottom-left in the UI) on and off until Langfuse Cloud becomes v4-only on <V4CutoverDate />.
...
Please note that you must migrate your projects to v4 before the cutover on <V4CutoverDate />.
