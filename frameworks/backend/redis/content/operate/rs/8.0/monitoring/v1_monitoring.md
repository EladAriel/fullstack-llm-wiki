...
source_branch: "main"
source_path: "content/operate/rs/8.0/monitoring/v1_monitoring.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.626699Z"
---
# V1_Monitoring
...
weight: 50
url: '/operate/rs/8.0/monitoring/v1_monitoring/'
---
...
- [Statistics APIs]({{<relref "/operate/rs/8.0/references/rest-api/objects/statistics">}}):
...
- v1 Prometheus scraping endpoint:
    ...
    - Redis Software exposes a legacy `/prometheus_metrics` endpoint to integrate with external observability platforms like [Prometheus and Grafana]({{<relref "/operate/rs/8.0/monitoring/get-started">}}).
...
To improve monitoring and address current limitations, Redis Software is transitioning to a new observability foundation: the [metrics stream engine]({{<relref "/operate/rs/8.0/monitoring/metrics_stream_engine">}}).
...
1. In **Cluster > Alert Settings**, click **Edit**.
1. Select **Set an email** to configure the [email server settings]({{< relref "/operate/rs/8.0/clusters/configure/cluster-settings#configuring-email-server-settings" >}}).
1. In **Configuration** for the database, click **Edit**.
1. Select the **Alerts** section to open it.
1. Select **Receive email alerts** and click **Save**.
1. In **Access Control**, select the [database and cluster alerts]({{< relref "/operate/rs/8.0/security/access-control/manage-users" >}}) that you want each user to receive.
