...
url: '/operate/rs/8.0/monitoring/metrics_stream_engine/'
---
...
1. Use the metrics tables in [this guide]({{<relref "/operate/rs/8.0/monitoring/metrics_stream_engine/prometheus-metrics-v1-to-v2">}}) to transition from v1 metrics to equivalent v2 PromQL.
