...
- [Active-Active]({{<relref "/operate/rs/8.0/databases/active-active">}})
...
- [Plan your deployment]({{< relref "/operate/rs/8.0/flex/plan" >}}): Review hardware requirements, sizing guidelines, and limitations.
- [Get started]({{< relref "/operate/rs/8.0/flex/get-started" >}}): Configure Flex on your cluster.
- [Scale your deployment]({{< relref "/operate/rs/8.0/flex/scale" >}}): Learn scaling strategies and best practices.
