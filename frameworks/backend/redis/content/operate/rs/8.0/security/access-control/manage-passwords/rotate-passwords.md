...
source_branch: "main"
source_path: "content/operate/rs/8.0/security/access-control/manage-passwords/rotate-passwords.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.653114Z"
---
# Rotate Passwords
...
toc: 'true'
weight: 70
url: '/operate/rs/8.0/security/access-control/manage-passwords/rotate-passwords/'
---

Redis Software lets you implement password rotation policies using the [REST API]({{< relref "/operate/rs/8.0/references/rest-api" >}}).
...
{{< note >}}
Password rotation does not work for the default user. [Add additional users]({{< relref "/operate/rs/8.0/security/access-control/create-users" >}}) to enable password rotation.
{{< /note >}}

## Password rotation policies

For user access to the Redis Software Cluster Manager UI,
you can set a [password expiration policy]({{< relref "/operate/rs/8.0/security/access-control/manage-passwords/password-expiration" >}}) to prompt the user to change their password.
...
With the Redis Software REST API, you can add additional passwords to your user account for authentication to the database or the Cluster Manager UI and API.
...
The new password cannot already exist as a password for the user and must meet the [password complexity]({{< relref "/operate/rs/8.0/security/access-control/manage-passwords/password-complexity-rules" >}}) requirements, if enabled.
...
1. Add an additional password to a user's password list with [`POST /v1/users/password`]({{< relref "/operate/rs/8.0/references/rest-api/requests/users/password#add-password" >}}).
...
1. Delete the original password with [`DELETE /v1/users/password`]({{< relref "/operate/rs/8.0/references/rest-api/requests/users/password#delete-password" >}}):
...
To replace a user's passwords, use [`PUT /v1/users/password`]({{< relref "/operate/rs/8.0/references/rest-api/requests/users/password#update-password" >}}).
