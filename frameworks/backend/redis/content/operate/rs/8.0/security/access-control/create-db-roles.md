...
source_branch: "main"
source_path: "content/operate/rs/8.0/security/access-control/create-db-roles.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.647946Z"
---
# Create Db Roles
...
weight: 15
url: '/operate/rs/8.0/security/access-control/create-db-roles/'
---

Roles with database access grant the ability to access and interact with a database's data. Database access privileges are determined by defining [Redis ACLs]({{<relref "/operate/rs/8.0/security/access-control/redis-acl-overview">}}) and adding them to roles.
...
1. [Update a database's configuration]({{<relref "/operate/rs/8.0/references/rest-api/requests/bdbs#put-bdbs">}}) to add `roles_permissions` with the role and Redis ACL:
...
You can [assign the new role to users]({{<relref "/operate/rs/8.0/security/access-control/create-users#assign-roles-to-users">}}) to grant database access.
