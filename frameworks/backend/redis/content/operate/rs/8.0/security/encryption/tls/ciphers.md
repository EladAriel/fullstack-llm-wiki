...
source_branch: "main"
source_path: "content/operate/rs/8.0/security/encryption/tls/ciphers.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.654444Z"
---
# Ciphers
...
weight: 60
url: '/operate/rs/8.0/security/encryption/tls/ciphers/'
---
...
| sentinel_cipher_suites | <span title="Yes">&#x2705; Yes</span> | Cipher list for [discovery service]({{< relref "/operate/rs/8.0/databases/durability-ha/discovery-service" >}}) (Sentinel) TLS 1.2 communications |
...
| sentinel_cipher_suites_tls_1_3 | <span title="No">&#x274c; No</span> | Cipher list for [discovery service]({{< relref "/operate/rs/8.0/databases/durability-ha/discovery-service" >}}) (Sentinel) TLS 1.3 communications |

## Configure cipher suites

You can configure ciphers with the [Cluster Manager UI](#edit-ciphers-ui), [`rladmin`]({{< relref "/operate/rs/8.0/references/cli-utilities/rladmin/cluster/config" >}}), or the [REST API]({{< relref "/operate/rs/8.0/references/rest-api/requests/cluster#put-cluster" >}}).
...
To configure TLS 1.2 cipher suites for cluster communication, use the following [`rladmin`]({{< relref "/operate/rs/8.0/references/cli-utilities/rladmin" >}}) command syntax:
...
To configure TLS 1.2 cipher suites for communications between applications and databases, use the following [`rladmin`]({{< relref "/operate/rs/8.0/references/cli-utilities/rladmin" >}}) command syntax:
...
To configure TLS 1.3 cipher suites for communications between applications and databases, use the following [`rladmin`]({{< relref "/operate/rs/8.0/references/cli-utilities/rladmin" >}}) command syntax:
...
Sentinel service cipher suites use the golang.org OpenSSL format for [discovery service]({{< relref "/operate/rs/8.0/databases/durability-ha/discovery-service" >}}) TLS connections in Redis Software version 6.0.20 or later. See their documentation for a list of [available configurations](https://golang.org/src/crypto/tls/cipher_suites.go).

#### Configure TLS 1.2 discovery service cipher suites

To configure TLS 1.2 cipher suites for the discovery service cipher suites, use the following [`rladmin`]({{< relref "/operate/rs/8.0/references/cli-utilities/rladmin" >}}) command syntax:
