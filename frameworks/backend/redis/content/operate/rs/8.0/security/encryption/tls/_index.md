...
source_branch: "main"
source_path: "content/operate/rs/8.0/security/encryption/tls/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.653877Z"
---
# _Index
...
linkTitle: TLS
weight: 10
url: '/operate/rs/8.0/security/encryption/tls/'
---
...
You can [use TLS authentication]({{< relref "/operate/rs/8.0/security/encryption/tls/enable-tls" >}}) for the following types of communication:
...
- Communication to and from your database to other clusters for synchronization using [Active-Active]({{< relref "/operate/rs/8.0/databases/active-active/" >}})
...
You can change the [TLS protocols]({{< relref "/operate/rs/8.0/security/encryption/tls/tls-protocols" >}}) and [ciphers]({{< relref "/operate/rs/8.0/security/encryption/tls/ciphers" >}}) to improve the security of your Redis Software cluster and databases. The default settings are in line with industry best practices, but you can customize them to match the security policy of your organization.
