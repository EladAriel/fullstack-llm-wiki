...
source_branch: "main"
source_path: "content/operate/rs/8.0/security/access-control/ldap/migrate-to-role-based-ldap.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.651826Z"
---
...
description: Describes how to migrate existing cluster-based LDAP deployments to role-based
  LDAP.
weight: 55
url: '/operate/rs/8.0/security/access-control/ldap/migrate-to-role-based-ldap/'
---

Redis Software supports LDAP through a [role-based mechanism]({{< relref "/operate/rs/8.0/security/access-control/ldap/" >}}), first introduced [in v6.0.20]({{< relref "/operate/rs/release-notes/rs-6-0-20-april-2021" >}}).
...
- Use the [REST API]({{< relref "/operate/rs/8.0/references/rest-api" >}}) to connect using authorized LDAP credentials.
