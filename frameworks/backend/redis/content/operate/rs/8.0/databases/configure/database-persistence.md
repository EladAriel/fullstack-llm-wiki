...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/configure/database-persistence.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.629918Z"
---
...
weight: 30
url: '/operate/rs/8.0/databases/configure/database-persistence/'
---

Data is stored in RAM or a combination of RAM and flash memory ([Redis Flex and Auto Tiering]({{< relref "/operate/rs/8.0/databases/flash/" >}})), which risks data loss during process or server failures. Redis Software supports multiple methods to persist data to disk on a per-database basis to ensure data durability.
...
You can configure persistence when you [create a database]({{< relref "/operate/rs/8.0/databases/create" >}}), or you can edit an existing database's configuration:
