...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/import-export/import-data.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.632203Z"
---
# Import Data
...
- operate
- rs
description: You can import export or backup files of a specific Redis Software database to restore data. You can either import from a single file or from multiple files, such as when you want to import from a backup of a clustered database.
linktitle: Import data
weight: 10
url: '/operate/rs/8.0/databases/import-export/import-data/'
---
You can import, [export]({{< relref "/operate/rs/8.0/databases/import-export/export-data" >}}),
or [backup]({{< relref "/operate/rs/8.0/databases/import-export/schedule-backups" >}})
...
To import data into a database using the REST API, send an [import database request]({{<relref "/operate/rs/8.0/references/rest-api/requests/bdbs/actions/import">}}):
...
When importing from a local mount point or a cloud provider, import locations need to be available to [the group and user]({{< relref "/operate/rs/8.0/installing-upgrading/install/customize-user-and-group.md" >}}) running Redis Software, `redislabs:redislabs` by default.  
...
Example [import database REST API request]({{<relref "/operate/rs/8.0/references/rest-api/requests/bdbs/actions/import">}}):
...
As of version 6.2.12, Redis Software reads files directly from the mount point using a [symbolic link](https://en.wikipedia.org/wiki/Symbolic_link) (symlink) instead of copying them to a temporary directory on the node.
...
1. Configure the S3 URL with [`rladmin cluster config`]({{<relref "/operate/rs/8.0/references/cli-utilities/rladmin/cluster/config">}}): 
...
- [Flush all data]({{< relref "/operate/rs/8.0/databases/import-export/flush#flush-data-from-an-active-active-database" >}}) from the Active-Active database, then import the data into the database.
...
The import through the Redis Software Cluster Manager UI handles these data types for you.
