...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/active-active/disaster-recovery/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.634788Z"
---
# _Index
...
hideListLinks: true
weight: 50
url: '/operate/rs/8.0/databases/active-active/disaster-recovery/'
---
...
- [Network-based]({{<relref "/operate/rs/8.0/databases/active-active/disaster-recovery/network-based">}}): Global traffic managers and load balancers handle routing at the network layer, requiring no application changes.

- [Proxy-based]({{<relref "/operate/rs/8.0/databases/active-active/disaster-recovery/proxy-based">}}): Software proxies handle detection and routing logic.

- [Client library-based]({{<relref "/operate/rs/8.0/databases/active-active/disaster-recovery/client-library-based">}}): Redis client libraries with built-in failover logic.

- [Application-based]({{<relref "/operate/rs/8.0/databases/active-active/disaster-recovery/application-based">}}): Custom application-level monitoring and connectivity management.
...
- Does the Active-Active database use DNS, the [OSS Cluster API]({{<relref "/operate/rs/8.0/clusters/optimize/oss-cluster-api">}}), or the [discovery service]({{<relref "/operate/rs/8.0/databases/durability-ha/discovery-service">}})?
...
See [Lag-aware database availability requests]({{<relref "/operate/rs/8.0/monitoring/db-availability#lag-aware">}}) for more information.
