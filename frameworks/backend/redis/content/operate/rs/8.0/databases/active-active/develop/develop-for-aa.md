...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/active-active/develop/develop-for-aa.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.635962Z"
---
# Develop For Aa
...
weight: 10
url: '/operate/rs/8.0/databases/active-active/develop/develop-for-aa/'
---
...
- **Active-Passive geo-distributed deployments**: With active-passive
    ...
    provides a [Replica Of]({{<relref "/operate/rs/8.0/databases/import-export/replica-of/">}}) capability that provides a similar approach.
...
The default policy for Active-Active databases is _noeviction_ mode. Redis Software version 6.0.20 and later support all eviction policies for Active-Active databases, unless [Redis Flex or Auto Tiering]({{< relref "/operate/rs/8.0/databases/flash" >}}) (previously known as Redis on Flash) is enabled.

For details, see [eviction for Active-Active databases (Redis Software)]({{< relref "/operate/rs/8.0/databases/memory-performance/eviction-policy#active-active-database-eviction" >}}) or [eviction for Active-Active databases (Redis Cloud)]({{< relref "/operate/rc/databases/configuration/data-eviction-policies#active-active-replication-considerations" >}}).
