...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/active-active/syncer.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.628089Z"
---
# Syncer
...
weight: 90
url: '/operate/rs/8.0/databases/active-active/syncer/'
---
...
Partial synchronization requires a backlog large enough to store the data operations until connection is restored. See [replication backlog]({{< relref "/operate/rs/8.0/databases/active-active/manage#replication-backlog" >}}) for more info on changing the replication backlog size.
...
- The [Active-Active replication backlog]({{< relref "/operate/rs/8.0/databases/active-active/manage#replication-backlog" >}}) is also sent to the replica during a full sync.
...
To restart a regular database's syncer after an unrecoverable error, [update the database configuration]({{<relref "/operate/rs/8.0/references/rest-api/requests/bdbs#put-bdbs">}}) with the REST API to enable `sync`:
...
-  For each participating cluster, [update the database configuration]({{<relref "/operate/rs/8.0/references/rest-api/requests/bdbs#put-bdbs">}}) with the REST API to enable `sync`:
...
- Run [`crdb-cli crdb update`]({{<relref "/operate/rs/8.0/references/cli-utilities/crdb-cli/crdb/update">}}):
