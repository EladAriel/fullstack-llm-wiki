...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/create.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.618737Z"
---
# Create
...
toc: 'true'
weight: 10
url: '/operate/rs/8.0/databases/create/'
---
...
1. [Test client connectivity]({{< relref "/operate/rs/8.0/databases/connect/test-client-connectivity" >}}).


{{< note >}}
For databases with Active-Active replication for geo-distributed locations,
see [Create an Active-Active database]({{< relref "/operate/rs/8.0/databases/active-active/create.md" >}}). To create and manage Active-Active databases, use the legacy UI.
{{< /note >}}
...
1. Optionally select **Full options** to configure [additional settings]({{< relref "/operate/rs/8.0/databases/configure#config-settings" >}}).
...
1. Select the database type:
    ...
    - **Active-Active database** - Multiple participating Redis Software clusters can host instances of the same [Active-Active database]({{< relref "/operate/rs/8.0/databases/active-active" >}}) in different geographic locations. Every instance can receive write operations, which are synchronized across all instances without conflict.

    {{<note>}}
For Active-Active databases, see [Create an Active-Active geo-replicated database]({{< relref "/operate/rs/8.0/databases/active-active/create" >}}).
    {{</note>}}
...
1. To configure additional database settings, expand each relevant section to make changes.
    ...
    See [Configuration settings]({{< relref "/operate/rs/8.0/databases/configure#config-settings" >}}) for more information about each setting.

1. Select **Create**.

## REST API method

To [create a database]({{<relref "/operate/rs/8.0/references/rest-api/requests/bdbs#post-bdbs-v1">}}) using a REST API request:
