...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/import-export/flush.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.631283Z"
---
# Flush
...
weight: 40
url: '/operate/rs/8.0/databases/import-export/flush/'
---
...
We recommend that you [back up your database]({{< relref "/operate/rs/8.0/databases/import-export/schedule-backups.md" >}}) before you flush the data.
{{< /warning >}}
...
2. Connect to each IP address using [`redis-cli`]({{<relref "/operate/rs/8.0/references/cli-utilities/redis-cli">}}) and run the [`FLUSHDB`]({{<relref "/commands/flushdb">}}) command:
...
- REST API
    ...
    1. To find the ID of the Active-Active database, use [`GET /v1/crdbs`]({{< relref "/operate/rs/8.0/references/rest-api/requests/crdbs#get-all-crdbs" >}}):

        ```sh
        GET https://[host][:port]/v1/crdbs
        ```

    1. To flush the Active-Active database, use [`PUT /v1/crdbs/{guid}/flush`]({{< relref "/operate/rs/8.0/references/rest-api/requests/crdbs/flush#put-crdbs-flush" >}}):
    ...
    1. To check the status of the flush task, use [`GET /v1/crdb_tasks`]({{< relref "/operate/rs/8.0/references/rest-api/requests/crdb_tasks#get-crdb_task" >}}):
