...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/connect/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.630473Z"
---
# _Index
...
linkTitle: Connect
weight: 20
url: '/operate/rs/8.0/databases/connect/'
---

After you [set up a cluster]({{< relref "/operate/rs/8.0/clusters/new-cluster-setup" >}}) and [create a Redis database]({{< relref "/operate/rs/8.0/databases/create" >}}), you can connect to your database.
...
If you try to connect with the FQDN, and the database does not respond, try connecting with the IP address. If this succeeds, DNS is not properly configured. To set up DNS, see [Configure cluster DNS]({{< relref "/operate/rs/8.0/networking/cluster-dns" >}}).

If you want to secure your connection, set up [TLS]({{< relref "/operate/rs/8.0/security/encryption/tls/" >}}).

## Connect to a database

Use one of the following connection methods to connect to your database:

- [`redis-cli`]({{< relref "/operate/rs/8.0/references/cli-utilities/redis-cli/" >}}) utility

- [Redis Insight](https://redis.com/redis-enterprise/redis-insight/)

- [Redis client]({{< relref "/develop/clients" >}}) for your preferred programming language

For examples, see [Test client connection]({{< relref "/operate/rs/8.0/databases/connect/test-client-connectivity" >}}).
