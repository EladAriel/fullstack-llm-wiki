...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/import-export/migrate-to-active-active.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.631823Z"
---
...
weight: $weight
url: '/operate/rs/8.0/databases/import-export/migrate-to-active-active/'
---

If you have data in a single-region Redis Software database that you want to migrate to an [Active-Active database]({{< relref "/operate/rs/8.0/databases/active-active" >}}),
you'll need to create a new Active-Active database and migrate the data into the new database as a [Replica Of]({{< relref "/operate/rs/8.0/databases/import-export/replica-of/" >}}) the existing database.
...
the [client mDNS prerequisites]({{< relref "/operate/rs/8.0/networking/mdns" >}}) must be met in order to communicate with other clusters.
...
1. Create a new Active-Active database. For prerequisites and detailed instructions, see [Create an Active-Active geo-replicated database]({{< relref "/operate/rs/8.0/databases/active-active/create" >}}).
...
you can [compress the replication data]({{< relref "/operate/rs/8.0/databases/import-export/replica-of#data-compression-for-replica-of" >}}) to save bandwidth.
{{< /note >}}
