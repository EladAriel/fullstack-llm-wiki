...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/flash/quickstart.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.634490Z"
---
# Quickstart
...
url: '/operate/rs/8.0/databases/flash/quickstart/'
---

{{<banner-article>}}
This article includes a quick start for Flex and its predecessor Auto Tiering. For more detailed information about Flex, see the dedicated [Flex databases]({{<relref "/operate/rs/8.0/flex">}}) section instead.
{{</banner-article>}}

This page guides you through a quick setup of [Flex and Auto Tiering]({{< relref "/operate/rs/8.0/databases/flash" >}}) with a single node for testing and demo purposes.

For production environments, you can find more detailed installation instructions in the [install and setup]({{< relref "/operate/rs/8.0/installing-upgrading" >}}) section.
...
To see the true performance and scale of Flex, you must tune your I/O path and set the flash path to the mounted path of SSD or NVMe flash memory as that is what it is designed to run on. For more information, see [Flex and Auto Tiering]({{< relref "/operate/rs/8.0/databases/flash/" >}}).
