...
source_branch: "main"
source_path: "content/operate/rs/8.0/databases/connect/test-client-connectivity.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.630639Z"
---
---
...
weight: 20
url: '/operate/rs/8.0/databases/connect/test-client-connectivity/'
---
...
1. After you [create a Redis database]({{< relref "/operate/rs/8.0/databases/create" >}}), copy the database endpoint, which contains the cluster name (FQDN).
...
1. If the database does not respond, try to connect to the database
    ...
    [Configure cluster DNS]({{< relref "/operate/rs/8.0/networking/cluster-dns" >}}).
...
- [`redis-cli`]({{< relref "/operate/rs/8.0/references/cli-utilities/redis-cli" >}}), the built-in command-line tool
...
For more `redis-cli` connection examples, see the [`redis-cli` reference]({{< relref "/operate/rs/8.0/references/cli-utilities/redis-cli" >}}).
...
1. Select **Use TLS** if [TLS]({{< relref "/operate/rs/8.0/security/encryption/tls" >}}) is set up.
