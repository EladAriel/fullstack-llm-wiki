...
source_branch: "main"
source_path: "content/operate/rs/8.0/clusters/remove-node.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.620880Z"
---
# Remove Node
...
weight: 80
url: '/operate/rs/8.0/clusters/remove-node/'
---
...
You can configure [email alerts from the cluster]({{< relref "/operate/rs/8.0/monitoring/v1_monitoring#cluster-alerts" >}}) to notify you of cluster changes, including when a node is removed.
...
node]({{< relref "/operate/rs/8.0/clusters/replace-node.md" >}}).
...
cluster]({{< relref "/operate/rs/8.0/clusters/add-node.md" >}}).
...
(CLI)]({{< relref "/operate/rs/8.0/references/cli-utilities/rladmin" >}}).

{{< note >}}
The [DNS records]({{< relref "/operate/rs/8.0/networking/cluster-dns" >}}) must be updated each time a node is added or replaced.
{{< /note >}}
...
To remove a node using the REST API, use [`POST /v1/nodes/<node_id>/actions/remove`]({{< relref "/operate/rs/8.0/references/rest-api/requests/nodes/actions#post-node-action" >}}).
...
you must [uninstall]({{< relref "/operate/rs/8.0/installing-upgrading/uninstalling.md" >}})
and [reinstall]({{< relref "/operate/rs/8.0/installing-upgrading" >}}) the software on that node.
{{< /note >}}
