...
source_branch: "main"
source_path: "content/operate/rs/8.0/clusters/add-node.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.620547Z"
---
# Add Node
...
weight: 20
url: '/operate/rs/8.0/clusters/add-node/'
---
...
- The clocks on all nodes must always be [synchronized]({{< relref "/operate/rs/8.0/clusters/configure/sync-clocks.md" >}}).
...
- You must [update the DNS records]({{< relref "/operate/rs/8.0/networking/cluster-dns" >}})
...
1. [Install the Redis Software installation package]({{< relref "/operate/rs/8.0/installing-upgrading" >}}) on a clean installation
    of a [supported operating system]({{< relref "/operate/rs/8.0/installing-upgrading/install/plan-deployment/supported-platforms.md" >}}).
...
You can also [replace the TLS certificate]({{< relref "/operate/rs/8.0/security/certificates/updating-certificates" >}})
...
- Command-line method:
    ...
    Run the [`rlcheck`]({{< relref "/operate/rs/8.0/references/cli-utilities/rlcheck" >}}) utility from the node's command line.
