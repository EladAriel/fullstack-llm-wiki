...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/requests/nodes/actions.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.685065Z"
---
# Actions
...
linkTitle: actions
weight: $weight
url: '/operate/rs/8.0/references/rest-api/requests/nodes/actions/'
---
...
|-----------------|-------|
| [view_status_of_all_node_actions]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_status_of_all_node_actions" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a list of [action objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/action" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [view_status_of_node_action]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_status_of_node_action" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a JSON object that includes a list of [action objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/action" >}}) for the specified node.
...
Returns an [action object]({{< relref "/operate/rs/8.0/references/rest-api/objects/action" >}}) for the specified node.
...
| Permission name | Roles |
|-----------------|-------|
| [start_node_action]({{< relref "/operate/rs/8.0/references/rest-api/permissions#start_node_action" >}}) | admin |
...
- `maintenance_on`: Creates a snapshot of the node, migrates shards to other nodes, and prepares the node for maintenance. See [maintenance mode]({{< relref "/operate/rs/8.0/clusters/maintenance-mode" >}}) for more information.
...
- `maintenance_off`: Restores node to its previous state before maintenance started. See [maintenance mode]({{< relref "/operate/rs/8.0/clusters/maintenance-mode" >}}) for more information.
...
| Permission name |
|-----------------|
| [cancel_node_action]({{< relref "/operate/rs/8.0/references/rest-api/permissions#cancel_node_action" >}}) |
