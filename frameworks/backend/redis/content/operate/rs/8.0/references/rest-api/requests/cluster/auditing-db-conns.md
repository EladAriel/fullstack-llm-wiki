...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/requests/cluster/auditing-db-conns.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.675260Z"
---
# Auditing Db Conns
...
weight: $weight
url: '/operate/rs/8.0/references/rest-api/requests/cluster/auditing-db-conns/'
---
...
Gets the configuration settings for [auditing database connections]({{< relref "/operate/rs/8.0/security/audit-events" >}}).
...
Returns a [database connection auditing configuration object]({{< relref "/operate/rs/8.0/references/rest-api/objects/db-conns-auditing-config" >}}).
...
Updates the configuration settings for [auditing database connections]({{< relref "/operate/rs/8.0/security/audit-events" >}}).
...
Include a [database connection auditing configuration object]({{< relref "/operate/rs/8.0/references/rest-api/objects/db-conns-auditing-config" >}}) with updated fields in the request body.

### Response {#put-response} 

Returns the updated [database connection auditing configuration object]({{< relref "/operate/rs/8.0/references/rest-api/objects/db-conns-auditing-config" >}}).
...
Resets the configuration settings for [auditing database connections]({{< relref "/operate/rs/8.0/security/audit-events" >}}).
