...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/requests/nodes/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.684687Z"
---
# _Index
...
linkTitle: nodes
weight: $weight
url: '/operate/rs/8.0/references/rest-api/requests/nodes/'
---
...
|-----------------|-------|
| [view_all_nodes_info]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_all_nodes_info" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a JSON array of [node objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/node" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [view_node_info]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_node_info" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a [node object]({{< relref "/operate/rs/8.0/references/rest-api/objects/node" >}}).
...
Update a [node object]({{< relref "/operate/rs/8.0/references/rest-api/objects/node" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [update_node]({{< relref "/operate/rs/8.0/references/rest-api/permissions#update_node" >}}) | admin |
