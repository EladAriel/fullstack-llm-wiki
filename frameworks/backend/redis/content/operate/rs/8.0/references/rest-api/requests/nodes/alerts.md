...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/requests/nodes/alerts.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.684499Z"
---
# Alerts
...
linkTitle: alerts
weight: $weight
url: '/operate/rs/8.0/references/rest-api/requests/nodes/alerts/'
---
...
| Permission name |
|-----------------|
| [view_all_nodes_alerts]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_all_nodes_alerts" >}}) |
...
Returns a hash of node UIDs and the [alert states]({{< relref "/operate/rs/8.0/references/rest-api/objects/alert" >}}) for each node.
...
| Permission name |
|-----------------|
| [view_node_alerts]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_node_alerts" >}}) |
...
Returns a hash of [alert objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/alert" >}}) and their states for a specific node.
