...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/requests/redis_acls/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.681978Z"
---
# _Index
...
weight: $weight
url: '/operate/rs/8.0/references/rest-api/requests/redis_acls/'
---
...
|-----------------|-------|
| [view_all_redis_acls_info]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_all_redis_acls_info" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a JSON array of [Redis ACL objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [view_redis_acl_info]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_redis_acl_info" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a [Redis ACL object]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [update_redis_acl]({{< relref "/operate/rs/8.0/references/rest-api/permissions#update_redis_acl" >}}) | admin<br />user_manager |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |  | Validate the updated [Redis ACL object]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}) but don't apply the update. |
...
Include a [Redis ACL object]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}) with updated fields in the request body.

### Response {#put-response}

Returns the updated [Redis ACL object]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [create_redis_acl]({{< relref "/operate/rs/8.0/references/rest-api/permissions#create_redis_acl" >}}) | admin<br />user_manager |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |  | Validate the new [Redis ACL object]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}) but don't apply the update. |

#### Request body

Include a [Redis ACL object]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}) in the request body.

### Response {#post-response}

Returns the newly created [Redis ACL object]({{< relref "/operate/rs/8.0/references/rest-api/objects/redis_acl" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [delete_redis_acl]({{< relref "/operate/rs/8.0/references/rest-api/permissions#delete_redis_acl" >}}) | admin<br />user_manager |
