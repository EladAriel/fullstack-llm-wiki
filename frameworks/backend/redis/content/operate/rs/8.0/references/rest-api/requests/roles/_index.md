...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/requests/roles/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.682211Z"
---
# _Index
...
linkTitle: roles
weight: $weight
url: '/operate/rs/8.0/references/rest-api/requests/roles/'
---
...
|-----------------|-------|
| [view_all_roles_info]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_all_roles_info" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a JSON array of [role objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [view_role_info]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_role_info" >}}) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a [role object]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [update_role]({{< relref "/operate/rs/8.0/references/rest-api/permissions#update_role" >}}) | admin<br />user_manager |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |  | Validate the updated [role object]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}) but don't apply the update. |
...
Include a [role object]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}) with updated fields in the request body.

### Response {#put-response}

Returns a [role object]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}) with the updated fields.
...
| Permission name | Roles |
|-----------------|-------|
| [create_role]({{< relref "/operate/rs/8.0/references/rest-api/permissions#create_role" >}}) | admin<br />user_manager |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |  | Validate the new [role object]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}) but don't apply the update. |

#### Body

Include a [role object]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}) in the request body.

### Response {#post-response}

Returns the newly created [role object]({{< relref "/operate/rs/8.0/references/rest-api/objects/role" >}}).
...
| Permission name | Roles |
|-----------------|-------|
| [delete_role]({{< relref "/operate/rs/8.0/references/rest-api/permissions#delete_role" >}}) | admin<br />user_manager |
