...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/permissions.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.656045Z"
---
# Permissions
...
- operate
- rs
description: Documents the permissions used with Redis Software REST API
  calls.
linkTitle: Permissions
weight: 60
url: '/operate/rs/8.0/references/rest-api/permissions/'
---

Some Redis Software [REST API requests]({{< relref "/operate/rs/8.0/references/rest-api/requests" >}}) may require the user to have specific permissions.

Administrators can assign a predefined role to a user with the [Cluster Manager UI]({{< relref "/operate/rs/8.0/security/access-control/create-users" >}}) or a [<nobr>`PUT /v1/users/{uid}`</nobr> API request]({{< relref "/operate/rs/8.0/references/rest-api/requests/users#put-user" >}}) to grant necessary permissions to them.
...
| <a name="config_sso"></a>config_sso | admin |
...
| <a name="manage_cluster_modules"></a>manage_cluster_modules | admin |
...
| <a name="upgrade_crdb"></a>upgrade_crdb | admin<br />cluster_member<br />db_member |
...
| <a name="view_all_metrics"></a>view_all_metrics | admin<br />cluster_member<br />cluster_viewer |
...
| <a name="view_sso"></a>view_sso | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
