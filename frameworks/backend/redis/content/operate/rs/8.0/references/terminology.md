...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/terminology.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.625622Z"
---
# Terminology
...
weight: $weight
url: '/operate/rs/8.0/references/terminology/'
---
...
[setup process]({{< relref "/operate/rs/8.0/clusters/new-cluster-setup" >}}) was run in order to make the machine part of the cluster.
...
together with the other cluster nodes. You can [add nodes]({{< relref "/operate/rs/8.0/clusters/add-node" >}}), [remove nodes]({{< relref "/operate/rs/8.0/clusters/remove-node" >}}), or [replace nodes]({{< relref "/operate/rs/8.0/clusters/replace-node" >}}) as needed.
...
- [**Highly available Redis database**]({{< relref "/operate/rs/8.0/databases/durability-ha/replication" >}}) - Every database master shard
...
- [**Clustered Redis database**]({{< relref "/operate/rs/8.0/databases/durability-ha/clustering" >}}) - The data stored in the database is
    ...
    cluster, these algorithms might [migrate a shard]({{< relref "/operate/rs/8.0/databases/migrate-shards" >}}) between nodes.
...
You can configure [shard placement]({{< relref "/operate/rs/8.0/databases/configure/shard-placement" >}}) to optimize performance and availability.
...
You can configure [proxy policies]({{< relref "/operate/rs/8.0/databases/configure/proxy-policy" >}}) to determine which nodes' proxies are active and bound to databases.

## Database endpoint

Each database is served by a [database endpoint]({{< relref "/operate/rs/8.0/databases/connect/test-client-connectivity" >}}) that is part of and
...
For high availability, you can configure [private and public endpoints]({{< relref "/operate/rs/8.0/networking/private-public-endpoints" >}}) for your databases.
...
- Gathering [operational statistics]({{< relref "/operate/rs/8.0/monitoring" >}})
- Enforcing [license and subscription limitations]({{< relref "/operate/rs/8.0/clusters/configure/license-keys" >}})

You can manage your Redis Software clusters using the [Cluster Manager UI]({{< relref "/operate/rs/8.0/clusters/configure" >}}), [command-line tools]({{< relref "/operate/rs/8.0/references/cli-utilities" >}}), or the [REST API]({{< relref "/operate/rs/8.0/references/rest-api" >}}).
