...
source_branch: "main"
source_path: "content/operate/rs/8.0/references/rest-api/requests/bdbs/alerts.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.685861Z"
---
# Alerts
...
linkTitle: alerts
weight: $weight
url: '/operate/rs/8.0/references/rest-api/requests/bdbs/alerts/'
---
...
| Permission name |
|-----------------|
| [view_all_bdbs_alerts]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_all_bdbs_alerts" >}}) |
...
Returns a hash of alert UIDs and the [alerts]({{< relref "/operate/rs/8.0/references/rest-api/objects/alert" >}}) states for each database.
...
| Permission name |
|-----------------|
| [view_bdb_alerts]({{< relref "/operate/rs/8.0/references/rest-api/permissions#view_bdb_alerts" >}}) |
...
Returns a hash of [alert objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/alert" >}}) and their states.
...
Returns an [alert object]({{< relref "/operate/rs/8.0/references/rest-api/objects/alert" >}}).
...
| Permission name |
|-----------------|
| [update_bdb_alerts]({{< relref "/operate/rs/8.0/references/rest-api/permissions#update_bdb_alerts" >}}) |
...
The request must contain a single JSON object with one or many database [alert objects]({{< relref "/operate/rs/8.0/references/rest-api/objects/alert" >}}).

### Response {#post-response} 

The response includes the updated database [alerts]({{< relref "/operate/rs/8.0/references/rest-api/objects/alert" >}}).
