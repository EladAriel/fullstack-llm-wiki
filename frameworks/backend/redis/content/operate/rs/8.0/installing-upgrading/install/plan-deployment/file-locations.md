...
source_branch: "main"
source_path: "content/operate/rs/8.0/installing-upgrading/install/plan-deployment/file-locations.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.646968Z"
---
# File Locations
...
weight: 60
url: '/operate/rs/8.0/installing-upgrading/install/plan-deployment/file-locations/'
---
{{<warning>}}
...
| /opt/redislabs/bin | Binaries for all the utilities for command-line access and management, such as [`rladmin`]({{< relref "/operate/rs/8.0/references/cli-utilities/rladmin" >}}) or [`redis-cli`]({{< relref "/operate/rs/8.0/references/cli-utilities/redis-cli" >}}) |
...
- [Ephemeral and persistence storage]({{< relref "/operate/rs/8.0/clusters/new-cluster-setup.md" >}}) during cluster setup
- [Socket files]({{< relref "/operate/rs/8.0/installing-upgrading/configuring/change-location-socket-files.md" >}}) after cluster setup

{{< note >}}
To specify custom paths for ephemeral and persistent storage during cluster setup, you must install Redis Software using [custom installation directories]({{< relref "/operate/rs/8.0/installing-upgrading/install/customize-install-directories" >}}). If you use the default installation, you cannot specify custom storage paths and will receive a "path not mounted" error.
{{< /note >}}
