...
source_branch: "main"
source_path: "content/operate/rs/8.0/installing-upgrading/install/customize-user-and-group.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.643494Z"
---
...
weight: 40
url: '/operate/rs/8.0/installing-upgrading/install/customize-user-and-group/'
---
...
To customize the user or group during [installation]({{< relref "/operate/rs/8.0/installing-upgrading/install/install-on-linux" >}}), include the `--os-user` or `--os-group` [command-line options]({{< relref "/operate/rs/8.0/installing-upgrading/install/install-script" >}}) when you run the `install.sh` script.
