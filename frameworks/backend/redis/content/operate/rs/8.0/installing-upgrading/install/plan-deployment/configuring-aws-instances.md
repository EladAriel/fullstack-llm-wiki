...
source_branch: "main"
source_path: "content/operate/rs/8.0/installing-upgrading/install/plan-deployment/configuring-aws-instances.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.646346Z"
---
...
weight: 80
url: '/operate/rs/8.0/installing-upgrading/install/plan-deployment/configuring-aws-instances/'
---
...
persistence storage]({{< relref "/operate/rs/8.0/installing-upgrading/install/plan-deployment/persistent-ephemeral-storage" >}}) is configured to use this volume.

{{< note >}}
After [installing the Redis Software package]({{< relref "/operate/rs/8.0/installing-upgrading" >}}) on the instance
and **before** running through [the setup process]({{< relref "/operate/rs/8.0/clusters/new-cluster-setup.md" >}}),
...
1. When using [Redis Flex or Auto Tiering]({{< relref "/operate/rs/8.0/databases/flash/" >}})
...
requirements]({{< relref "/operate/rs/8.0/installing-upgrading/install/plan-deployment/hardware-requirements.md" >}}).
...
- If you are using the DNS resolving option with Redis Software, define a DNS UDP
    ...
    using the [DNS resolving mechanism]({{< relref "/operate/rs/8.0/networking/cluster-dns" >}}).
- To create a cluster that has multiple nodes all running as instances on AWS,
    ...
    To limit the number of open ports, you can open only the [ports used by Redis Software]({{< relref "/operate/rs/8.0/networking/port-configurations.md" >}}).

After successfully launching the instances:

1. Install Redis Software from the [Linux package or AWS AMI]({{< relref "/operate/rs/8.0/installing-upgrading" >}}).
2. [Set up the cluster]({{< relref "/operate/rs/8.0/clusters/new-cluster-setup.md" >}}).
