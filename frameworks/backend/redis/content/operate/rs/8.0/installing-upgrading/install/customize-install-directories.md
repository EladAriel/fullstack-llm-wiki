...
source_branch: "main"
source_path: "content/operate/rs/8.0/installing-upgrading/install/customize-install-directories.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.643690Z"
---
...
weight: 30
url: '/operate/rs/8.0/installing-upgrading/install/customize-install-directories/'
---
...
To specify directories during [installation]({{< relref "/operate/rs/8.0/installing-upgrading/install/install-on-linux" >}}), include installer flags as [command-line options]({{< relref "/operate/rs/8.0/installing-upgrading/install/install-script" >}}) when you run the `install.sh` script. For example:
...
When you install Redis Software to custom directories, you can specify custom storage paths for persistent and ephemeral storage during [cluster setup]({{< relref "/operate/rs/8.0/clusters/new-cluster-setup" >}}) or when [adding nodes]({{< relref "/operate/rs/8.0/clusters/add-node" >}}).
...
For more information about storage requirements, see [Persistent and ephemeral node storage]({{< relref "/operate/rs/8.0/installing-upgrading/install/plan-deployment/persistent-ephemeral-storage" >}}).
