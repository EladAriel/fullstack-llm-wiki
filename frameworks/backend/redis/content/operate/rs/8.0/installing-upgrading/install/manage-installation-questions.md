...
source_branch: "main"
source_path: "content/operate/rs/8.0/installing-upgrading/install/manage-installation-questions.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.642956Z"
---
...
- operate
- rs
description: Describes Redis Software installation questions and how to
  answer them automatically.
linkTitle: Manage install questions
weight: 25
url: '/operate/rs/8.0/installing-upgrading/install/manage-installation-questions/'
---
...
- **Linux swap file** - `Swap is enabled. Do you want to proceed? [Y/N]?`
    ...
    We recommend that you [disable Linux swap]({{< relref "/operate/rs/8.0/installing-upgrading/configuring/linux-swap.md" >}}) in the operating system configuration
...
- **Network time** - `Do you want to set up NTP time synchronization now [Y/N]?`
    ...
    or you can [configure NTP manually]({{< relref "/operate/rs/8.0/clusters/configure/sync-clocks.md" >}}).

- **Firewall ports** - `Would you like to open RedisLabs cluster ports on the default firewall zone [Y/N]?`

    Redis Software requires that all nodes have [specific network ports]({{< relref "/operate/rs/8.0/networking/port-configurations.md" >}}) open.
    To open the ports, you can:

    - Answer `Y` to let the installation process open these ports.
    - Answer `N` and configure the firewall manually for [RHEL/CentOS firewall]({{< relref "/operate/rs/8.0/installing-upgrading/configuring/centos-rhel-firewall" >}}).
...
To perform a silent (or automated) install, answer the questions when you start the [install]({{< relref "/operate/rs/8.0/installing-upgrading/install/install-on-linux" >}}).  

### Answer yes to all questions

To automatically answer `yes` to all questions (which accepts the default values), run the [installation script]({{< relref "/operate/rs/8.0/installing-upgrading/install/install-script" >}}) with the `-y` parameter:
...
1. Run the [installation script]({{< relref "/operate/rs/8.0/installing-upgrading/install/install-script" >}}) with the `-c` command-line option and add the path to the answer file.
