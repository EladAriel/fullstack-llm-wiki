...
source_branch: "main"
source_path: "content/operate/rs/7.22/installing-upgrading/creating-support-package.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.337474Z"
---
...
toc: 'true'
weight: $weight
url: '/operate/rs/7.22/installing-upgrading/creating-support-package/'
---
...
| node_<node_uid>.rladmin | Information about the cluster's nodes, databases, endpoints, and shards. See [`rladmin status`]({{<relref "/operate/rs/7.22/references/cli-utilities/rladmin/status">}}) for example output. |
...
If package creation fails with `internal error` or if you cannot access the UI, create a support package for the cluster from the command line on any node in the cluster using the [`rladmin cluster debug_info`]({{< relref "/operate/rs/7.22/references/cli-utilities/rladmin/cluster/debug_info" >}}) command: 
...
You can also use `debuginfo` [REST API]({{< relref "/operate/rs/7.22/references/rest-api" >}}) requests to create and download support packages.
