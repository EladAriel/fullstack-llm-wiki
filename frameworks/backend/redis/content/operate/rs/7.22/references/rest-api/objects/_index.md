...
source_branch: "main"
source_path: "content/operate/rs/7.22/references/rest-api/objects/_index.md"
...
linkTitle: Objects
weight: 40
url: '/operate/rs/7.22/references/rest-api/objects/'
---

Certain [REST API requests]({{< relref "/operate/rs/7.22/references/rest-api/requests" >}}) require you to include specific objects in the request body. Many requests also return objects in the response body.
