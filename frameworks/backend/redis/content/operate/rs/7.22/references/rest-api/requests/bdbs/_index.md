...
source_branch: "main"
source_path: "content/operate/rs/7.22/references/rest-api/requests/bdbs/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.397845Z"
---
# _Index
...
linkTitle: bdbs
weight: $weight
url: '/operate/rs/7.22/references/rest-api/requests/bdbs/'
---
...
|-----------------|---------|
| [view_all_bdbs_info]({{< relref "/operate/rs/7.22/references/rest-api/permissions#view_all_bdbs_info" >}}) |  admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
The response body contains a JSON array with all databases, represented as [BDB objects]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}).
...
Returns a [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}).
...
If called with the `dry_run` URL query string, the function will validate the [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}) against the existing database, but will not invoke the state machine that will update it.
...
To track this request's progress, poll the [`/actions/<action_uid>` endpoint]({{< relref "/operate/rs/7.22/references/rest-api/requests/bdbs/actions" >}}) with the action_uid returned in the response body.

### Permissions

| Permission name | Roles |
|-----------------|-------|
| [update_bdb]({{< relref "/operate/rs/7.22/references/rest-api/permissions#update_bdb" >}}) | admin<br />cluster_member<br />db_member |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |      | Validate the new [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}) but don't apply the update. |
...
Include a [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}) with updated fields in the request body.
...
Returns the updated [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}).
...
If the request succeeds, the response body returns the updated [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}). If an error occurs, the response body may include an error code and message with more details.
...
The request must contain a single JSON [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}) with the configuration parameters for the new database.
...
If passed with the `dry_run` URL query string, the function will validate the [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}), but will not invoke the state machine that will create it.
...
| Permission name | Roles |
|-----------------|-------|
| [create_bdb]({{< relref "/operate/rs/7.22/references/rest-api/permissions#create_bdb" >}}) | admin<br />cluster_member<br />db_member |
...
| Field | Type | Description |
|-------|------|-------------|
| dry_run |    | Validate the new [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}) but don't create the database. |

#### Body

Include a [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}) in the request body.
...
The response includes the newly created [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}).
...
POST /v2/bdbs
```
Create a new database in the cluster. See [`POST /v1/bdbs`]({{< relref "/operate/rs/7.22/references/rest-api/requests/bdbs#post-bdbs-v1" >}}) for more information.
...
Include a JSON object that contains a [BDB object]({{< relref "/operate/rs/7.22/references/rest-api/objects/bdb" >}}) and an optional `recovery_plan` object in the request body.
...
| Permission name | Roles |
|-----------------|-------|
| [delete_bdb]({{< relref "/operate/rs/7.22/references/rest-api/permissions#delete_bdb" >}}) | admin<br />cluster_member<br />db_member |
