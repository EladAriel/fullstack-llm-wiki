...
source_branch: "main"
source_path: "content/operate/rs/7.22/clusters/new-cluster-setup.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.335373Z"
---
# New Cluster Setup
...
weight: 10
url: '/operate/rs/7.22/clusters/new-cluster-setup/'
---
...
To set up a new cluster, you must first [install the Redis Enterprise Software package]({{< relref "/operate/rs/7.22/installing-upgrading" >}})
and then set up the cluster as described below.
After the cluster is created you can [add multiple nodes to the cluster]({{< relref "/operate/rs/7.22/clusters/add-node.md" >}}).
...
1. In a browser, go to `https://<name or IP address of the machine with Redis Enterprise Software installed>:8443`.
    ...
    {{< note >}}
- The management UI uses a [self-signed certificate for TLS encryption]({{< relref "/operate/rs/7.22/security/certificates/updating-certificates" >}}).
...
1. In the **Configuration** section:
    ...
    1. For **FQDN (Fully Qualified Domain Name)**, enter a unique name for the cluster.
        ...
        See the [instructions for DNS setup]({{< relref "/operate/rs/7.22/networking/cluster-dns" >}})
        to make sure your cluster is reachable by name.

    1. Choose whether to [**Enable private & public endpoints support**]({{< relref "/operate/rs/7.22/networking/private-public-endpoints.md" >}}).

    1. Choose whether to [**Enable rack-zone awareness**]({{< relref "/operate/rs/7.22/clusters/configure/rack-zone-awareness.md" >}}).
...
- [Creating a new database]({{< relref "/operate/rs/7.22/databases/create.md" >}})
- [Joining a new node to a cluster]({{< relref "/operate/rs/7.22/clusters/add-node.md" >}})
