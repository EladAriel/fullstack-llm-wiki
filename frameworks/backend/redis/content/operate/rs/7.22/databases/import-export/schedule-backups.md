...
source_branch: "main"
source_path: "content/operate/rs/7.22/databases/import-export/schedule-backups.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.345179Z"
---
# Schedule Backups
...
weight: 40
url: '/operate/rs/7.22/databases/import-export/schedule-backups/'
---
...
To make an on-demand backup, [export your data]({{< relref "/operate/rs/7.22/databases/import-export/export-data.md" >}}).
...
The backup process creates compressed (.gz) RDB files that you can [import into a database]({{< relref "/operate/rs/7.22/databases/import-export/import-data.md" >}}). If the database name is longer than 30 characters, only the first 30 are used in backup file names.
...
- To limit the parallel backup for shards, set both [`tune cluster max_simultaneous_backups`]({{< relref "/operate/rs/7.22/references/cli-utilities/rladmin/tune#tune-cluster" >}}) and [`tune node max_redis_forks`]({{< relref "/operate/rs/7.22/references/cli-utilities/rladmin/tune#tune-node" >}}). `max_simultaneous_backups` is set to 4 by default.
...
When saved to a local mount point or a cloud provider, backup locations need to be available to [the group and user]({{< relref "/operate/rs/7.22/installing-upgrading/install/customize-user-and-group.md" >}}) running Redis Enterprise Software, `redislabs:redislabs` by default.  
