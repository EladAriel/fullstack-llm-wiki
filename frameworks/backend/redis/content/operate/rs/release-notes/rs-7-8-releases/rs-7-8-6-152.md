...
source_branch: "main"
source_path: "content/operate/rs/release-notes/rs-7-8-releases/rs-7-8-6-152.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.521969Z"
---
# Rs 7 8 6 152

---
Title: Redis Software release notes 7.8.6-152 (August 2025)
alwaysopen: false
categories:
- docs
- operate
...
- Bug fixes for Active-Active syncing, event log entries for configuration changes made by LDAP users, LDAP mapping visibility in the Cluster Manager UI, database max_connections setting, and memory leaks when using Active-Active databases in Kubernetes.
...
- RS144065: Fixed an issue where LDAP mappings created using the REST API without the `bdbs_email_alerts` field were not visible in the Cluster Manager UI.

- RS144380: Fixed an issue where updating a database configuration in the Cluster Manager UI reset `max_connections` to 0, which allowed unlimited client connections.
...
- The system now preserves user-defined `max_connections` for databases instead of resetting the values to unlimited (0) when the database configuration is updated using the Cluster Manager UI. If you previously set a database's `max_connections` to a value that doesn't align with your expected workload, review and adjust your configuration to prevent unintended client disconnections in case the threshold is too low.
...
| Package | SHA256 checksum (7.8.6-152 August release) |
|---------|---------------------------------------|
| Ubuntu 20 | <span class="break-all">4733282e2487ddf283461f68051c53d413c9fcdb23cd094beec011e01951282e</span> |
| Ubuntu 22 | <span class="break-all">e1064227ea1da4d3be52e0dc001c49d757050507a8be6c6fec32f37a8e34ed3d</span> |
| Red Hat Enterprise Linux (RHEL) 8 | <span class="break-all">e10de5341fff4e2ff6e502987a74eaf4b37b4ce91e6f0b184398cfa172b18286</span> |
| Red Hat Enterprise Linux (RHEL) 9 | <span class="break-all">34e678b3120f2e50f19135dd8e3ab7c50d64793809c95353444f10a37cd57b91</span> |
| Amazon Linux 2 | <span class="break-all">9c2613103031b59f82c6354b548fdd5c7292f444ee0d970e560cb591a545427e</span> |
...
Redis Software 7.8.6-152 supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs fixed by version.
