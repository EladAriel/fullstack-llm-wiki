...
source_branch: "main"
source_path: "content/operate/rs/release-notes/rs-7-8-releases/rs-7-8-6-13.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.520906Z"
---
# Rs 7 8 6 13

---
Title: Redis Software release notes 7.8.6-13 (March 2025)
alwaysopen: false
categories:
- docs
- operate
...
​[​Redis Software version 7.8.6](https://redis.io/downloads/#software) is now available! This release includes API enhancements that warranted a new minor version instead of a maintenance release for version 7.8.4. However, you can upgrade from 7.8.2 or 7.8.4 to 7.8.6 without issue.
...
- If you create or update users or roles using the [REST API]({{<relref "/operate/rs/references/rest-api">}}), you can use the `dry_run` query parameter to validate the request without actually applying the update.
    ...
    - [Create role]({{<relref "/operate/rs/references/rest-api/requests/roles#post-role">}}) example request:
        ...
        ```sh
        POST /v1/roles?dry_run
        ```

    - [Update role]({{<relref "/operate/rs/references/rest-api/requests/roles#put-role">}}) example request: 

        ```sh
        PUT /v1/roles/<uid>?dry_run
        ```

    - [Create user]({{<relref "/operate/rs/references/rest-api/requests/users#post-user">}}) example request:

        ```sh
        POST /v1/users?dry_run
        ```

    - [Update user]({{<relref "/operate/rs/references/rest-api/requests/users#put-user">}}) example request: 

        ```sh
        PUT /v1/users/<uid>?dry_run
        ```
...
| Package | SHA256 checksum (7.8.6-13 March release) |
|---------|---------------------------------------|
| Ubuntu 20 | <span class="break-all">8fa5336a6b487f4082353f7abad924a86b4ce2719e700ea0c8766718a2066020</span> |
| Ubuntu 22 | <span class="break-all">0013ad5d97b3480b9d8237ec22f15d0aa7d08f3caa75312e5d2597583229b2fa</span> |
| Red Hat Enterprise Linux (RHEL) 8 | <span class="break-all">e66cc1661540028f941189e41a17a32b17797c82abf90237f7da9491ea20a1c0</span> |
| Red Hat Enterprise Linux (RHEL) 9 | <span class="break-all">d588491fa96cc652aa92d43902efa490a90fbfe8967c649ea54284c7986f37bd</span> |
| Amazon Linux 2 | <span class="break-all">baea0cdada0ac42d38035b8ca826eabc2077256e2633b8cea5ff5010ff0ac53d</span> |
...
Redis Software 7.8.6-13 supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs fixed by version.
