...
source_branch: "main"
source_path: "content/operate/rs/release-notes/rs-8-0-releases/rs-8-0-20-96.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.541361Z"
---
# Rs 8 0 20 96

---
Title: Redis Software release notes 8.0.20-96 (August 2026)
alwaysopen: false
categories:
- docs
- operate
...
description: Bug fixes for Active-Active database upgrades and synchronization, internode encryption certificates, upgrades on RHEL 9 with an earlier OpenSSL version, and metrics exporter startup. Internal fixes and improvements.
linkTitle: 8.0.20-96 (August 2026)
weight: 78
---
...
- RS196656: Fixed an issue where upgrading Redis Software failed partway through on RHEL 9 nodes running an OpenSSL version earlier than 3.3.

- RS197912: Fixed an issue where the self-upgrade status for an Active-Active database could stay non-final until the API client timed out instead of reporting a final outcome.

- RS199887: Fixed an issue where some wrapper scripts relied on the installation adding the `bin` directory to `PATH`, which prevented the metrics exporters from starting when the installation was configured not to modify the environment.

- RS208976: Fixed an issue where an Active-Active database upgrade could stall during post-upgrade verification when a shard was still loading its dataset, which left the feature set version out of sync and the database stuck in a pending state.

- RS208996: Fixed an issue where applying a custom internode encryption certificate restarted the heartbeat service and made the cluster management API on port 9443 unreachable on all nodes for several minutes.
...
| Package | SHA256 checksum (8.0.20-96 August release) |
|---------|---------------------------------------|
| Ubuntu 20 | <span class="break-all">f9d55d1fb35ddb3547afe2474b38fb1dcdeaa3a898976306cef66f21f2a4a441</span> |
| Ubuntu 22 (amd64) | <span class="break-all">3df873bfe633b94b5909efe32d0fe3d65c57fe8bf155b21b1a5425b40299bb8b</span> |
| Ubuntu 22 (arm64) | <span class="break-all">6a8bb29d06d5a37575071839bc9b14f761aba65ac44c955e1a34293abe224681</span> |
| Red Hat Enterprise Linux (RHEL) 8 | <span class="break-all">d7b45466cbec89e8f4a3519439358085362bf17b1004106618cae759790f249f</span> |
| Red Hat Enterprise Linux (RHEL) 9 (amd64) | <span class="break-all">376f37b5c1f04ecd67ca34c8ffd43521da8fc69501fdcca644b09f8f8f4938c1</span> |
| Red Hat Enterprise Linux (RHEL) 9 (arm64) | <span class="break-all">a294ebeddf8d69c11b1039782e0c4fecfdaeaaefd49c7dc422853f5769f1526d</span> |
| Amazon Linux 2 | <span class="break-all">5a17cbc0f0038cd649acb8f7ba0826941129fc345feb0b598cebfb71d1d1d958</span> |
| Amazon Linux 2023 (amd64) | <span class="break-all">1db0bb0e492f0bb40f7453d4909fe76259c8a4ac36cdb91c2c268b139132c616</span> |
| Amazon Linux 2023 (arm64) | <span class="break-all">6b15cf7e411d447984ab8486c310e422c54a97917475057bbd3c9aae3533ae4e</span> |
...
Redis Software 8.0.20-96 supports Redis Open Source 8.6, 8.4, 8.2, 8.0, 7.4, 7.2, and 6.2. Below is the list of Redis Open Source CVEs and other security vulnerabilities fixed by version.
