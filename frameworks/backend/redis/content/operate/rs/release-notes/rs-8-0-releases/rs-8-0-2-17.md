...
source_branch: "main"
source_path: "content/operate/rs/release-notes/rs-8-0-releases/rs-8-0-2-17.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.542467Z"
---
# Rs 8 0 2 17

---
Title: Redis Software release notes 8.0.2-17 (October 2025)
alwaysopen: false
categories:
- docs
- operate
...
​[​Redis Software version 8.0.2](https://redis.io/downloads/#Redis_Software) is now available!
...
- To transition to the metrics stream engine, either migrate your existing dashboards using [Prometheus v1 metrics and equivalent v2 PromQL]({{<relref "/operate/rs/references/metrics/prometheus-metrics-v1-to-v2">}}) or use [new preconfigured dashboards]({{<relref "/integrate/prometheus-with-redis-enterprise#grafana-dashboards-for-redis-software">}}).
...
| Package | SHA256 checksum (8.0.2-17 October release) |
|---------|---------------------------------------|
