...
source_branch: "main"
source_path: "content/operate/rs/references/rest-api/objects/cluster/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.604881Z"
---
# _Index
...
| <span class="break-all">allow_modules_upload</span> | boolean (default: false) | Allow uploading custom (user-defined) modules to the cluster. When disabled, module upload endpoints are rejected regardless of role. |
...
| <span class="break-all">control_plane_basic_authentication</span> | boolean (default: true) | Enable Basic and Digest authentication on inbound cluster management API requests. When `false`, the cluster rejects Basic and Digest authentication; clients must use another configured method, such as certificate (mTLS), JWT, or LDAP authentication. See [Disable basic authentication for the REST API]({{<relref "/operate/rs/security/access-control/disable-basic-authentication">}}). |
