...
Set the following fields in an individual [instance]({{<relref "/operate/rs/references/rest-api/objects/crdb/instance_info">}})'s `db_config` because they are specific to that cluster's environment.
