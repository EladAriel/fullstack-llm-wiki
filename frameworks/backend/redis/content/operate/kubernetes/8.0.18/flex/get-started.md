...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0.18/flex/get-started.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.209078Z"
---
# Get Started
...
url: '/operate/kubernetes/8.0.18/flex/get-started/'
---
...
For hardware requirements and sizing guidelines, see [Plan your deployment]({{< relref "/operate/kubernetes/8.0.18/flex/plan" >}}).

## Configure the REC for Flex

To enable Flex, configure your `RedisEnterpriseCluster` (REC) resource with flash storage settings. Add the [`redisOnFlashSpec`]({{<relref "/operate/kubernetes/8.0.18/reference/api/redis_enterprise_cluster_api#specredisonflashspec">}}) section to your REC specification.
...
For all available fields, see the [REC API reference]({{<relref "/operate/kubernetes/8.0.18/reference/api/redis_enterprise_cluster_api#specredisonflashspec">}}).
...
For all available fields, see the [REDB API reference]({{<relref "/operate/kubernetes/8.0.18/reference/api/redis_enterprise_database_api">}}).
...
- [Scale your deployment]({{< relref "/operate/kubernetes/8.0.18/flex/scale" >}}): Learn how to scale volume, throughput, and infrastructure.
- [Plan your deployment]({{< relref "/operate/kubernetes/8.0.18/flex/plan" >}}): Review sizing guidelines and best practices.
