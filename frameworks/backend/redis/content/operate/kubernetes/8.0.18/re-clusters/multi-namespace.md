...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0.18/re-clusters/multi-namespace.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.218750Z"
---
# Multi Namespace
...
weight: 17
url: '/operate/kubernetes/8.0.18/re-clusters/multi-namespace/'
---
...
Before configuring a multi-namespace deployment, you must have a running [Redis Enterprise cluster (REC)]({{< relref "/operate/kubernetes/8.0.18/deployment/quick-start" >}}). See more information in the [deployment]({{< relref "/operate/kubernetes/8.0.18/deployment/" >}}) section.
...
{{<note>}}These will need to be reapplied each time you [upgrade]({{< relref "/operate/kubernetes/8.0.18/upgrade/upgrade-redis-cluster" >}}). {{</note>}}
...
2. Ensure all Active-Active prerequisites are met as described in [Configure Active-Active]({{<relref "/operate/kubernetes/8.0.18/active-active/create-reaadb/">}}).
