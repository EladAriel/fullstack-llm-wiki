...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0.18/networking/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.210579Z"
---
# _Index
...
weight: 40
url: '/operate/kubernetes/8.0.18/networking/'
---
...
- [Ingress routing]({{< relref "/operate/kubernetes/8.0.18/networking/ingress" >}}) - Use NGINX or HAProxy ingress controllers with `ingress` API resources
- [Istio ingress routing]({{< relref "/operate/kubernetes/8.0.18/networking/istio-ingress" >}}) - Use Istio service mesh with `Gateway` and `VirtualService` API resources
- [OpenShift routes]({{< relref "/operate/kubernetes/8.0.18/networking/routes" >}}) - Use OpenShift-specific route resources for external traffic

## Automatic ingress configuration

For Active-Active databases, configure automatic ingress creation:

- [REC external routing]({{< relref "/operate/kubernetes/8.0.18/networking/ingressorroutespec" >}}) - Use `ingressOrRouteSpec` field in RedisEnterpriseCluster (REC) for automatic ingress creation

## `ingressOrRouteSpec` for Active-Active databases

Versions 6.4.2 or later of Redis Enterprise for Kubernetes include a feature for ingress configuration. The `ingressOrRouteSpec` field is available in the RedisEnterpriseCluster spec to automatically create an Ingress (or route) for the API service and databases (REAADB) on that REC. See [REC external routing]({{< relref "/operate/kubernetes/8.0.18/networking/ingressorroutespec" >}}) for more details.
...
[OSS Cluster API]({{< relref "/operate/kubernetes/8.0.18/networking/cluster-aware-clients" >}}) is supported for both internal and external clients:
...
See [Enable cluster-aware clients (OSS Cluster API)]({{< relref "/operate/kubernetes/8.0.18/networking/cluster-aware-clients" >}}) for configuration details.
