...
source_branch: "main"
source_path: "content/operate/kubernetes/7.8.4/active-active/edit-rerc.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.141037Z"
---
# Edit Rerc
...
For more details, see the [RERC API reference]({{<relref "/operate/kubernetes/7.8.4/reference/redis_enterprise_remote_cluster_api">}}).

## Edit RERC

Use the `kubectl patch rerc <rerc-name> --type merge --patch` command to patch the local RERC custom resource with your changes. For a full list of available fields, see the [RERC API reference]({{<relref "/operate/kubernetes/7.8.4/reference/redis_enterprise_remote_cluster_api">}}).
...
1. Watch the RERC to verify the status is "Active" and the spec status is "Valid."
    ...
    To troubleshoot invalid configurations, view the RERC custom resource events and the [Redis Enterprise operator logs]({{< relref "/operate/kubernetes/7.8.4/logs/" >}}).
