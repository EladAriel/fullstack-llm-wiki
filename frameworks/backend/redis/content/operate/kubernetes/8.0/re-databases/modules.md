...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0/re-databases/modules.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.204029Z"
---
# Modules
...
weight: 15
url: '/operate/kubernetes/8.0/re-databases/modules/'
---
...
- [Redis Enterprise operator deployed]({{< relref "/operate/kubernetes/8.0/deployment/quick-start" >}}) in your Kubernetes cluster
- [Redis Enterprise cluster (REC)]({{< relref "/operate/kubernetes/8.0/re-clusters" >}}) running and in a healthy state
...
If you use [HashiCorp Vault integration]({{< relref "/operate/kubernetes/8.0/security/vault" >}}), store the module credentials in Vault instead of creating a Kubernetes secret. The `credentialsSecret` field will reference the secret name in Vault.
...
- [Upgrade a Redis Enterprise cluster (REC)]({{< relref "/operate/kubernetes/8.0/upgrade/upgrade-redis-cluster" >}})
- [Upgrade Redis Enterprise on OpenShift]({{< relref "/operate/kubernetes/8.0/upgrade/openshift-cli" >}})
...
- [REAADB API reference]({{< relref "/operate/kubernetes/8.0/reference/api/redis_enterprise_active_active_database_api" >}}) - API reference for Active-Active databases
