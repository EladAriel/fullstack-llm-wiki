...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0/reference/yaml/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.205450Z"
---
---
Title: YAML examples
alwaysopen: false
...
weight: 85
url: '/operate/kubernetes/8.0/reference/yaml/'
---
...
- [Basic deployment examples]({{< relref "/operate/kubernetes/8.0/reference/yaml/basic-deployment" >}}) - Service account, RBAC, cluster, and database configurations
- [Rack awareness examples]({{< relref "/operate/kubernetes/8.0/reference/yaml/rack-awareness" >}}) - Rack-aware cluster configuration and required RBAC
- [Active-Active examples]({{< relref "/operate/kubernetes/8.0/reference/yaml/active-active" >}}) - Multi-cluster Active-Active database setup
- [Multi-namespace examples]({{< relref "/operate/kubernetes/8.0/reference/yaml/multi-namespace" >}}) - Cross-namespace operator and cluster configurations
- [Log collector RBAC examples]({{< relref "/operate/kubernetes/8.0/reference/yaml/log-collector-rbac" >}}) - RBAC permissions for log collection in restricted and all modes
...
- [Reference]({{< relref "/operate/kubernetes/8.0/reference" >}}) - Complete API specifications for all custom resources
- [Deploy Redis Enterprise Software for Kubernetes]({{< relref "/operate/kubernetes/8.0/deployment/quick-start" >}}) - Step-by-step deployment instructions
- [Manage databases in multiple namespaces]({{< relref "/operate/kubernetes/8.0/re-clusters/multi-namespace" >}}) - Detailed multi-namespace setup instructions
- [Active-Active databases]({{< relref "/operate/kubernetes/8.0/active-active" >}}) - Active-Active configuration and management
