...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0/reference/yaml/rack-awareness.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.205270Z"
---
# Rack Awareness
...
weight: 20
url: '/operate/kubernetes/8.0/reference/yaml/rack-awareness/'
---

This page provides YAML examples for deploying Redis Enterprise with [rack awareness]({{< relref "/operate/kubernetes/8.0/recommendations/node-selection#using-rack-awareness" >}}). Rack awareness distributes Redis Enterprise nodes and database shards across different availability zones or failure domains to improve high availability and fault tolerance.
...
- Install the [Redis Enterprise operator]({{< relref "/operate/kubernetes/8.0/deployment" >}})

For complete deployment instructions, see [Deploy on Kubernetes]({{< relref "/operate/kubernetes/8.0/deployment" >}}).

## Service account

The service account for rack-aware deployments is the same as [basic deployments]({{< relref "/operate/kubernetes/8.0/reference/yaml/basic-deployment#service-account" >}}).
...
The rack-aware [REC configuration]({{< relref "/operate/kubernetes/8.0/reference/api/redis_enterprise_cluster_api" >}}) includes the `rackAwarenessNodeLabel` field.
...
Database configuration for rack-aware clusters is the same as [basic deployments]({{< relref "/operate/kubernetes/8.0/reference/yaml/basic-deployment#redis-enterprise-database" >}}).
...
To deploy rack-aware Redis Enterprise clusters, follow [Deploy on Kubernetes]({{< relref "/operate/kubernetes/8.0/deployment" >}}) and ensure your Kubernetes nodes have proper zone labels. For detailed rack awareness configuration, see the [node selection recommendations]({{< relref "/operate/kubernetes/8.0/recommendations/node-selection" >}}).
...
- [Configure Active-Active databases]({{< relref "/operate/kubernetes/8.0/reference/yaml/active-active" >}})
- [Set up multi-namespace deployment]({{< relref "/operate/kubernetes/8.0/reference/yaml/multi-namespace" >}})
- [Learn about database replication]({{< relref "/operate/kubernetes/8.0/re-databases/replica-redb" >}})

## Related documentation

- [Node selection recommendations]({{< relref "/operate/kubernetes/8.0/recommendations/node-selection" >}})
...
- [Redis Enterprise cluster architecture]({{< relref "/operate/kubernetes/8.0/architecture" >}})
