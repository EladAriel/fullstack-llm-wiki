...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0/reference/yaml/log-collector-rbac.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.205089Z"
---
---
...
weight: 50
url: '/operate/kubernetes/8.0/reference/yaml/log-collector-rbac/'
---
...
For complete log collection instructions, see [Collect logs]({{< relref "/operate/kubernetes/8.0/logs/collect-logs" >}}).
...
- [Collect logs guide]({{< relref "/operate/kubernetes/8.0/logs/collect-logs" >}})
- [Basic deployment examples]({{< relref "/operate/kubernetes/8.0/reference/yaml/basic-deployment" >}})
- [Multi-namespace deployment]({{< relref "/operate/kubernetes/8.0/reference/yaml/multi-namespace" >}})

## Related documentation

- [Kubernetes RBAC documentation](https://kubernetes.io/docs/reference/access-authn-authz/rbac/)
- [Redis Enterprise troubleshooting]({{< relref "/operate/kubernetes/8.0/logs" >}})
- [Operator deployment guide]({{< relref "/operate/kubernetes/8.0/deployment" >}})
