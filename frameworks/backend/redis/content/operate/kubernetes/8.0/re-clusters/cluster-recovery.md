...
source_branch: "main"
source_path: "content/operate/kubernetes/8.0/re-clusters/cluster-recovery.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.202956Z"
---
# Cluster Recovery
...
weight: 20
url: '/operate/kubernetes/8.0/re-clusters/cluster-recovery/'
---
...
{{< note >}}
If your cluster uses user-defined modules, the recovery process doesn't block on module validation errors (such as URL or credential issues). The cluster can recover successfully, and you can resolve any module configuration issues after recovery is complete. See [User-defined modules]({{< relref "/operate/kubernetes/8.0/re-databases/modules#user-defined-modules" >}}) for more information.
{{< /note >}}

## Prerequisites

- For cluster recovery, the cluster must be [deployed with persistence]({{< relref "/operate/kubernetes/8.0/recommendations/persistent-volumes" >}}).
