...
source_branch: "main"
source_path: "content/develop/use-cases/time-series-dashboard/go/_index.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:56.124927Z"
---
# _Index
...
- rs
- rc
description: Build a Redis-backed rolling sensor graph demo in Go with go-redis
linkTitle: Go dashboard
title: Rolling sensor graph demo with Go
weight: 4
---

This guide shows you how to build a compact rolling sensor graph demo in Go with the [`go-redis`]({{< relref "/develop/clients/go" >}}) client library and Redis time series support. The example simulates three power sensors, ingests readings into Redis, and serves a local browser dashboard that updates in real time.
...
* [Go client guide]({{< relref "/develop/clients/go" >}}) - Install and use the Go client
