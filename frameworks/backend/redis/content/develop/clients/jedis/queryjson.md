...
source_branch: "main"
source_path: "content/develop/clients/jedis/queryjson.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:56.069228Z"
---
# Queryjson
...
{{< clients-example set="java_home_json" step="create_data" description="Foundational: Define sample user data structures for indexing and querying" difficulty="beginner" >}}
{{< /clients-example >}}
...
{{< clients-example set="java_home_json" step="add_data" description="Foundational: Store JSON documents in Redis with automatic indexing based on key prefix" difficulty="beginner" >}}
{{< /clients-example >}}
...
{{< clients-example set="java_home_json" step="query1" description="Query with filters: Search JSON documents using text matching and numeric range filters to find specific records" difficulty="intermediate" >}}
{{< /clients-example >}}

Specify query options to return only the `city` field:

{{< clients-example set="java_home_json" step="query2" description="Query with field projection: Retrieve only specific fields from search results to reduce data transfer" difficulty="intermediate" >}}
{{< /clients-example >}}
...
{{< clients-example set="java_home_json" step="cleanup_hash" description="Foundational: Clean up existing hash indexes and data before creating new indexes" difficulty="beginner" >}}
{{< /clients-example >}}
...
{{< clients-example set="java_home_json" step="query1_hash" description="Query with filters: Search hash documents using text matching and numeric range filters (same as JSON queries)" difficulty="intermediate" >}}
{{< /clients-example >}}
