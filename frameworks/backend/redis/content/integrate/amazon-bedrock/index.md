...
framework: "redis"
directory: "content/integrate/amazon-bedrock"
...
This directory contains redis learning pages related to amazon bedrock.

## Breadcrumbs

[Wiki Home](../../../index.md) -> [Content](../../index.md) -> [Integrate](../index.md) -> [Amazon Bedrock](index.md)
...
- [Create Knowledge Base](create-knowledge-base.md)
