...
source_branch: "main"
source_path: "content/commands/ts.nrevrange.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:54.996125Z"
---
# Ts.Nrevrange
...
syntax_fmt: "TS.NREVRANGE numkeys key [key ...] fromTimestamp toTimestamp\n  [LATEST]\
  ...
  \ align] AGGREGATION aggregators [aggregators ...]\n  bucketDuration [BUCKETTIMESTAMP <start | - |\
  \ end | + | mid | ~>]\n  [EMPTY]]"
title: TS.NREVRANGE
---
...
{{% redis-cli %}}
redis> TS.NREVRANGE 2 {sensor}:1 {sensor}:2 - +
1) 1) (integer) 3000
   2) 1) NaN
      2) 25
2) 1) (integer) 2000
...
2) (integer) 1100
3) (integer) 2000
redis> TS.NREVRANGE 2 {sensor}:3 {sensor}:4 - + AGGREGATION avg sum 1000
1) 1) (integer) 2000
   2) 1) 30
      2) 25
2) 1) (integer) 1000
...
{{% redis-cli %}}
redis> TS.NREVRANGE 2 {sensor}:3 {sensor}:4 - + AGGREGATION avg,max sum 1000
1) 1) (integer) 2000
   2) 1) 30
      2) 30
      3) 25
