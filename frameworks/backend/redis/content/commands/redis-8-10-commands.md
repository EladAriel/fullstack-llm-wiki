...
source_branch: "main"
source_path: "content/commands/redis-8-10-commands.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.049075Z"
---
# Redis 8 10 Commands

---
title: Redis 8.10 Commands Reference
linkTitle: Redis 8.10 Commands
description: Complete list of all Redis commands available in version 8.10, organized by functional group
summary: Complete list of all Redis commands available in version 8.10, organized by functional group
layout: single
type: develop
categories:
- docs
...
This page provides a comprehensive reference of all Redis commands available in Redis 8.10, organized by functional group. Each command includes its description and syntax in a collapsible section for easy navigation.

{{< note >}}
Redis 8.10 includes all commands from previous versions plus new commands introduced in 8.10. Commands marked with **⭐ New in 8.10** were added in this release.
{{< /note >}}
...
<details>
<summary><strong><a href="/commands/increx/">INCREX</a></strong> - Increments the numeric value of a key by a number and sets its expiration time. Uses 0 as initial value if the key doesn't exist.</summary>

**Syntax:** `INCREX key [BYFLOAT increment | BYINT increment]
...
<details>
<summary><strong><a href="/commands/blmovem/">BLMOVEM</a></strong> - Moves up to (or exactly) a number of elements from one list to another and returns them. Blocks until the elements are available otherwise. Deletes the source list if it becomes empty. <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `BLMOVEM source destination <LEFT | RIGHT> <LEFT | RIGHT> timeout
  [<COUNT count | EXACTLY exactly> <OBO | BULK>]`

**Description:** Moves up to (or exactly) a number of elements from one list to another and returns them. Blocks until the elements are available otherwise. Deletes the source list if it becomes empty.
...
<details>
<summary><strong><a href="/commands/lmovem/">LMOVEM</a></strong> - Moves up to (or exactly) a number of elements from one list to another and returns them. Deletes the source list if it becomes empty. <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `LMOVEM source destination <LEFT | RIGHT> <LEFT | RIGHT>
  [<COUNT count | EXACTLY exactly> <OBO | BULK>]`

**Description:** Moves up to (or exactly) a number of elements from one list to another and returns them. Deletes the source list if it becomes empty.
...
<details>
<summary><strong><a href="/commands/sdiffcard/">SDIFFCARD</a></strong> - Returns the number of members of the difference between the first set and all successive sets. <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `SDIFFCARD numkeys key [key ...] [LIMIT limit]`
...
<details>
<summary><strong><a href="/commands/sunioncard/">SUNIONCARD</a></strong> - Returns the number of members of the union of multiple sets. <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>
...
<details>
<summary><strong><a href="/commands/xidmprecord/">XIDMPRECORD</a></strong> - An internal command for setting IDMP metadata on an existing stream message.</summary>
...
<details>
<summary><strong><a href="/commands/xnack/">XNACK</a></strong> - Releases pending messages back to the group's PEL without acknowledging them, making them available for re-delivery.</summary>
...
**Syntax:** `XREAD [COUNT count] [MAXCOUNT maxcount] [MAXSIZE maxsize]
...
**Syntax:** `XREADGROUP GROUP group consumer [COUNT count] [MAXCOUNT maxcount]
  [MAXSIZE maxsize] [BLOCK milliseconds] [CLAIM min-idle-time]
...
<details>
<summary><strong><a href="/commands/arcount/">ARCOUNT</a></strong> - Returns the number of non-empty elements in an array.</summary>
...
<details>
<summary><strong><a href="/commands/ardel/">ARDEL</a></strong> - Deletes elements at the specified indices in an array.</summary>
...
<details>
<summary><strong><a href="/commands/ardelrange/">ARDELRANGE</a></strong> - Deletes elements in one or more ranges.</summary>
...
<details>
<summary><strong><a href="/commands/arget/">ARGET</a></strong> - Gets the value at an index in an array.</summary>
...
<details>
<summary><strong><a href="/commands/argetrange/">ARGETRANGE</a></strong> - Gets values in a range of indices.</summary>
...
<details>
<summary><strong><a href="/commands/argrep/">ARGREP</a></strong> - Searches array elements in a range using textual predicates.</summary>
...
<details>
<summary><strong><a href="/commands/arinfo/">ARINFO</a></strong> - Returns metadata about an array.</summary>
...
<details>
<summary><strong><a href="/commands/arinsert/">ARINSERT</a></strong> - Inserts one or more values at consecutive indices.</summary>
...
<details>
<summary><strong><a href="/commands/arlastitems/">ARLASTITEMS</a></strong> - Returns the most recently inserted elements.</summary>
...
<details>
<summary><strong><a href="/commands/arlen/">ARLEN</a></strong> - Returns the length of an array (max index + 1).</summary>
...
<details>
<summary><strong><a href="/commands/armget/">ARMGET</a></strong> - Gets values at multiple indices in an array.</summary>
...
<details>
<summary><strong><a href="/commands/armset/">ARMSET</a></strong> - Sets multiple index-value pairs in an array.</summary>
...
<details>
<summary><strong><a href="/commands/arnext/">ARNEXT</a></strong> - Returns the next index ARINSERT would use.</summary>
...
<details>
<summary><strong><a href="/commands/arop/">AROP</a></strong> - Performs aggregate operations on array elements in a range.</summary>
...
<details>
<summary><strong><a href="/commands/arring/">ARRING</a></strong> - Inserts values into a ring buffer of specified size, wrapping and truncating as needed.</summary>
...
<details>
<summary><strong><a href="/commands/arscan/">ARSCAN</a></strong> - Iterates existing elements in a range, returning index-value pairs.</summary>
...
<details>
<summary><strong><a href="/commands/arseek/">ARSEEK</a></strong> - Sets the ARINSERT / ARRING cursor to a specific index.</summary>
...
<details>
<summary><strong><a href="/commands/arset/">ARSET</a></strong> - Sets one or more contiguous values starting at an index in an array.</summary>
...
<details>
<summary><strong><a href="/commands/ft.aliaslist/">FT.ALIASLIST</a></strong> - Lists all aliases for the index <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `FT.ALIASLIST index`
...
**Syntax:** `FT.HYBRID index
  ...
  VSIM vector field $vector param
    [KNN count K k [EF RUNTIME ef runtime]] [SHARD K RATIO shard k ratio]]
    [RANGE count RADIUS radius [EPSILON epsilon]]
    [YIELD SCORE AS name]
    [FILTER] count filter-expression [POLICY [ADHOC/BATCHES] BATCH SIZE batch-size-value]
...
<details>
<summary><strong><a href="/commands/ft.profile/">FT.PROFILE</a></strong> - Performs a `FT.SEARCH`, `FT.HYBRID`, or `FT.AGGREGATE` command and collects performance information</summary>

**Syntax:** `FT.PROFILE index <SEARCH | HYBRID | AGGREGATE> [LIMITED] QUERY query`

**Description:** Performs a `FT.SEARCH`, `FT.HYBRID`, or `FT.AGGREGATE` command and collects performance information
...
**Syntax:** `TS.MRANGE fromTimestamp toTimestamp [LATEST] [FILTER BY TS Timestamp
  ...
  l!=(v1,v2,...) ...]> [GROUPBY label REDUCE reducer] [EXCLUDEEMPTY]`
...
<details>
<summary><strong><a href="/commands/ts.nrange/">TS.NRANGE</a></strong> - Query a range across multiple time series in forward direction, returning the results grouped by timestamp <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `TS.NRANGE numkeys key [key ...] fromTimestamp toTimestamp [LATEST]
  [FILTER BY TS ts [ts ...]] [FILTER BY VALUE min max] [COUNT count]
  [[ALIGN align] AGGREGATION aggregators [aggregators ...] bucketDuration
  [BUCKETTIMESTAMP <start | - | end | + | mid | ~>] [EMPTY]]`

**Description:** Query a range across multiple time series in forward direction, returning the results grouped by timestamp
...
<details>
<summary><strong><a href="/commands/ts.nrevrange/">TS.NREVRANGE</a></strong> - Query a range across multiple time series in reverse direction, returning the results grouped by timestamp <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `TS.NREVRANGE numkeys key [key ...] fromTimestamp toTimestamp
  [LATEST] [FILTER BY TS ts [ts ...]] [FILTER BY VALUE min max]
  [COUNT count] [[ALIGN align] AGGREGATION aggregators [aggregators ...]
  bucketDuration [BUCKETTIMESTAMP <start | - | end | + | mid | ~>]
  [EMPTY]]`

**Description:** Query a range across multiple time series in reverse direction, returning the results grouped by timestamp
...
<details>
<summary><strong><a href="/commands/ts.querylabels/">TS.QUERYLABELS</a></strong> - Get all label names, or all values of a given label, for time series matching a filter list, or all series <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `TS.QUERYLABELS <LABELS | VALUES label> [FILTER filterExpr
  [filterExpr ...]]`

**Description:** Get all label names, or all values of a given label, for time series matching a filter list, or all series
...
<details>
<summary><strong><a href="/commands/ts.read/">TS.READ</a></strong> - Read: return up to max_count samples with timestamp >= timestamp. With BLOCK, waits up to milliseconds ms until at least min_count qualifying samples exist <span style="color: #e74c3c;">⭐ New in 8.10</span></summary>

**Syntax:** `TS.READ key timestamp [BLOCK milliseconds min count]
  [MAX COUNT max count]`

**Description:** Read: return up to max_count samples with timestamp >= timestamp. With BLOCK, waits up to milliseconds ms until at least min_count qualifying samples exist
