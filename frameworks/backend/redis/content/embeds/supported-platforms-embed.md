...
source_branch: "main"
source_path: "content/embeds/supported-platforms-embed.md"
source_commit: "f8693349287b0efbef3c865b6f6a2aceca88594d"
source_commit_short: "f869334"
source_commit_date: "2026-08-28T10:01:19-05:00"
generated_at: "2026-08-29T09:38:55.095180Z"
---
# Supported Platforms Embed


Redis Software is supported on several operating systems, cloud environments, and virtual environments.
...
We only support what the vendor supports in accordance with their policies. When Red Hat no longer supports a particular release, it is no longer supported by Redis as well. If future Redis Software releases will not support a major RHEL version, the release notes and the [supported platforms](#supported-platforms) table will include deprecation warnings.
...
To avoid issues with SHA1 certificates, replace them with new certificates that use SHA-256. Note that certificates provided by Redis Software use SHA-256.
...
This limitation is fixed for clusters using Redis Software version 7.2.4 and later.
...
This limitation was fixed in [Redis Software version 7.2.4-64]({{< relref "/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-64" >}}).
...
Redis Software is compatible with VMware and other similar virtualization platforms. Make sure to do the following:

- Configure your memory, CPU, network, and storage settings to allow for optimal Redis Software performance.
- Pin each Redis Software shard to a specific ESX or ESXi host by setting the appropriate affinity rules.
...
- Turn off VMware VMotion because Redis Software is not compatible with VMotion.
- Don't use snapshots because Redis Software cluster manages states dynamically, so a snapshot might not have the correct node and cluster states.
